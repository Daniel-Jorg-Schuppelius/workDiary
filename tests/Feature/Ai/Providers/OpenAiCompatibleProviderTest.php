 ...
 * Filename     : OpenAiCompatibleProviderTest.php
...
class OpenAiCompatibleProviderTest extends LlmProviderContractTestCase {
    ...
    protected function completionUrlPattern(): string {
        return 'https://llm.example.com/v1/chat/completions*';
    }

    protected function preflightUrlPattern(): string {
        return 'https://llm.example.com/v1/models*';
    }
    ...
    protected function hasAuthHeader(RequestInterface $request): bool {
        return ($request->getHeader('Authorization')[0] ?? '') === 'Bearer sk-compat';
    }
}
