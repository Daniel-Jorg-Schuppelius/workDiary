...
La dashboard è la sua pagina iniziale personale: riunisce in riquadri
gli indicatori, le attività aperte e gli avvisi più importanti per Lei.
Ciò che appare dipende dai suoi permessi e dai moduli attivati — chi
...
- Per le impostazioni predefinite dell'organizzazione: il diritto di
  gestirla.
- Nel profilo può impostare la pagina iniziale personale come pagina
  predefinita dopo l'accesso.

## Procedura consigliata

1. Apra la **personalizzazione** e attivi i riquadri che le servono
...
2. Ordini i riquadri trascinandoli o con le frecce e li imposti a metà
   o piena larghezza.
3. Salvi la configurazione — la selezione vale solo per il suo account
   e viene conservata.
...
- **Confondere predefinito e vista personale:** il predefinito
  ...
  «Ripristina predefinito» riporta in ogni momento al predefinito.

## Effetti e prossimi passi

La selezione dei riquadri riguarda solo il suo account e non modifica
