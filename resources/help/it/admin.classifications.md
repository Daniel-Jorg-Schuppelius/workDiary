...
Le classificazioni sono liste di valori a livello di organizzazione per
dominio (tipi di commessa, attività, tipi di errore, cause, esiti,
...
prima della firma — e se la regola blocca o è solo un avviso.
