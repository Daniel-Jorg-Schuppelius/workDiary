...
via `POST` HTTPS alla sua URL. Crei il webhook con nome e URL di
destinazione, sottoscriva gli **eventi** desiderati, copi subito il
**signing key** (mostrato in chiaro una sola volta, poi rotabile) e
verifichi con **Invia evento di test**. Il payload è volutamente
