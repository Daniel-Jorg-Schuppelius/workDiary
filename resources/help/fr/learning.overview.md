...
contenu est construit à partir de blocs (texte, encadré, liste de contrôle,
vidéo, intégration) — le HTML libre n'est volontairement pas proposé.
...
paramètres classent le catalogue ; **fenêtre de disponibilité** et **limite de
