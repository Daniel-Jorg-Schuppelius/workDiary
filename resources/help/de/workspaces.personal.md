...
Ein Arbeitsbereich blendet **nur aus**. Er ändert keine Rechte, schaltet kein
...
1. **Name** vergeben (er steht später auf der Kachel im Umschalter).
2. Optional ein **Symbol** und eine **Reihenfolge** setzen — die Reihenfolge
   bestimmt, wo die Kachel im Umschalter steht.
3. Links im Katalog auf einen Bereich, eine Gruppe oder einen Eintrag klicken,
   um ihn zur Auswahl hinzuzufügen. Ein ganzer Bereich nimmt alles mit, was
   darin liegt.
...
- **Ziehen** am Griff links in der Zeile.
- **Ohne Maus:** Griff mit der Tabulatortaste anspringen und mit *Pfeil hoch*
  bzw. *Pfeil runter* verschieben — oder die Schaltflächen ▲/▼ in der Zeile
  benutzen.
