...
1. **Vorfall erfassen**: Titel, Kategorie (z. B. „Schadsoftware",
   „Phishing", „Unbefugter Zugriff", „Dienstausfall"), Kritikalität
   („Niedrig" bis „Kritisch"), Erkennungs-/Eintrittszeitpunkt und
   Verantwortlicher.
2. **Eindämmen und untersuchen**: Auswirkung und Kommunikation festhalten,
   den Vorfall entlang der Statuskette führen – von „Gemeldet" über
   „Bewertung", „Eingedämmt", „Bereinigt" und „Wiederhergestellt" bis
   „Geschlossen".
...
Bearbeiten erfordert ISMS-Pflegerechte.

Nächste Schritte: Neu gemeldete **kritische** Vorfälle lösen eine
