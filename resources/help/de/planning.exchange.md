...
3. Die Teamleitung prüft die Freigabe. Dabei wird automatisch geprüft, ob
   die neue Zuordnung mit Ruhezeiten, Höchstarbeitszeit, Überschneidung
   und Abwesenheiten vereinbar ist.
4. Erst mit der Freigabe wechselt die Schicht-Zuordnung – bei einem echten
   Tausch beide Schichten.

Ein Antrag kann zurückgenommen werden, solange er noch nicht entschieden
ist.
