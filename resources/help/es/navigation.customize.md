...
global, los marcadores y los enlaces directos no cambian.

## Todas las funciones

La página **Todas las funciones** es la válvula de seguridad: lista cada
área con su estado —

- **visible** — con enlace directo;
- **oculto por mí** — recuperable con un clic;
- **desactivado por la organización** — con permiso, un enlace lleva a la
