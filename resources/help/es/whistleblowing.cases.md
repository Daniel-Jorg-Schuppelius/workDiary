...
Aquí gestiona las denuncias recibidas de informantes internos y
...
cada caso se cifra con su propia clave (DEK). En el detalle puede
...
cifrados. Declarar un conflicto de intereses le excluye del caso,
