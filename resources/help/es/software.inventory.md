...
La gestión de software lleva el inventario del software y las licencias
en uso: por entrada se mantienen nombre, fabricante, tipo y tipo de
licencia, además de un estado activo. La vista general muestra el
