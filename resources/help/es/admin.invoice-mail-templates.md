...
`customer_name`, `invoice_number`, `due_date`, `total` o
`company_name`. Las plantillas son por organización, su gestión
requiere el permiso de facturación y el envío se realiza en el área de
facturas (ver **Gestionar facturas**).
