...
{{--
    ...
    DaisyUI-Theme korrekt. Ab `md` einzeilig (Text truncated, Aktionen rechts);
    Aktions-Slot daher ohne eigenes `flex-wrap` bestücken.
--}}
<div {{ $attributes->class([
    // shrink-0: in Voll-Höhe-Flex-Seiten darf der Kopf nicht von hohem
    // Inhalt (z. B. großen Tabellen) zusammengestaucht werden.
    // md:flex-nowrap: Einzeilen-Standard — Text links truncated, Aktionen
    // bleiben rechts in derselben Zeile; nur mobil darf umbrochen werden.
