...
<x-form-group :legend="__('Preis & Status')" icon="payments" tone="info" cols="2">
    <x-input-field name="default_unit_price" type="number" step="0.0001" min="0" :label="__('EP netto')" :value="old('default_unit_price', $material->default_unit_price?->getAmount())" />
    <x-input-field name="tax_rate" type="number" step="0.01" min="0" max="100" label="USt %" :value="old('tax_rate', $material->tax_rate?->getNumericValue())" />
