                ...
                @else
                    ...
                    @foreach ($rows as $line)
                        <tr class="hover">
                            ...
                            <td class="text-right tabular-nums">{{ \CommonToolkit\Helper\Data\NumberHelper::toGermanFormat(($line->unit_price?->toFloat() ?? 0.0), 2, withThousandsSeparator: true) }} {{ $line->currency->value }}</td>
                        </tr>
                    @endforeach
                @endif
            </x-table>
