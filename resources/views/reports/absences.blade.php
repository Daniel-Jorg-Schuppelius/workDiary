...
<x-page-shell>
        ...
        <x-page-toolbar :subtitle="__('Urlaub, Krankheit, Sonderfreistellungen und Flex-Saldo je Mitarbeiter.')">
            <x-slot:actions>
                ...
                <x-icon-btn icon="table_view" tone="outline" size="sm"
                            :href="route('reports.absences', array_merge($linkParams, ['export' => 'xlsx']))"
    ...
    <div class="chart-grid grid gap-3 xl:grid-cols-2">
        <x-charts.stacked-bar :title="__('Abwesenheitstage :per nach Typ', ['per' => $periodPhrase])" :unit="__('Tage')" :series="$monthlyTypeSeries" :bands="$typeBands" :x-label="$periodAxis" />
