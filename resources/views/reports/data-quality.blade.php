...
<x-page-shell>
    ...
    <div class="chart-grid grid gap-3 xl:grid-cols-2">
        <x-charts.bar :title="__('Aufträge mit Klassifikationslücken :per', ['per' => $periodPhrase])" :unit="__('Aufträge')"
                      :series="$gapsMonthlySeries" :x-label="$periodAxis" :y-label="__('Aufträge')" />
