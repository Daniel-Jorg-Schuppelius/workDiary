...
>
    ...
    @if ($canViewIntegrations)
        <x-card as="article" data-section="integrations" class="flex flex-col gap-3">
    ...
    @if ($canViewExports)
        <x-card as="article" data-section="exports" class="flex flex-col gap-3">
    ...
    @if ($canViewSupport)
        <x-card as="article" data-section="support" class="flex flex-col gap-3">
