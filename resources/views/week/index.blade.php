...
@section('content')
<x-page-shell overflow="clip" class="wd-week"
              data-week-tabs
              data-active-week="{{ $activeKey }}">
    {{-- Toolbar als stehender Seitenkopf (page-header-Stack); Kontext-Hilfe
         kommt bereits über das Route-Mapping in config/help-topics.php. --}}
    <x-slot:toolbar>
        ...
        <div role="tablist" class="tabs tabs-box flex-nowrap overflow-x-auto">
            @foreach ($weekViews as $wv)
                <button type="button" role="tab"
                    ...
                    <span class="text-[0.65rem] text-muted tabular-nums">{{ $wv['shortLabel'] }}</span>
                </button>
            @endforeach
        </div>
    @endif
...
<div id="wd-week-create-menu"
    ...
    <div class="px-3 py-1 text-[0.65rem] uppercase tracking-wider text-muted" data-wd-menu-label></div>
