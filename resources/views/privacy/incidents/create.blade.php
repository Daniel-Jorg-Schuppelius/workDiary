...
@section('content')
    <div class="p-4 max-w-2xl space-y-4">
        <h1 class="text-xl font-semibold">{{ __('Datenschutzvorfall melden') }}</h1>
        <p class="text-sm text-base-content/60">{{ __('Mit dem Anlegen startet die 72-Stunden-Frist zur Meldung an die Aufsichtsbehörde (Art. 33).') }}</p>
