...
return [
    ...
    'job' => [
        ...
        'caldav' => ['publish' => 'Conciliación de publicación del calendario CalDAV'],
        'carddav' => ['sync' => 'Sincronización CardDAV'],
        'catalog' => ['fetch_due' => 'Obtener fuentes de catálogo', 'apply_pending_prices' => 'Activar los niveles de precio programados'],
        'tenders' => ['fetch_notices' => 'Recuperar los anuncios de licitación'],
        'chat' => [
        ...
        'google-calendar' => ['publish' => 'Conciliación de publicación del calendario de Google'],
        ...
        'msgraph' => [
            'calendar-import' => 'Importación bidireccional del calendario',
            'publish' => 'Conciliación de publicación del calendario de Microsoft 365',
            'subscriptions' => 'Renovar las suscripciones de webhooks de Microsoft 365',
            'todo-sync' => 'Sincronización de Microsoft To Do',
        ],
        ...
        'clockify' => ['push' => 'Exportar tiempos a Clockify'],
