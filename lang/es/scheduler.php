...
return [
    ...
    'cadence_label' => [
        ...
        'weeklyOn' => 'Cada :weekday a las :time',
        'monthlyOn' => 'Mensualmente el día :day a las :time',
    ],
    'criticality' => [
    ...
    'job' => [
        ...
        'learning' => [
            'close_stale_sessions' => 'Cerrar sesiones de aprendizaje abandonadas',
            'lti_rotate_keys' => 'Rotar las claves de firma LTI',
            'lti_prune_nonces' => 'Eliminar los nonces LTI caducados',
        ],
        'attendance' => ['close_open' => 'Cerrar fichajes olvidados', 'open_reminder' => 'Recordar fichajes abiertos por la tarde'],
        ...
        'caldav' => ['publish' => 'Conciliación de publicación del calendario CalDAV', 'import' => 'Reimportación del calendario CalDAV'],
        'carddav' => ['sync' => 'Sincronización CardDAV'],
        'sevdesk' => ['pull-vouchers' => 'Recuperar documentos de sevDesk'],
        ...
        'peppol' => ['receive' => 'Recuperar la entrada Peppol'],
        ...
        'search' => ['reconcile' => 'Conciliar el índice de búsqueda (búsqueda de actividades)'],
        ...
        'zammad' => ['sync' => 'Sincronización de tickets Zammad'],
        'github' => ['sync' => 'Sincronización de issues GitHub'],
        'gitlab' => ['sync' => 'Sincronización de issues GitLab'],
