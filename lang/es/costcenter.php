...
return [
    ...
    'field' => [
        ...
        'cost_center_master' => "Centro de coste de los datos maestros",
        'cost_center_master_free' => "– introducir manualmente –",
        'cost_center_master_help' => "La selección toma el código de los datos maestros; sin selección se aplica el código introducido manualmente.",
        'priority' => "Prioridad",
