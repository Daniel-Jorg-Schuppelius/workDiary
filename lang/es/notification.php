...
return [
    'title' => [
        ...
        'center_subtitle' => 'Sus notificaciones en la aplicación — leídas y no leídas.',
        'empty' => 'Sin notificaciones.',
        'empty_message' => 'En cuanto un evento le afecte, aparecerá aquí.',
    ...
    'field' => [
        ...
        'channels' => 'Canales',
        'channels_sms_hint' => 'Los SMS solo llegan a personas con número de móvil confirmado y tienen coste por mensaje, por lo que solo pueden elegirse en eventos críticos.',
    ...
    'message' => [
        'learning_enrolled' => 'Se le ha asignado el curso «:course».',
        'learning_enrolled_with_due' => 'Se le ha asignado el curso «:course» — vence el :date.',
        'learning_due_soon' => 'El curso «:course» vence el :date.',
        'learning_overdue' => 'El curso «:course» venció el :date y aún no está completado.',
        'learning_submission_received' => ':name ha entregado la tarea «:assignment» del curso «:course».',
        'learning_graded' => 'Su tarea «:assignment» del curso «:course» ha sido evaluada.',
        'learning_returned' => 'Su tarea «:assignment» del curso «:course» ha sido devuelta para revisión.',
        'learning_certificate_issued' => 'Su certificado :number del curso «:course» ha sido emitido.',
        'learning_waitlist_promoted' => 'Ha quedado una plaza libre para «:title» el :date — está inscrito/a.',
        'club_event_reminder' => 'Recordatorio para :name: «:title» empieza el :date.',
        'club_event_rescheduled' => '«:title» (:name) se ha aplazado: nuevo inicio :date, antes :previous.',
        'club_event_cancelled' => '«:title» del :date (:name) se ha cancelado.',
        'club_waitlist_promoted' => 'Ha quedado una plaza libre para «:title» el :date: :name está inscrito/a.',
        'club_horse_unavailable' => 'El caballo «:horse» no está disponible (:reason): «:title» el :date con :rider necesita una nueva asignación.',
        'learning_booking_confirmed' => 'Su reserva del curso «:course» ha sido confirmada.',
        'learning_booking_rejected' => 'Su reserva del curso «:course» ha sido rechazada.',
        'learning_time_approval_requested' => ':name ha registrado :minutes minutos de aprendizaje para «:course» fuera del horario laboral — se necesita aprobación.',
        'learning_question_asked' => ':name pregunta sobre «:course»: :question',
        ...
        // Wetterwarnung für disponierte Einsätze (Feature 062, MVP-716).
        'weather_warning_title' => 'Aviso meteorológico :date — :title',
        'weather_warning_rain' => 'Lluvia intensa prevista: :value mm/día (umbral :limit mm).',
        'weather_warning_gust' => 'Rachas de tormenta previstas: hasta :value km/h (umbral :limit km/h).',
        'weather_warning_frost' => 'Helada prevista: mínima :value °C (umbral :limit °C).',
        'weather_warning_heat' => 'Calor previsto: máxima :value °C (umbral :limit °C).',
        ...
        'email_changed_title' => 'Correo de acceso cambiado',
        'email_changed_message' => 'La dirección de acceso de su cuenta se cambió a :email. Si no fue usted, cambie su contraseña de inmediato y avise a su administración.',
        'passkey_added_title' => 'Nueva clave de acceso añadida',
        'passkey_added_message' => 'Se añadió una nueva llave de seguridad o clave de acceso a su cuenta. Si no fue usted, elimínela de inmediato y cambie su contraseña.',
        'two_factor_lockout_title' => 'Están adivinando su segundo factor',
        'two_factor_lockout_message' => 'Su cuenta acumuló demasiados códigos de doble factor incorrectos y se canceló el inicio de sesión. Si no fue usted, cambie su contraseña: alguien podría conocerla ya.',
        ...
        'issue_assigned' => ':actor le ha asignado este punto abierto.',
        ...
        'correction_decided_title' => 'Decisión sobre su solicitud de corrección (:date)',
        'correction_approved' => 'Su solicitud fue aprobada. :note',
        'correction_rejected' => 'Su solicitud fue rechazada. :note',
        'overtime_requested_title' => 'Solicitud de horas extra de :user para :date (:minutes min)',
        'overtime_decided_title' => 'Decisión sobre su solicitud de horas extra (:date)',
        'overtime_approved' => 'Su solicitud de horas extra fue aprobada. :note',
        'overtime_rejected' => 'Su solicitud de horas extra fue rechazada. :note',
        'vacation_requested_title' => 'Solicitud de vacaciones de :user (:from – :to)',
        'vacation_decided_title' => 'Decisión sobre su solicitud de vacaciones (:from – :to)',
        'vacation_approved' => 'Su solicitud de vacaciones fue aprobada. :note',
        'vacation_rejected' => 'Su solicitud de vacaciones fue rechazada. :note',
        'unclear_case_title' => 'Caso por aclarar el :date',
        'open_attendance_title' => 'Tiene la entrada fichada desde las :time',
        'open_attendance_body' => 'Fiche la salida si ya ha terminado; de lo contrario, el sistema cerrará el fichaje automáticamente más tarde.',
        ...
        'training_due' => 'Formación obligatoria «:course» pendiente el :date.',
