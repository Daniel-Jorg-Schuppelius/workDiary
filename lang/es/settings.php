...
return [
    ...
    'weather' => [
        ...
        'warnings_heading' => 'Avisos meteorológicos para la planificación',
        'warnings_enabled' => 'Avisos meteorológicos para intervenciones planificadas',
        'warnings_enabled_hint' => 'Comprueba cada hora la previsión diaria (solo Open-Meteo) de las intervenciones de los próximos 3 días con coordenadas y notifica los umbrales superados exactamente una vez por intervención, día y umbral. Predeterminado: activado.',
        'warn_rain_mm' => 'Lluvia (mm/día)',
        'warn_gust_kmh' => 'Rachas (km/h)',
        'warn_frost_c' => 'Helada desde mínima de (°C)',
        'warn_heat_c' => 'Calor desde máxima de (°C)',
        'warn_hint' => 'Predeterminado: 20 mm/día, 60 km/h, 0 °C, 30 °C.',
    ],
    ...
    'fixed_assets' => [
        'heading' => 'Inmovilizado: bienes de escaso valor y fondo colectivo',
        'description' => 'Límites de valor (netos) para la amortización inmediata de bienes de escaso valor y para el fondo colectivo. Los valores por defecto siguen el § 6 apdo. 2/2a EStG (a 2026); compruébelos si cambia la ley.',
        'gwg_limit' => 'Límite bienes de escaso valor',
    ...
    'claims_pattern' => [
        ...
        'description' => 'A partir de cuántas reclamaciones similares (mismo lote, mismo artículo con el mismo tipo de defecto o causa, mismo proveedor) aparece una indicación.',
        'threshold' => 'Umbral (casos)',
    ...
    'dunning' => [
        ...
        'description' => 'Valores por defecto por nivel para la reclamación individual y la serie de reclamaciones: carencia, recargo y plazo de pago por nivel, más interés de demora sobre el importe pendiente.',
        'grace_days' => 'Nivel :level: carencia (días)',
        'grace_days_hint_first' => 'Días de retraso antes de que el nivel 1 (recordatorio de pago) sea exigible.',
        'grace_days_hint_next' => 'Días desde la última reclamación antes de que este nivel sea exigible.',
        'fee' => 'Nivel :level: recargo (EUR)',
        'pay_days' => 'Nivel :level: plazo de pago (días)',
        'interest_rate' => 'Interés de demora (% anual)',
        'interest_rate_hint' => 'Solo con tipo fijo; 0 = sin indicación de intereses. Solo se muestra en la carta de reclamación, sin contabilizar.',
        'interest_mode' => 'Calcular intereses de demora',
        'interest_mode_hint' => 'Tipo fijo o tipo básico según § 247 BGB (consulta mensual al Bundesbank) más puntos porcentuales.',
        'interest_mode_fixed' => 'Tipo fijo',
