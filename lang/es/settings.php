...
return [
    ...
    'dunning' => [
        ...
        'interest_rate_hint' => '0 = sin indicación de intereses. Referencia § 288 BGB: 5 o 9 puntos sobre el tipo básico — el tipo se mantiene aquí manualmente (sin feed del tipo básico). Solo indicación en la carta, no se contabiliza nada.',
    ],
];
