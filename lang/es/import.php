...
return [
    'entity' => [
        ...
        'club_members' => 'Socios de la asociación',
    ],
    'template' => [
    ...
    'error' => [
        ...
        'format' => [
            ...
            'integer' => 'No es un número entero válido.',
            'club_kind' => 'Tipo de afiliación no válido (activo, pasivo, colaborador, en pausa).',
        ],
        'outOfRange' => [
        ...
        'ical' => [
            ...
            'recurring' => 'Evento recurrente «:event»: solo se importó la instancia base.',
            'recurringOutside' => 'Evento recurrente «:event»: ninguna ocurrencia en el periodo elegido.',
