...
return [
    ...
    'field' => [
        ...
        'jit_hint' => 'Crea una cuenta nueva en el primer inicio de sesión del IdP (se aplica el límite de licencia). Nunca vincula cuentas existentes — las colisiones de correo se rechazan. Solo para dominios SSO verificados y, con OIDC, correos confirmados por el IdP.',
        'jit_role' => 'Rol predeterminado JIT',
        'jit_role_none' => 'sin rol',
        'email_link_hint' => 'En el primer inicio de sesión SSO, vincular una cuenta existente por correo (solo con exactamente una coincidencia). Después solo cuentan issuer + subject. Solo con un correo confirmado por el IdP (OIDC) y un dominio SSO verificado.',
