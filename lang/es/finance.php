...
return [
    ...
    'open_times' => [
        ...
        'outside_range' => ':count registro abierto está fuera del período seleccionado.|:count registros abiertos están fuera del período seleccionado.',
        'outside_range_show_all' => 'Mostrar todos los tiempos abiertos',
        'column' => [
            'date' => 'Fecha',
            'customer' => 'Cliente',
            'project' => 'Proyecto',
    ...
    'dunning' => [
        'menu' => 'Serie de reclamaciones',
        'title' => 'Serie de reclamaciones',
        'subtitle' => 'Revisar los niveles de reclamación vencidos de las facturas gestionadas localmente y enviarlos en lote.',
        'kpi' => [
            'candidates' => 'Niveles de reclamación vencidos',
            'open_sum' => 'Importe pendiente',
            'open_sum_hint' => 'Suma de los importes pendientes de los candidatos vencidos (importe a pagar menos pagos conocidos).',
            'waiting' => 'Carencia en curso',
            'waiting_hint' => 'Facturas vencidas cuyo siguiente nivel aún no es exigible.',
            'blocked' => 'Bloqueos de reclamación',
            'blocked_hint' => 'Las facturas bloqueadas nunca aparecen en la selección.',
        ],
        'interest_active' => 'Interés de demora activo: :rate % anual sobre el importe pendiente — se indica en la carta, no se contabiliza nada.',
        'blocked_heading' => ':count factura con bloqueo de reclamación|:count facturas con bloqueo de reclamación',
        'badge_blocked' => 'Bloqueo de reclamación',
        'blocked_since' => 'bloqueada desde el :date',
        'waiting_heading' => ':count factura vencida en carencia|:count facturas vencidas en carencia',
        'waiting_until' => 'nivel :level exigible a partir del :date',
        'bulk_selected' => ':n facturas seleccionadas',
        'bulk_confirm' => '¿Registrar el siguiente nivel de reclamación para todas las facturas seleccionadas y enviar la reclamación por correo electrónico?',
        'bulk_action' => 'Enviar reclamaciones en lote',
        'select_all' => 'Seleccionar todo',
        'select_row' => 'Seleccionar factura :nr',
        'column' => [
            'customer' => 'Cliente',
            'number' => 'Número',
            'overdue_since' => 'Vencida desde',
            'open' => 'Importe pendiente',
            'current_level' => 'Nivel actual',
            'next_level' => 'Siguiente nivel',
            'fee' => 'Recargo',
        ],
        'days_overdue' => '(:count día)|(:count días)',
        'level_none' => 'sin reclamar',
        'level_n' => 'Nivel :level',
        'level_reminder' => 'Recordatorio de pago',
        'empty_title' => 'Ningún nivel de reclamación vencido',
        'empty_message' => 'Todas las facturas vencidas están reclamadas, bloqueadas o aún en carencia.',
        'error_blocked' => 'Esta factura tiene un bloqueo de reclamación.',
        'error_no_email' => 'No hay dirección de correo electrónico registrada para el cliente.',
        'error_external' => 'La factura se gestiona externamente — la reclamación se hace en el sistema principal.',
        'error_not_ready' => 'El siguiente nivel de reclamación aún no es exigible (carencia, bloqueo o nivel máximo).',
        'flash_run' => ':count reclamación enviada.|:count reclamaciones enviadas.',
        'flash_errors' => 'Sin reclamar: :errors',
        'flash_blocked' => 'Bloqueo de reclamación establecido para la factura :nr.',
        'flash_unblocked' => 'Bloqueo de reclamación retirado para la factura :nr.',
        'action_block' => 'Establecer bloqueo de reclamación',
        'action_unblock' => 'Retirar bloqueo de reclamación',
        'confirm_block' => '¿Bloquear la factura :nr para reclamaciones? No aparecerá ni en la serie de reclamaciones ni en el diálogo de reclamación.',
        'block_legend' => 'Bloqueo de reclamaciones',
        'block_reason' => 'Motivo del bloqueo',
        'block_reason_hint' => 'Por ejemplo, pago a plazos acordado, reclamación pendiente o procedimiento de insolvencia; queda registrado en la auditoría y en el documento.',
        'interest_row' => 'Intereses de demora (:rate % anual, :days días)',
        'interest_row_base' => 'Intereses de demora (:points puntos porcentuales sobre el tipo básico, actualmente :rate % anual, :days días)',
        'interest_active_base' => 'Intereses de demora activos: tipo básico + :points puntos porcentuales, actualmente :rate % anual — se indican en la carta de reclamación, sin contabilizar.',
        'interest_base_missing' => 'Los intereses de demora se basan en el tipo básico, pero aún no se ha obtenido ningún tipo básico; no se indicarán intereses hasta que se ejecute la importación (invoicing:base-rate-sync).',
        'paid_row' => 'Ya pagado',
        'interest_hint_dialog' => 'Intereses de demora indicados en la carta: :amount :currency (:rate % anual, :days días desde el vencimiento) — no se contabiliza nada.',
        'mail_interest' => 'Además indicamos intereses de demora de :amount :currency (:rate % anual, :days días desde el vencimiento).',
    ],
];
