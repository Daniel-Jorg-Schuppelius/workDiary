...
return [
    ...
    'costing' => [
        ...
        'sum' => 'Total',
        'empty' => 'No hay órdenes de fabricación terminadas en el período.',
        'open_order' => 'Abrir orden de fabricación',
        'note' => 'Coste de material según consumos registrados (si no, cantidad × coste maestro); mano de obra según tiempos asignados × tarifa horaria interna. Tasa de desecho sobre todos los partes del artículo.',
        'kpi' => [
            'orders' => 'Órdenes',
            'unit_cost_avg' => 'Coste unitario medio',
            'unit_cost_range' => 'mín :min · máx :max',
            'material' => 'Material real',
            'planned' => 'Previsto: :value',
            'deviation' => 'Desviación de material',
    ...
    'field' => [
        ...
        'copper_weight_hint' => 'Para el recargo de cobre a precio diario (DEL) y los registros Z de la exportación DATANORM.',
        'copper_base_price' => 'Base de cobre en el precio (€ por 100 kg)',
        'copper_base_price_hint' => 'Base DEL ya incluida en el precio de venta (método alemán).',
        'gtin' => 'GTIN',
