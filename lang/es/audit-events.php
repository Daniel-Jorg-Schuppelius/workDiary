...
return [
    ...
    'club' => [
        ...
        'grading' => [
            'systemCreated' => 'Reglamento de graduación creado',
            'systemUpdated' => 'Reglamento de graduación modificado',
            'systemDeleted' => 'Reglamento de graduación eliminado',
            'gradeCreated' => 'Grado creado',
            'gradeUpdated' => 'Grado modificado',
            'gradeDeleted' => 'Grado eliminado',
            'versionCreated' => 'Versión de reglas creada',
            'versionUpdated' => 'Versión de reglas modificada',
            'versionActivated' => 'Versión de reglas activada',
            'requirementSaved' => 'Requisitos guardados',
            'requirementDeleted' => 'Requisitos quitados',
            'gradeRecognized' => 'Grado reconocido',
            'gradeAwarded' => 'Grado concedido',
            'gradeRevoked' => 'Grado revocado',
            'proofAdded' => 'Justificante registrado',
            'proofUpdated' => 'Justificante modificado',
            'proofDeleted' => 'Justificante eliminado',
        ],
        'exam' => [
            'offerCreated' => 'Convocatoria creada',
            'offerUpdated' => 'Convocatoria modificada',
            'candidateRequested' => 'Candidato solicitado',
            'candidateApproved' => 'Aprobación concedida',
            'candidateAdmitted' => 'Candidato admitido',
            'candidateAdmittedByException' => 'Candidato admitido por excepción',
            'candidateRejected' => 'Candidato rechazado',
            'candidateWithdrawn' => 'Candidato retirado',
            'resultRecorded' => 'Resultado de examen registrado',
            'rechecked' => 'Admisiones revisadas',
            'reviewRequired' => 'Revisión de la admisión necesaria',
            'reviewCleared' => 'Revisión cerrada',
        ],
        'team' => [
            'profileCreated' => 'Perfil deportivo creado',
            'profileUpdated' => 'Perfil deportivo modificado',
            'profileDeleted' => 'Perfil deportivo eliminado',
            'packInstalled' => 'Paquete inicial instalado',
            'squadMemberAdded' => 'Añadido a la plantilla de temporada',
            'squadMemberUpdated' => 'Entrada de plantilla modificada',
            'squadMemberEnded' => 'Entrada de plantilla finalizada',
        ],
        'match' => [
            'created' => 'Jornada creada',
            'updated' => 'Jornada modificada',
            'lineupSaved' => 'Alineación guardada',
            'lineupReleased' => 'Alineación liberada',
            'lineupWithdrawn' => 'Liberación de alineación retirada',
            'roleAssigned' => 'Rol de la cita asignado',
            'roleRemoved' => 'Rol de la cita eliminado',
            'resultRecorded' => 'Resultado registrado',
            'proposalsImported' => 'Propuestas de calendario importadas',
            'proposalAccepted' => 'Propuesta de calendario aceptada',
            'proposalDismissed' => 'Propuesta de calendario descartada',
        ],
        'resource' => [
            'created' => 'Recurso creado',
            'updated' => 'Recurso modificado',
            'deleted' => 'Recurso eliminado',
            'booked' => 'Recurso reservado',
            'released' => 'Reserva de recurso liberada',
            'moved' => 'Reservas de recursos desplazadas con la cita',
            'closed' => 'Cierre de recurso fijado',
            'reopened' => 'Cierre de recurso levantado',
            'clearanceGranted' => 'Habilitación de recurso concedida',
            'clearanceRevoked' => 'Habilitación de recurso revocada',
        ],
        'horse' => [
            'created' => 'Caballo creado',
            'updated' => 'Caballo modificado',
            'deleted' => 'Caballo eliminado',
            'assigned' => 'Caballo asignado',
            'unassigned' => 'Asignación de caballo eliminada',
            'needsReview' => 'Clase marcada para replanificar',
            'useRecorded' => 'Uso del caballo registrado',
        ],
        'competition' => [
            'created' => 'Competición creada',
            'updated' => 'Competición modificada',
            'entered' => 'Inscripción registrada',
            'entryCleared' => 'Inscripción aclarada',
            'withdrawn' => 'Inscripción retirada',
            'startRightGranted' => 'Derecho de participación documentado',
            'startRightRevoked' => 'Derecho de participación eliminado',
            'performanceRecorded' => 'Marca registrada',
            'performanceConfirmed' => 'Marca confirmada',
            'performanceCorrected' => 'Marca corregida',
            'performanceDeleted' => 'Marca eliminada',
            'requirementCreated' => 'Requisito de asistencia creado',
            'requirementUpdated' => 'Requisito de asistencia modificado',
            'requirementDeleted' => 'Requisito de asistencia eliminado',
            'requirementExported' => 'Lista de acreditación exportada',
        ],
        'fee' => [
            'paymentRecorded' => 'Pago de cuota registrado',
            'paymentMatched' => 'Pago de cuota vinculado al movimiento bancario',
            'paymentReverted' => 'Pago de cuota revertido',
            'chargeback' => 'Devolución registrada',
            'dunned' => 'Reclamación de cuota emitida',
            'dunningMailed' => 'Reclamación enviada',
            'dunningBlocked' => 'Reclamación bloqueada',
            'dunningUnblocked' => 'Reclamación desbloqueada',
            'collectionUnblocked' => 'Cobro reactivado',
            'collectionScheduled' => 'Cobro programado',
            'runCreated' => 'Ejecución de cuotas creada',
            'runRecalculated' => 'Ejecución de cuotas recalculada',
            'runReleased' => 'Ejecución de cuotas liberada',
            'runCancelled' => 'Ejecución de cuotas descartada',
            'runExported' => 'Lista de traspaso exportada',
            'claimCreated' => 'Reclamación de cuotas creada',
            'claimCancelled' => 'Reclamación de cuotas anulada',
            'correctionCreated' => 'Corrección creada',
            'noticeMailed' => 'Notificación de cuotas enviada',
            'tariffCreated' => 'Tarifa de cuotas creada',
            'tariffUpdated' => 'Tarifa de cuotas modificada',
            'tariffDeleted' => 'Tarifa de cuotas eliminada',
            'rateCreated' => 'Tipo de tarifa creado',
            'rateUpdated' => 'Tipo de tarifa modificado',
            'rateDeleted' => 'Tipo de tarifa eliminado',
            'surchargeCreated' => 'Recargo de sección creado',
            'surchargeUpdated' => 'Recargo de sección modificado',
            'surchargeDeleted' => 'Recargo de sección eliminado',
            'accountCreated' => 'Cuenta de cuotas creada',
            'accountUpdated' => 'Cuenta de cuotas modificada',
            'assignmentCreated' => 'Asignación de cuota creada',
            'assignmentUpdated' => 'Asignación de cuota modificada',
            'assignmentEnded' => 'Asignación de cuota finalizada',
            'reviewRequired' => 'Cambio de tarifa propuesto para revisión',
            'reviewDismissed' => 'Cambio de tarifa descartado',
            'exemptionCreated' => 'Exención de cuota creada',
            'exemptionUpdated' => 'Exención de cuota modificada',
            'exemptionDeleted' => 'Exención de cuota eliminada',
        ],
        'proposal' => [
