...
return [
    ...
    'team' => [
        'title' => 'Equipo hoy',
        'subtitle' => 'Quién está ahora y qué días faltan por cerrar.',
        'present' => 'Presentes',
        'nobody_present' => 'Nadie ha fichado',
        'on_break' => 'Pausa',
        'since' => 'desde :time',
        'away' => 'Ausentes',
        'off_site' => 'fuera',
        'absent' => 'ausente',
        'unaccounted' => 'Sin fichaje',
        'open_days' => 'Cierres diarios pendientes',
        'apply' => 'Aplicar periodo',
        'no_open_days' => 'Todos los días del periodo están cerrados.',
        'day' => 'Día',
        'person' => 'Persona',
        'open' => 'Abrir día',
    ],
