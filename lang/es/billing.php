...
return [
    'feed' => [
        ...
        'kpi' => [
            ...
            'open' => 'Pendiente',
            'overdue' => 'de los cuales vencidos',
            'open_count' => '{0} ningún documento abierto|{1} :count documento abierto|[2,*] :count documentos abiertos',
            'overdue_count' => ':count de :total documentos',
