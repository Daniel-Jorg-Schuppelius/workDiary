...
return [
    ...
    'notification' => [
        'event' => [
            'club' => [
                ...
                'horseUnavailable' => 'Caballo no disponible: replanificar la clase',
            ],
            'learning' => [
    ...
    'club' => [
        ...
        'criteria-result' => [
            ...
            'grade_below' => 'Por debajo del grado mínimo',
            'grade_above' => 'Por encima del grado máximo',
            'grade_unknown' => 'Sin grado válido',
        ],
        'event-kind' => [
        ...
        'counting-basis' => [
            'since_previous_grade' => 'Desde el grado previo',
            'since_membership' => 'Desde el ingreso',
            'window_months' => 'Ventana fija',
        ],
        'grade-source' => [
            'exam' => 'Examen',
        ...
        'proof-kind' => [
            'course' => 'Justificante de curso',
            'external_training' => 'Justificante externo de entrenamiento',
        ],
        ...
        'sport-family' => [
            'team_ball' => 'Deporte de equipo con balón',
            'racket' => 'Deporte de raqueta',
            'individual' => 'Deporte individual/de competición',
            'shooting' => 'Tiro deportivo',
            'equestrian' => 'Hípica',
            'martial_arts' => 'Artes marciales',
            'boats' => 'Deporte de embarcaciones/aparatos',
            'other' => 'Otro',
        ],
        'result-format' => [
            'goals' => 'Goles',
            'period_points' => 'Puntos por periodo',
            'sets' => 'Sets',
            'none' => 'Sin resultado',
        ],
        'lineup-slot' => [
        ...
        'event-role-kind' => [
            ...
            'jury' => 'Jurado',
            'driver' => 'Transporte',
            'venue_duty' => 'Servicio de pista/vestuario',
            'range_officer' => 'Supervisor de galería',
            'coach' => 'Entrenador/a',
            'other' => 'Otro',
        ],
        ...
        'horse-kind' => [
            'school' => 'Caballo de escuela',
            'private' => 'Caballo privado',
        ],
        'entry-status' => [
            'registered' => 'Inscrito',
            'needs_review' => 'Para aclarar',
            'withdrawn' => 'Retirado',
        ],
