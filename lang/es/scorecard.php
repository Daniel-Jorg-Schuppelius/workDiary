...
return [
    ...
    'apply' => 'Mostrar',
    'weights_hint' => 'Ponderación de la puntuación global: puntualidad :ontime %, tasa de reclamaciones :complaints %, calidad ISMS :quality %, evolución de precios :price %, comportamiento ante reclamaciones de regreso :recourse %. Los indicadores no disponibles se omiten y las ponderaciones se renormalizan.',
    ...
    'metric_recourse' => 'Comportamiento ante regresos',
    'recourse_no_source' => 'No hay regresos respondidos en el periodo.',
    'recourse_detail' => ':answered de :submitted regresos respondidos; proporción aceptada.',
    'recourse_ontime' => 'Respuesta en plazo',
    'recourse_recovery' => 'Reembolso',
    'recourse_days' => 'Tiempo medio de respuesta (días)',
    'claim_costs' => 'Costes de reclamaciones en el periodo: :amount',
    'metric_lead_time' => 'Plazo de entrega (mediana)',
    'days' => ':days días',
    'lead_time_detail' => 'Mediana sobre :count pedidos, el más rápido :min, el más lento :max días (pedido hasta la última recepción).',
    'chart_lead_time' => 'Plazo de entrega de pedidos por proveedor',
    'unit_days' => 'días',
    'chart_lead_time_note' => 'Del pedido a la última recepción, pedidos completados en el periodo; un clic abre la ficha de evaluación.',
];
