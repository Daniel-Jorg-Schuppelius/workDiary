...
return [
    ...
    'type' => [
        ...
        'queue_failed_jobs' => 'Tâches d’arrière-plan échouées',
        'queue_worker_down' => 'Worker de file inactif',
    ...
    'task' => [
        ...
        'queue_failed_jobs' => ':count tâches d’arrière-plan échouées (dernière : :last) — vérifier failed_jobs, queue:retry.',
        'queue_worker_down' => 'Le worker de file ne s’est pas signalé depuis :minutes minutes — vérifier le service/cron.',
