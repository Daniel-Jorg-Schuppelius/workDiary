...
return [
    ...
    'field' => [
        ...
        'condition_teams' => 'Équipes',
        'condition_sites' => 'Sites',
        'condition_shift_types' => 'Types de poste',
        'conditions_help' => 'Vide = s\'applique à tous. Plusieurs conditions se combinent par ET ; au sein d\'une liste, une seule correspondance suffit. Le site est détecté via les pointages terminal — sans contexte déterminable, une règle conditionnelle ne s\'applique pas.',
