...
return [
    ...
    'team' => [
        ...
        'subtitle' => 'Qui est présent maintenant et quelles journées restent à clôturer.',
        'present' => 'Présents',
        'nobody_present' => 'Personne n’a pointé',
        'on_break' => 'Pause',
        'since' => 'depuis :time',
        'away' => 'Absents',
        'off_site' => 'à l’extérieur',
        'absent' => 'absent',
        'unaccounted' => 'Sans pointage',
        'open_days' => 'Clôtures de journée en attente',
        'apply' => 'Appliquer la période',
        'no_open_days' => 'Toutes les journées de la période sont clôturées.',
        'day' => 'Jour',
        'person' => 'Personne',
        'open' => 'Ouvrir la journée',
    ],
];
