...
return [
    ...
    'cadence_label' => [
        ...
        'weeklyOn' => 'Chaque :weekday à :time',
        'monthlyOn' => 'Chaque mois, le :day à :time',
    ],
    'criticality' => [
    ...
    'job' => [
        ...
        'resale' => [
            ...
            'draft_local' => 'Abonnements de revente : facturation récurrente — brouillons de facture locaux à partir des périodes échues',
        ...
        'zammad' => ['sync' => 'Synchronisation des tickets Zammad'],
        'github' => ['sync' => 'Synchronisation des issues GitHub'],
        'gitlab' => ['sync' => 'Synchronisation des issues GitLab'],
