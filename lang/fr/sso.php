...
return [
    ...
    'field' => [
        ...
        'jit_hint' => 'Crée un nouveau compte à la première connexion IdP (la limite de licence s’applique). Ne lie jamais des comptes existants — les collisions d’e-mail sont rejetées. Uniquement pour les domaines SSO vérifiés et, avec OIDC, les adresses e-mail confirmées par l’IdP.',
        'jit_role' => 'Rôle JIT par défaut',
        'jit_role_none' => 'aucun rôle',
        'email_link_hint' => 'À la première connexion SSO, lier un compte existant via l’e-mail (uniquement en cas de correspondance unique). Ensuite, seuls issuer + subject comptent. Uniquement avec une adresse e-mail confirmée par l’IdP (OIDC) et un domaine SSO vérifié.',
