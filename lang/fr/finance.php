...
return [
    ...
    // Temps ouverts (MVP-460) : liste de travail comptable des temps non facturés.
    'open_times' => [
        'menu' => 'Temps ouverts',
        'title' => 'Temps ouverts',
        'subtitle' => 'Vérifier les saisies de temps de tous les collaborateurs qui n\'ont pas encore été facturées — avant qu\'elles ne passent à la trappe.',
        'groups_heading' => 'Totaux par client & projet',
        'action' => [
            'export' => 'Export CSV',
        ...
        'kpi' => [
            'count' => 'Saisies ouvertes',
            'minutes' => 'Temps ouvert',
        ...
        'mismatch' => [
            ...
            'open_entries' => ':count saisie ouverte|:count saisies ouvertes',
        ],
        'empty_title' => 'Aucun temps ouvert',
        'empty_message' => 'Toutes les saisies de temps sont facturées ou transmises.',
        'empty_filtered' => 'Aucun temps ouvert ne correspond aux filtres sélectionnés.',
    ],
];
