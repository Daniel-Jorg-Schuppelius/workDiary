...
return [
    ...
    'dunning' => [
        'menu' => 'Série de relances',
        'title' => 'Série de relances',
        'subtitle' => 'Vérifier les niveaux de relance échus des factures gérées localement et les envoyer en lot.',
        'kpi' => [
            'candidates' => 'Niveaux de relance échus',
            'open_sum' => 'Montant ouvert',
            'open_sum_hint' => 'Somme des montants ouverts des candidats échus (montant à payer moins paiements connus).',
            'waiting' => 'Délai de carence en cours',
            'waiting_hint' => 'Factures en retard dont le prochain niveau n’est pas encore échu.',
            'blocked' => 'Blocages de relance',
            'blocked_hint' => 'Les factures bloquées n’apparaissent jamais dans la sélection.',
        ],
        'interest_active' => 'Intérêts de retard actifs : :rate % p. a. sur le montant ouvert — indiqués dans la lettre, aucune écriture.',
        'blocked_heading' => ':count facture avec blocage de relance|:count factures avec blocage de relance',
        'badge_blocked' => 'Blocage de relance',
        'blocked_since' => 'bloquée depuis le :date',
        'waiting_heading' => ':count facture en retard en carence|:count factures en retard en carence',
        'waiting_until' => 'niveau :level échu à partir du :date',
        'bulk_selected' => ':n factures sélectionnées',
        'bulk_confirm' => 'Enregistrer le prochain niveau de relance pour toutes les factures sélectionnées et envoyer la relance par e-mail ?',
        'bulk_action' => 'Envoyer la série de relances',
        'select_all' => 'Tout sélectionner',
        'select_row' => 'Sélectionner la facture :nr',
        'column' => [
            'customer' => 'Client',
            'number' => 'Numéro',
            'overdue_since' => 'Échue depuis',
            'open' => 'Montant ouvert',
            'current_level' => 'Niveau actuel',
            'next_level' => 'Niveau suivant',
            'fee' => 'Frais',
        ],
        'days_overdue' => '(:count jour)|(:count jours)',
        'level_none' => 'non relancée',
        'level_n' => 'Niveau :level',
        'level_reminder' => 'Rappel de paiement',
        'empty_title' => 'Aucun niveau de relance échu',
        'empty_message' => 'Toutes les factures en retard sont relancées, bloquées ou encore en carence.',
        'error_blocked' => 'Un blocage de relance est défini pour cette facture.',
        'error_no_email' => 'Aucune adresse e-mail enregistrée pour le client.',
        'error_external' => 'Facture gérée en externe — la relance se fait dans le système directeur.',
        'error_not_ready' => 'Prochain niveau de relance pas encore échu (carence, blocage ou niveau maximal).',
        'flash_run' => ':count relance envoyée.|:count relances envoyées.',
        'flash_errors' => 'Non relancées : :errors',
        'flash_blocked' => 'Blocage de relance défini pour la facture :nr.',
        'flash_unblocked' => 'Blocage de relance levé pour la facture :nr.',
        'action_block' => 'Définir un blocage de relance',
        'action_unblock' => 'Lever le blocage de relance',
        'confirm_block' => 'Bloquer la facture :nr pour les relances ? Elle n’apparaîtra ni dans la série de relances ni dans le dialogue de relance.',
        'block_legend' => 'Blocage des relances',
        'block_reason' => 'Motif du blocage',
        'block_reason_hint' => "Par exemple paiement échelonné convenu, réclamation en cours ou procédure d'insolvabilité ; consigné dans l'audit et sur la facture.",
        'interest_row' => 'Intérêts de retard (:rate % p. a., :days jours)',
        'interest_row_base' => "Intérêts de retard (:points points de pourcentage au-dessus du taux de base, actuellement :rate % l'an, :days jours)",
        'interest_active_base' => "Intérêts de retard actifs : taux de base + :points points de pourcentage, actuellement :rate % l'an — indiqués dans la lettre de relance, sans comptabilisation.",
        'interest_base_missing' => "Les intérêts de retard sont réglés sur le taux de base, mais aucun taux de base n'a encore été récupéré — aucun intérêt n'est indiqué tant que l'import (invoicing:base-rate-sync) n'a pas été exécuté.",
        'paid_row' => 'Déjà payé',
        'interest_hint_dialog' => 'Intérêts de retard indiqués dans la lettre : :amount :currency (:rate % p. a., :days jours depuis l’échéance) — aucune écriture.',
        'mail_interest' => 'Nous indiquons en outre des intérêts de retard de :amount :currency (:rate % p. a., :days jours depuis l’échéance).',
    ],
];
