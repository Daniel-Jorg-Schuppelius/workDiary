...
return [
    ...
    'apply' => 'Afficher',
    'weights_hint' => 'Pondération du score global : respect des délais :ontime %, taux de réclamation :complaints %, qualité ISMS :quality %, évolution des prix :price %, comportement en recours :recourse %. Les indicateurs indisponibles sont ignorés et les pondérations renormalisées.',
    ...
    'metric_recourse' => 'Comportement en recours',
    'recourse_no_source' => 'Aucun recours avec réponse dans la période.',
    'recourse_detail' => ':answered recours sur :submitted avec réponse ; part acceptée.',
    'recourse_ontime' => 'Réponse dans le délai',
    'recourse_recovery' => 'Remboursement',
    'recourse_days' => 'Délai de réponse moyen (jours)',
    'claim_costs' => 'Coûts de réclamation dans la période : :amount',
    'metric_lead_time' => 'Délai de traitement (médiane)',
    'days' => ':days jours',
    'lead_time_detail' => 'Médiane sur :count commandes, la plus rapide :min, la plus lente :max jours (commande jusqu’à la dernière réception).',
    'chart_lead_time' => 'Délai de commande par fournisseur',
    'unit_days' => 'jours',
    'chart_lead_time_note' => 'De la commande à la dernière réception, commandes terminées dans la période ; un clic ouvre la fiche d’évaluation.',
];
