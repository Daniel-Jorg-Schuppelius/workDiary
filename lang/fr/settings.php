...
return [
    ...
    'dunning' => [
        ...
        'interest_rate_hint' => '0 = pas d’indication d’intérêts. Repère § 288 BGB : 5 ou 9 points au-dessus du taux de base — le taux est géré manuellement ici (pas de flux du taux de base). Indication dans la lettre uniquement, aucune écriture.',
    ],
];
