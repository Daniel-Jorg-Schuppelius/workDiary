...
return [
    ...
    'field' => [
        ...
        'channels' => 'Canaux',
        'channels_sms_hint' => 'Les SMS ne parviennent qu’aux personnes dont le numéro de mobile est confirmé et sont facturés à l’unité — ils ne sont donc disponibles que pour les événements critiques.',
    ...
    'message' => [
        ...
        'club_event_reminder' => 'Rappel pour :name : « :title » commence le :date.',
        ...
        'weather_warning_title' => 'Alerte météo :date — :title',
        'weather_warning_rain' => 'Fortes pluies prévues : :value mm/jour (seuil :limit mm).',
        'weather_warning_gust' => 'Rafales de tempête prévues : jusqu’à :value km/h (seuil :limit km/h).',
        'weather_warning_frost' => 'Gel prévu : minimum :value °C (seuil :limit °C).',
        'weather_warning_heat' => 'Chaleur prévue : maximum :value °C (seuil :limit °C).',
        ...
        'email_changed_title' => 'Adresse de connexion modifiée',
        ...
        'overtime_requested_title' => 'Demande d\'heures supplémentaires de :user pour :date (:minutes min)',
        'overtime_decided_title' => 'Décision sur votre demande d\'heures supplémentaires (:date)',
        'overtime_approved' => 'Votre demande d\'heures supplémentaires a été approuvée. :note',
        'overtime_rejected' => 'Votre demande d\'heures supplémentaires a été refusée. :note',
        'vacation_requested_title' => 'Demande de congé de :user (:from – :to)',
        'vacation_decided_title' => 'Décision sur votre demande de congé (:from – :to)',
        'vacation_approved' => 'Votre demande de congé a été approuvée. :note',
        'vacation_rejected' => 'Votre demande de congé a été refusée. :note',
        'unclear_case_title' => 'Cas à clarifier le :date',
        'open_attendance_title' => 'Vous êtes pointé depuis :time',
        'open_attendance_body' => 'Pointez votre départ si vous avez déjà terminé — sinon le système clôturera le pointage automatiquement plus tard.',
        ...
        'tender_submission_due_soon' => 'Remise avant le :date.',
        'tender_submission_overdue' => 'La date limite était le :date.',
        ...
        'training_due' => 'Formation obligatoire « :course » à échéance le :date.',
