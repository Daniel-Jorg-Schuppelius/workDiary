...
return [
    ...
    'fixed_assets' => [
        'heading' => 'Cespiti: beni di modesto valore e fondo collettivo',
        'description' => 'Limiti di valore (netti) per l’ammortamento immediato dei beni di modesto valore e per il fondo collettivo. I valori predefiniti seguono il § 6 c. 2/2a EStG (stato 2026) — verificarli in caso di modifiche di legge.',
        'gwg_limit' => 'Limite beni di modesto valore',
    ...
    'claims_pattern' => [
        ...
        'description' => 'Da quanti reclami simili (stesso lotto, stesso articolo con lo stesso tipo di difetto o causa, stesso fornitore) nasce un’indicazione.',
        'threshold' => 'Soglia (casi)',
    ...
    'dunning' => [
        ...
        'interest_rate_hint' => 'Solo con tasso fisso; 0 = nessuna indicazione di interessi. Solo indicato nel sollecito, nessuna registrazione.',
        'interest_mode' => 'Calcolo degli interessi di mora',
        'interest_mode_hint' => 'Tasso fisso o tasso base secondo il § 247 BGB (rilevato mensilmente dalla Bundesbank) più punti percentuali.',
        'interest_mode_fixed' => 'Tasso fisso',
