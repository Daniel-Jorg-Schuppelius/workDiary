...
return [
    ...
    'dialog' => [
        'label' => 'Denominazione',
        'item_type' => 'Tipo di punto',
        'parent' => 'Sotto il gruppo',
        'required' => 'Punto obbligatorio',
        'options' => 'Valori di scelta',
        'options_hint' => 'Solo per scelta singola e multipla: un valore per riga.',
        'unit' => 'Unità',
        'min' => 'Minimo',
        'max' => 'Massimo',
        'not_fillable' => 'Questo punto non si compila qui: foto tramite la striscia foto, firme alla chiusura.',
        'result' => 'Esito',
        'result_hint' => 'Lasciare vuoto per ricavarlo dal valore.',
        'note' => 'Nota',
        'sign_hint' => 'La chiusura blocca il protocollo e lo archivia in PDF.',
        'with_signature' => 'Acquisire la firma',
        'signer_name' => 'Nome',
        'signer_email' => 'E-mail',
        'role' => 'Ruolo',
        'method' => 'Modalità di firma',
        'reason' => 'Motivazione',
        'token_title' => 'Inviare link di firma',
        'token_submit' => 'Creare link',
        'token_hint' => 'La persona riceve un link per verificare e firmare il protocollo senza accedere.',
        'ttl_days' => 'Validità (giorni)',
        'token_url_hint' => 'Link di firma creato. Se l’e-mail non arriva, può inoltrare questo link:',
        'archive_confirm' => 'Archiviare il protocollo?',
        'remove_confirm' => 'Rimuovere il punto «:label»?',
        'defect_severity' => 'Gravità',
        'defect_category' => 'Categoria',
        'defect_description' => 'Descrizione del difetto',
        'measurement_add' => 'Nuova misura per «:label»',
        'measurement_count' => ':count misure registrate',
    ],
    'template' => [
        'title' => 'Modelli di protocollo',
        'subtitle' => 'I modelli nascono da un protocollo campione; qui ne gestisce assegnazione e validità.',
        'search' => 'Ricerca',
        'name' => 'Nome',
        'target' => 'Assegnazione',
        'items' => 'Punti',
        ...
        'confirm_delete' => 'Eliminare il modello «:name»? I protocolli esistenti restano invariati.',
        'empty_title' => 'Nessun modello di protocollo',
        'empty' => 'Crei un protocollo, registri i punti e scelga «Salva come modello».',
        'entry_type' => 'Tipo di ordine',
        'target_hint' => 'Lasciare vuoto per proporre il modello ovunque.',
        'customer' => 'Cliente',
        'any' => 'Tutti',
        'validity' => 'Valido dal / al',
        'save_title' => 'Salva come modello',
        'save_hint' => 'Vengono ripresi i punti con la loro configurazione, non i valori registrati.',
        'save' => 'Salva modello',
        'update_existing' => 'Aggiornare il modello «:name» (versione :version) invece di crearne uno nuovo',
        'choose' => 'Modello',
        'choose_hint' => 'Il modello porta con sé i suoi punti.',
        'none' => 'Senza modello',
        'flash' => [
            'updated' => 'Modello salvato.',
            'deleted' => 'Modello eliminato.',
            'created' => 'Modello «:name» creato.',
            'versioned' => 'Modello «:name» aggiornato alla versione :version.',
        ],
    ],
];
