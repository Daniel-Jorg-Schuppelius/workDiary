...
/*
 * Chiusura giornaliera (MVP-015, WorkDiary-Architecture/tagesabschluss.md) — testi della
...
return [
    ...
    'errors' => [
        'month_entry_locked' => 'Il mese è approvato: per tempi successivi presenti una richiesta di correzione.',
    ...
    'team' => [
        'title' => 'Team oggi',
        'subtitle' => 'Chi è presente ora e quali giornate devono ancora essere chiuse.',
        'present' => 'Presenti',
        'nobody_present' => 'Nessuno ha timbrato',
        'on_break' => 'Pausa',
        'since' => 'dalle :time',
        'away' => 'Assenti',
        'off_site' => 'fuori sede',
        'absent' => 'assente',
        'unaccounted' => 'Senza timbratura',
        'open_days' => 'Chiusure giornaliere aperte',
        'apply' => 'Applica periodo',
        'no_open_days' => 'Tutte le giornate del periodo sono chiuse.',
        'day' => 'Giorno',
        'person' => 'Persona',
        'open' => 'Apri giornata',
    ],
