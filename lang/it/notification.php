...
return [
    'title' => [
        'center' => 'Notifiche',
        'center_subtitle' => 'Le sue notifiche in-app — lette e non lette.',
        'empty' => 'Nessuna notifica.',
        'empty_message' => 'Non appena un evento la riguarda, apparirà qui.',
    ...
    'field' => [
        ...
        'channels' => 'Canali',
        'channels_sms_hint' => 'Gli SMS raggiungono solo le persone con numero di cellulare confermato e hanno un costo per messaggio: perciò sono selezionabili solo per eventi critici.',
        ...
        'yes' => 'Sì',
        'no' => 'No',
        'mail_enabled' => 'Ricevere notifiche via e-mail',
    ...
    'message' => [
        'learning_enrolled' => 'Le è stato assegnato il corso «:course».',
        'learning_enrolled_with_due' => 'Le è stato assegnato il corso «:course» — scadenza il :date.',
        'learning_due_soon' => 'Il corso «:course» scade il :date.',
        'learning_overdue' => 'Il corso «:course» scadeva il :date e non è ancora completato.',
        'learning_submission_received' => ':name ha consegnato il compito «:assignment» del corso «:course».',
        'learning_graded' => 'Il suo compito «:assignment» del corso «:course» è stato valutato.',
        'learning_returned' => 'Il suo compito «:assignment» del corso «:course» è stato restituito per la revisione.',
        'learning_certificate_issued' => 'Il suo certificato :number per il corso «:course» è stato emesso.',
        'learning_waitlist_promoted' => 'Si è liberato un posto per «:title» il :date — è iscritto/a.',
        'club_event_reminder' => 'Promemoria per :name: «:title» inizia il :date.',
        'club_event_rescheduled' => '«:title» (:name) è stato spostato — nuovo inizio :date, prima :previous.',
        'club_event_cancelled' => '«:title» del :date (:name) è stato annullato.',
        'club_waitlist_promoted' => 'Si è liberato un posto per «:title» il :date — :name è iscritto/a.',
        'club_horse_unavailable' => 'Il cavallo «:horse» non è disponibile (:reason): «:title» il :date con :rider richiede una nuova assegnazione.',
        'learning_booking_confirmed' => 'La sua prenotazione per il corso «:course» è stata confermata.',
        'learning_booking_rejected' => 'La sua prenotazione per il corso «:course» è stata rifiutata.',
        'learning_time_approval_requested' => ':name ha registrato :minutes minuti di apprendimento per «:course» fuori dall’orario di lavoro — serve l’approvazione.',
        'learning_question_asked' => ':name chiede su «:course»: :question',
        ...
        'weather_warning_title' => 'Allerta meteo :date — :title',
        'weather_warning_rain' => 'Pioggia intensa prevista: :value mm/giorno (soglia :limit mm).',
        'weather_warning_gust' => 'Raffiche di tempesta previste: fino a :value km/h (soglia :limit km/h).',
        'weather_warning_frost' => 'Gelo previsto: minima :value °C (soglia :limit °C).',
        'weather_warning_heat' => 'Caldo previsto: massima :value °C (soglia :limit °C).',
        'new_device_title' => 'Accesso da nuovo dispositivo',
        'new_device_message' => 'Nuovo accesso con :device da :country. Se non era Lei, cambi subito la password e controlli le sue sessioni.',
        'email_changed_title' => 'E-mail di accesso modificata',
        'email_changed_message' => 'L’indirizzo di accesso del suo account è stato cambiato in :email. Se non è stato Lei, cambi subito la password e avvisi l’amministrazione.',
        'passkey_added_title' => 'Nuova passkey aggiunta',
        'passkey_added_message' => 'Al suo account è stata aggiunta una nuova chiave di sicurezza o passkey. Se non è stato Lei, la rimuova subito e cambi la password.',
        'two_factor_lockout_title' => 'Stanno indovinando il secondo fattore',
        'two_factor_lockout_message' => 'Sul suo account sono stati inseriti troppi codici a due fattori errati e l’accesso è stato interrotto. Se non è stato Lei, cambi la password: qualcuno potrebbe già conoscerla.',
        'lockout_title' => 'Troppi tentativi falliti — account bloccato brevemente',
        'lockout_message' => 'Il suo account è stato oggetto di più tentativi di accesso falliti ed è stato bloccato brevemente. Se non era Lei, cambi la password.',
        ...
        'impossible_travel_message' => 'Accesso da :to, prima :from — :distance km in :hours h (:speed km/h). Se non era Lei: cambi la password e termini le sessioni.',
        'issue_assigned' => ':actor le ha assegnato questo punto aperto.',
        ...
        'correction_decided_title' => 'Decisione sulla sua richiesta di correzione (:date)',
        'correction_approved' => 'La sua richiesta è stata approvata. :note',
        'correction_rejected' => 'La sua richiesta è stata respinta. :note',
        'overtime_requested_title' => 'Richiesta di straordinario di :user per :date (:minutes min)',
        'overtime_decided_title' => 'Decisione sulla sua richiesta di straordinario (:date)',
        'overtime_approved' => 'La sua richiesta di straordinario è stata approvata. :note',
        'overtime_rejected' => 'La sua richiesta di straordinario è stata respinta. :note',
        'vacation_requested_title' => 'Richiesta di ferie di :user (:from – :to)',
        'vacation_decided_title' => 'Decisione sulla sua richiesta di ferie (:from – :to)',
        'vacation_approved' => 'La sua richiesta di ferie è stata approvata. :note',
        'vacation_rejected' => 'La sua richiesta di ferie è stata respinta. :note',
        'unclear_case_title' => 'Caso da chiarire il :date',
        'open_attendance_title' => 'Ha timbrato l\'entrata alle :time',
        'open_attendance_body' => 'Timbri l\'uscita se ha già finito, altrimenti il sistema chiuderà la timbratura automaticamente più tardi.',
        ...
        'procedure_deviation_escalated' => 'La deviazione nel passo «:step» (:severity) è stata escalata: :reason',
        'safety_assessment_review_due' => 'Revisione della valutazione dei rischi in scadenza il :date.',
        'safety_instruction_due' => 'Formazione sulla sicurezza «:topic» da ripetere entro il :date.',
        'safety_checkup_due' => 'Sorveglianza sanitaria (:kind) in scadenza il :date.',
        'training_due' => 'Corso obbligatorio «:course» in scadenza il :date.',
