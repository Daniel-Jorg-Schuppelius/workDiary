...
return [
    ...
    'job' => [
        ...
        'learning' => [
            'close_stale_sessions' => 'Chiudere le sessioni di apprendimento rimaste aperte',
        ...
        'caldav' => ['publish' => 'Riconciliazione pubblicazione calendario CalDAV', 'import' => 'Reimportazione calendario CalDAV'],
        'carddav' => ['sync' => 'Sincronizzazione CardDAV'],
        'sevdesk' => ['pull-vouchers' => 'Recupera i documenti sevDesk'],
        ...
        'cloud-intake' => ['sync' => 'Recuperare la ricezione documenti cloud', 'wake' => 'Recupera le connessioni cloud risvegliate'],
        'peppol' => ['receive' => 'Recuperare la posta Peppol'],
        ...
        'resale' => [
            ...
            'draft_local' => 'Abbonamenti in rivendita: fatturazione ricorrente — bozze di fattura locali dai periodi scaduti',
        ...
        'search' => ['reconcile' => 'Riallineare l’indice di ricerca (ricerca attività)'],
        ...
        'zammad' => ['sync' => 'Sincronizzazione ticket Zammad'],
        'github' => ['sync' => 'Sincronizzazione issue GitHub'],
        'gitlab' => ['sync' => 'Sincronizzazione issue GitLab'],
