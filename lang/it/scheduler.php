...
return [
    ...
    'job' => [
        ...
        'caldav' => ['publish' => 'Riconciliazione pubblicazione calendario CalDAV'],
        'carddav' => ['sync' => 'Sincronizzazione CardDAV'],
        'catalog' => ['fetch_due' => 'Recuperare le fonti di catalogo', 'apply_pending_prices' => 'Attivare i listini programmati'],
        'tenders' => ['fetch_notices' => 'Recuperare i bandi'],
        'chat' => [
        ...
        'google-calendar' => ['publish' => 'Riconciliazione pubblicazione calendario Google'],
        ...
        'msgraph' => [
            'calendar-import' => 'Importazione bidirezionale del calendario',
            'publish' => 'Riconciliazione pubblicazione calendario Microsoft 365',
            'subscriptions' => 'Rinnovo delle sottoscrizioni webhook Microsoft 365',
            'todo-sync' => 'Sincronizzazione Microsoft To Do',
        ],
        ...
        'clockify' => ['push' => 'Esportare i tempi in Clockify'],
        'toggl' => ['push' => 'Esporta i tempi verso Toggl', 'import' => 'Import Toggl'],
