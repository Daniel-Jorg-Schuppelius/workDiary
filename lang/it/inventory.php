...
return [
    ...
    'stock' => 'Giacenza',
    'bins' => 'Ubicazioni di magazzino',
    // MVP-706: Art des Lagerorts (fest/Fahrzeug/Standort/Team).
    'kind' => [
        'fixed' => 'Magazzino fisso',
        'vehicle' => 'Scorta veicolo',
        'site' => 'Scorta sede',
        'team' => 'Scorta team',
    ],
    'subtitle' => [
    ...
    'action' => [
        ...
        'create_bin' => 'Crea ubicazione',
        'edit_bin' => 'Modifica ubicazione',
        'manage_bins' => 'Ubicazioni',
        'block_bin' => 'Blocca',
        'unblock_bin' => 'Sblocca',
        'pick_list' => 'Lista di prelievo',
        'pick_list_pdf' => 'Lista di prelievo (PDF)',
    ],
    'field' => [
        'code' => 'Codice',
        'default' => 'Predefinito',
    ...
    'empty' => [
        ...
        'bins' => 'Nessuna ubicazione ancora creata.',
        'pick_list' => 'Nessuna posizione aperta per questa origine.',
    ],
    'confirm' => [
        'delete_warehouse' => 'Eliminare davvero questo magazzino? Possibile solo senza movimenti.',
        'delete_bin' => 'Eliminare davvero questa ubicazione? Possibile solo senza movimenti.',
    ],
    'flash' => [
        ...
        'bin_created' => 'Ubicazione creata.',
        'bin_updated' => 'Ubicazione aggiornata.',
        'bin_deleted' => 'Ubicazione eliminata.',
        'bin_delete_blocked' => 'Impossibile eliminare l’ubicazione: esistono movimenti.',
        'bin_blocked' => 'Ubicazione bloccata.',
        'bin_unblocked' => 'Ubicazione sbloccata.',
    ],
    'reservation_status' => [
        'active' => 'Attiva',
        'fulfilled' => 'Evasa',
    ...
    'pick_list' => [
        ...
        'subtitle' => 'Posizioni aperte per magazzino, ubicazione e lotto (FEFO).',
        'source' => 'Origine',
        'number' => 'N.',
        'position' => 'Pos.',
        'available' => 'Disponibile nell’ubicazione',
        'footer_note' => 'Ordine: magazzino → ubicazione → lotto (scadenza più vicina prima).',
        'lines' => 'Posizioni',
    ],
    'error' => [
        'bin_foreign' => 'L’ubicazione non appartiene a questo magazzino.',
        'bin_with_customer' => 'La contabilizzazione dei costi materiali a un cliente è possibile solo senza ubicazione.',
        'bin_unusable' => 'L’ubicazione :code è bloccata o inattiva — registrazione non possibile.',
        'warehouse_unusable' => 'Il magazzino :name è bloccato o inattivo — registrazione non possibile.',
