...
return [
    ...
    'field' => [
        ...
        'jit_hint' => 'Crea un nuovo account al primo accesso IdP (vale il limite di licenza). Non collega mai account esistenti — le collisioni e-mail vengono rifiutate. Solo per domini SSO verificati e, con OIDC, indirizzi e-mail confermati dall’IdP.',
        'jit_role' => 'Ruolo predefinito JIT',
        'jit_role_none' => 'nessun ruolo',
        'email_link_hint' => 'Al primo accesso SSO, collega un account esistente tramite e-mail (solo con esattamente una corrispondenza). In seguito contano solo issuer + subject. Solo con un’e-mail confermata dall’IdP (OIDC) e un dominio SSO verificato.',
