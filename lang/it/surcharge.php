...
return [
    ...
    'field' => [
        ...
        'condition_teams' => 'Team',
        'condition_sites' => 'Sedi',
        'condition_shift_types' => 'Tipi di turno',
        'conditions_help' => 'Vuoto = vale per tutti. Più condizioni si combinano in AND; all\'interno di una lista basta una corrispondenza. La sede viene rilevata dalle timbrature terminale — senza contesto determinabile una regola condizionata non si applica.',
