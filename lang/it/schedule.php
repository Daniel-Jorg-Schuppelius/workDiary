...
return [
    ...
    'availability' => [
        ...
        'subtitle' => 'Gestisca la sua disponibilità e le preferenze sui turni. La pianificazione ne tiene conto per i suggerimenti di copertura.',
    ...
    'exchange' => [
        ...
        'error_not_target' => 'Non è il partner di scambio richiesto.',
        ...
        'notification_pending_message' => 'Lo scambio turno del :date attende la sua approvazione.',
        'notification_decided_title' => 'Scambio turno deciso',
        'notification_decided_message' => 'Il suo scambio turno del :date è stato :status.',
    ],
    'suggest' => [
        'button' => 'Suggerimenti',
