...
return [
    ...
    'sales' => [
        ...
        'lead_source' => ['referral' => 'Passaparola', 'web' => 'Web', 'trade_fair' => 'Fiera', 'phone' => 'Telefono', 'booking' => 'Prenotazione appuntamento', 'other' => 'Altro'],
    ],
    ...
    'notification' => [
        'event' => [
            'club' => [
                'eventReminder' => 'Promemoria appuntamento associativo',
                'eventRescheduled' => 'Appuntamento associativo spostato',
                'eventCancelled' => 'Appuntamento associativo annullato',
                'waitlistPromoted' => 'Posto assegnato dalla lista d\'attesa',
                'horseUnavailable' => 'Cavallo non disponibile — ripianificare la lezione',
            ],
            'learning' => [
            ...
            'attendance' => [
                ...
                'openReminder' => 'Promemoria: timbratura ancora aperta',
            ],
            'monthClosure' => [
    ...
    // Chiusura giornaliera (MVP-015, WorkDiary-Architecture/tagesabschluss.md §3/§5).
    'dayClosure' => [
        'status' => [
            'open' => 'Aperto',
            'closed' => 'Chiuso',
    ...
    'backup' => [
        ...
        'provider' => [
            ...
            's3' => 'Archiviazione compatibile S3',
        ],
        'target_status' => [
            'draft' => 'Bozza',
            'active' => 'Attiva',
    ...
    'club' => [
        'membership-kind' => [
            ...
            'active' => 'Attivo',
            'passive' => 'Passivo',
            'supporting' => 'Socio sostenitore',
            'paused' => 'In pausa',
        ],
        'admission-mode' => [
            'leader' => 'Tramite responsabile',
            'application' => 'Richiesta con approvazione',
        ],
        ...
        'criteria-result' => [
            'met' => 'Soddisfatto',
            'age_below' => 'Sotto l\'età minima',
            'age_above' => 'Sopra l\'età massima',
            'review_required' => 'Verifica necessaria',
            'grade_below' => 'Sotto il grado minimo',
            'grade_above' => 'Sopra il grado massimo',
            'grade_unknown' => 'Nessun grado valido',
        ],
        'event-kind' => [
            'competition' => 'Gara',
            'match' => 'Giornata',
            'training' => 'Allenamento / prova',
            'course' => 'Corso',
            'exam' => 'Esame',
            'meeting' => 'Assemblea',
            'other' => 'Altro appuntamento',
        ],
        'event-visibility' => [
            'club' => 'Tutta l\'associazione',
            'groups' => 'Gruppi specifici',
            'invited' => 'Invito personale',
        ],
        ...
        'participation-source' => [
            'admin' => 'Amministrazione',
            'leader' => 'Responsabile di gruppo',
            'guardian' => 'Rappresentante',
            'self' => 'Il socio stesso',
            'spontaneous' => 'Spontaneo (responsabile)',
            'invitation' => 'Invito',
        ],
        ...
        'counting-basis' => [
            'since_previous_grade' => 'Dal grado precedente',
            'since_membership' => 'Dall\'iscrizione',
            'window_months' => 'Finestra fissa',
        ],
        'grade-source' => [
            'exam' => 'Esame',
        ...
        'proof-kind' => [
            'course' => 'Attestazione di corso',
            'external_training' => 'Attestazione esterna di allenamento',
        ],
        ...
        'fee-payment-source' => [
            ...
            'sepa' => 'Lotto di incasso',
            'chargeback' => 'Storno',
            'credit' => 'Credito',
        ],
        'sport-family' => [
            'team_ball' => 'Sport di squadra con palla',
            'racket' => 'Sport di racchetta',
            'individual' => 'Sport individuale/di gara',
            'shooting' => 'Tiro sportivo',
            'equestrian' => 'Equitazione',
            'martial_arts' => 'Arti marziali',
            'boats' => 'Sport nautici/con attrezzi',
            'other' => 'Altro',
        ],
        'result-format' => [
            'goals' => 'Gol',
            'period_points' => 'Punti per periodo',
            'sets' => 'Set',
        ...
        'event-role-kind' => [
            ...
            'jury' => 'Giuria',
            'driver' => 'Trasporto',
            'venue_duty' => 'Servizio campo/spogliatoio',
            'range_officer' => 'Direttore di tiro',
        ...
        'horse-kind' => [
            'school' => 'Cavallo di scuola',
            'private' => 'Cavallo privato',
        ],
        'entry-status' => [
            'registered' => 'Iscritto',
            'needs_review' => 'Da chiarire',
            'withdrawn' => 'Ritirato',
        ],
        ...
        'notification-status' => [
            'sent' => 'Consegnato',
            'failed' => 'Errore di consegna',
        ],
        'attendance-status' => [
            'present' => 'Presente',
            'partial' => 'Parzialmente presente',
            'excused' => 'Giustificato',
            'absent' => 'Assente',
        ],
        'guardian-permission' => [
            'register' => 'Iscrivere e disdire',
