...
return [
    ...
    'weather' => [
        ...
        'warnings_heading' => 'Wetterwarnungen für die Disposition',
        'warnings_enabled' => 'Wetterwarnungen für disponierte Einsätze',
        'warnings_enabled_hint' => 'Prüft stündlich die Tagesvorhersage (nur Open-Meteo) für Einsätze der nächsten 3 Tage mit Koordinaten und meldet Schwellenüberschreitungen genau einmal je Einsatz, Tag und Schwelle. Standard: an.',
        'warn_rain_mm' => 'Regen (mm/Tag)',
        'warn_gust_kmh' => 'Böen (km/h)',
        'warn_frost_c' => 'Frost ab Tiefstwert (°C)',
        'warn_heat_c' => 'Hitze ab Höchstwert (°C)',
        'warn_hint' => 'Standard: 20 mm/Tag, 60 km/h, 0 °C, 30 °C.',
    ],
    ...
    'fixed_assets' => [
        'heading' => 'Anlagen: GWG und Sammelposten',
        'description' => 'Wertgrenzen (netto) für die Sofortabschreibung geringwertiger Wirtschaftsgüter und den Sammelposten. Die Vorgaben entsprechen § 6 Abs. 2/2a EStG (Stand 2026) — bitte bei Gesetzesänderungen prüfen.',
        'gwg_limit' => 'GWG-Grenze',
    ...
    'claims_pattern' => [
        ...
        'description' => 'Ab wie vielen gleichartigen Reklamationen (gleiche Charge, gleicher Artikel mit gleicher Mangelart oder Ursache, gleicher Lieferant) ein Hinweis entsteht.',
        'threshold' => 'Schwelle (Fälle)',
    ...
    'dunning' => [
        'heading' => 'Mahnwesen',
        'description' => 'Stufen-Defaults für Einzelmahnung und Mahnlauf: Karenz, Gebühr und Zahlungsfrist je Mahnstufe sowie Verzugszins auf den offenen Betrag.',
        'grace_days' => 'Stufe :level: Karenz (Tage)',
        'grace_days_hint_first' => 'Tage Überfälligkeit, bevor Stufe 1 (Zahlungserinnerung) fällig wird.',
        'grace_days_hint_next' => 'Tage seit der letzten Mahnung, bevor diese Stufe fällig wird.',
        'fee' => 'Stufe :level: Gebühr (EUR)',
        'pay_days' => 'Stufe :level: Zahlungsfrist (Tage)',
        'interest_rate' => 'Verzugszins (% p. a.)',
        'interest_rate_hint' => 'Nur beim festen Satz; 0 = kein Zinsausweis. Nur Ausweis im Mahnschreiben, keine Buchung.',
        'interest_mode' => 'Verzugszins berechnen',
        'interest_mode_hint' => 'Fester Satz oder Basiszinssatz nach § 247 BGB (monatlicher Abruf bei der Bundesbank) zuzüglich Prozentpunkten.',
        'interest_mode_fixed' => 'Fester Satz',
