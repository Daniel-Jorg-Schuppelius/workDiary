...
return [
    ...
    'permission' => [
        ...
        'club.viewAny' => 'Vereinsregister sehen (Mitglieder, Gruppen)',
        'club.manage' => 'Verein verwalten (Mitglieder, Gruppen, Vertretungen, Import)',
        'club.groups.lead' => 'Gruppenleitung (eigene Gruppen führen)',
        'club.grading.manage' => 'Graduierungen verwalten (Ordnungen, Anerkennungen, Nachweise)',
        'club.exams.examine' => 'Prüfer (Prüfungsergebnisse erfassen)',
        'club.fees.manage' => 'Beiträge verwalten (Tarife, Beitragskonten, Befreiungen, Läufe, Zahlungen, Einzug)',
        'training.viewAny' => 'Schulungskatalog und Soll sehen',
        'training.manage' => 'Schulungen verwalten (Katalog, Pflichtmatrix, Soll)',
        'learning.viewAny' => 'Lernfortschritte aller sehen',
        'learning.author' => 'Lernkurse erstellen und bearbeiten',
        'learning.release' => 'Lernkurse freigeben und archivieren',
        'learning.grade' => 'Aufgaben und Aufsätze bewerten',
        'learning.manage' => 'Lernen verwalten (Zuweisungen, Gruppen, Katalog)',
        ...
        'hrFile.viewAny' => 'Personalakten sehen (alle Mitarbeiter)',
        'hrFile.create' => 'Personalakten-Dokumente aufnehmen',
        'hrFile.update' => 'Personalakten-Dokumente bearbeiten',
        'hrFile.delete' => 'Personalakten-Dokumente vernichten',
