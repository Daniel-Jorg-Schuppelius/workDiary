...
return [
    ...
    'team' => [
        'title' => 'Team heute',
        'subtitle' => 'Wer jetzt da ist und welche Tage noch abgeschlossen werden müssen.',
        'present' => 'Anwesend',
        'nobody_present' => 'Niemand eingestempelt',
        'on_break' => 'Pause',
        'since' => 'seit :time',
        'away' => 'Abwesend',
        'off_site' => 'außer Haus',
        'absent' => 'abwesend',
        'unaccounted' => 'Ohne Stempel',
        'open_days' => 'Offene Tagesabschlüsse',
        'apply' => 'Zeitraum anwenden',
        'no_open_days' => 'Alle Tage im Zeitraum sind abgeschlossen.',
        'day' => 'Tag',
        'person' => 'Person',
        'open' => 'Tag öffnen',
    ],
