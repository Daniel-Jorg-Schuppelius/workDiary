...
return [
    ...
    'dunning' => [
        ...
        'block_legend' => 'Mahnsperre',
        'block_reason' => 'Grund der Sperre',
        'block_reason_hint' => 'Zum Beispiel Ratenzahlung vereinbart, Reklamation offen oder Insolvenzverfahren; steht im Audit und am Beleg.',
        'interest_row' => 'Verzugszinsen (:rate % p. a., :days Tage)',
        'interest_row_base' => 'Verzugszinsen (:points Prozentpunkte über dem Basiszinssatz, derzeit :rate % p. a., :days Tage)',
        'interest_active_base' => 'Verzugszins aktiv: Basiszinssatz + :points Prozentpunkte, derzeit :rate % p. a. — Ausweis im Mahnschreiben, keine Buchung.',
        'interest_base_missing' => 'Verzugszins nach Basiszinssatz eingestellt, aber noch kein Basiszinssatz abgerufen — es wird kein Zins ausgewiesen, bis der Abruf (invoicing:base-rate-sync) gelaufen ist.',
        'paid_row' => 'Bereits gezahlt',
