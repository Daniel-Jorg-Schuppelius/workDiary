...
return [
    ...
    'dialog' => [
        ...
        'before' => 'Tage vor Periodenbeginn (Vorauszahlung)',
        'after' => 'Tage nach Periodenbeginn (Nachberechnung)',
        'window_hint' => 'Eine Rechnung zählt zur Periode, wenn ihr Datum in diesem Fenster um den Periodenbeginn liegt. Nach hinten großzügig lassen (Standard zwei Jahre): Nachberechnungen und Mehrjahresblöcke werden in Lizenzmonaten zugeteilt, nichts zählt doppelt.',
