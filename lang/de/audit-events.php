...
return [
    ...
    'invoice' => [
        ...
        'peppolSent' => 'Rechnung über Peppol zugestellt',
    ],
    'isms' => [
        'audit' => [
    ...
    'customer' => [
        ...
        'peppolChecked' => 'Peppol-Registrierung geprüft',
    ],
    ...
    'club' => [
        ...
        'grading' => [
            'systemCreated' => 'Graduierungsordnung angelegt',
            'systemUpdated' => 'Graduierungsordnung geändert',
            'systemDeleted' => 'Graduierungsordnung gelöscht',
            'gradeCreated' => 'Grad angelegt',
            'gradeUpdated' => 'Grad geändert',
            'gradeDeleted' => 'Grad gelöscht',
            'versionCreated' => 'Regelversion angelegt',
            'versionUpdated' => 'Regelversion geändert',
            'versionActivated' => 'Regelversion aktiviert',
            'requirementSaved' => 'Voraussetzungen gespeichert',
            'requirementDeleted' => 'Voraussetzungen entfernt',
            'gradeRecognized' => 'Grad anerkannt',
            'gradeAwarded' => 'Grad vergeben',
            'gradeRevoked' => 'Grad widerrufen',
            'proofAdded' => 'Nachweis erfasst',
            'proofUpdated' => 'Nachweis geändert',
            'proofDeleted' => 'Nachweis gelöscht',
        ],
        'exam' => [
            'offerCreated' => 'Prüfungsangebot angelegt',
            'offerUpdated' => 'Prüfungsangebot geändert',
            'candidateRequested' => 'Prüfungskandidat angefragt',
            'candidateApproved' => 'Fachliche Freigabe erteilt',
            'candidateAdmitted' => 'Kandidat zugelassen',
            'candidateAdmittedByException' => 'Kandidat als Ausnahme zugelassen',
            'candidateRejected' => 'Kandidat abgelehnt',
            'candidateWithdrawn' => 'Kandidat zurückgetreten',
            'resultRecorded' => 'Prüfungsergebnis erfasst',
            'rechecked' => 'Zulassungen neu geprüft',
            'reviewRequired' => 'Überprüfung der Zulassung nötig',
            'reviewCleared' => 'Überprüfung abgeschlossen',
        ],
        'team' => [
            'profileCreated' => 'Sportartenprofil angelegt',
            'profileUpdated' => 'Sportartenprofil geändert',
            'profileDeleted' => 'Sportartenprofil gelöscht',
            'packInstalled' => 'Startpaket angelegt',
            'squadMemberAdded' => 'In Saisonkader aufgenommen',
            'squadMemberUpdated' => 'Kaderzuordnung geändert',
            'squadMemberEnded' => 'Kaderzuordnung beendet',
        ],
        'match' => [
            'created' => 'Spieltag angelegt',
            'updated' => 'Spieltag geändert',
            'lineupSaved' => 'Aufstellung gespeichert',
            'lineupReleased' => 'Aufstellung freigegeben',
            'lineupWithdrawn' => 'Aufstellungsfreigabe zurückgenommen',
            'roleAssigned' => 'Terminrolle vergeben',
            'roleRemoved' => 'Terminrolle entfernt',
            'resultRecorded' => 'Spielergebnis erfasst',
            'proposalsImported' => 'Spielplan-Vorschläge importiert',
            'proposalAccepted' => 'Spielplan-Vorschlag übernommen',
            'proposalDismissed' => 'Spielplan-Vorschlag verworfen',
        ],
        'resource' => [
            'created' => 'Ressource angelegt',
            'updated' => 'Ressource geändert',
            'deleted' => 'Ressource gelöscht',
            'booked' => 'Ressource belegt',
            'released' => 'Ressourcenbelegung gelöst',
            'moved' => 'Ressourcenbelegungen mit Termin verschoben',
            'closed' => 'Ressourcen-Sperrzeit gesetzt',
            'reopened' => 'Ressourcen-Sperrzeit aufgehoben',
            'clearanceGranted' => 'Ressourcenfreigabe erteilt',
            'clearanceRevoked' => 'Ressourcenfreigabe widerrufen',
        ],
        'horse' => [
            'created' => 'Pferd angelegt',
            'updated' => 'Pferd geändert',
            'deleted' => 'Pferd gelöscht',
            'assigned' => 'Pferd zugeordnet',
            'unassigned' => 'Pferdezuordnung gelöst',
            'needsReview' => 'Reitstunde zur Neuplanung markiert',
            'useRecorded' => 'Pferdeeinsatz erfasst',
        ],
        'competition' => [
            'created' => 'Wettkampf angelegt',
            'updated' => 'Wettkampf geändert',
            'entered' => 'Wettkampfmeldung erfasst',
            'entryCleared' => 'Wettkampfmeldung geklärt',
            'withdrawn' => 'Wettkampfmeldung zurückgezogen',
            'startRightGranted' => 'Startrecht dokumentiert',
            'startRightRevoked' => 'Startrecht entfernt',
            'performanceRecorded' => 'Leistung erfasst',
            'performanceConfirmed' => 'Leistung bestätigt',
            'performanceCorrected' => 'Leistung korrigiert',
            'performanceDeleted' => 'Leistung gelöscht',
            'requirementCreated' => 'Anwesenheitsanforderung angelegt',
            'requirementUpdated' => 'Anwesenheitsanforderung geändert',
            'requirementDeleted' => 'Anwesenheitsanforderung gelöscht',
            'requirementExported' => 'Nachweisliste exportiert',
        ],
        'fee' => [
            'paymentRecorded' => 'Beitragszahlung gebucht',
            'paymentMatched' => 'Beitragszahlung mit Bankumsatz verknüpft',
            'paymentReverted' => 'Beitragszahlung zurückgenommen',
            'chargeback' => 'Rücklastschrift gebucht',
            'dunned' => 'Beitragsforderung gemahnt',
            'dunningMailed' => 'Mahnung versendet',
            'dunningBlocked' => 'Mahnsperre gesetzt',
            'dunningUnblocked' => 'Mahnsperre aufgehoben',
            'collectionUnblocked' => 'Einzug wieder freigegeben',
            'collectionScheduled' => 'Einzug vorgemerkt',
            'runCreated' => 'Beitragslauf angelegt',
            'runRecalculated' => 'Beitragslauf neu berechnet',
            'runReleased' => 'Beitragslauf freigegeben',
            'runCancelled' => 'Beitragslauf verworfen',
            'runExported' => 'Übergabeliste exportiert',
            'claimCreated' => 'Beitragsforderung erzeugt',
            'claimCancelled' => 'Beitragsforderung storniert',
            'correctionCreated' => 'Korrektur angelegt',
            'noticeMailed' => 'Beitragsmitteilung versendet',
            'tariffCreated' => 'Beitragstarif angelegt',
            'tariffUpdated' => 'Beitragstarif geändert',
            'tariffDeleted' => 'Beitragstarif gelöscht',
            'rateCreated' => 'Tarifsatz angelegt',
            'rateUpdated' => 'Tarifsatz geändert',
            'rateDeleted' => 'Tarifsatz gelöscht',
            'surchargeCreated' => 'Abteilungszuschlag angelegt',
            'surchargeUpdated' => 'Abteilungszuschlag geändert',
            'surchargeDeleted' => 'Abteilungszuschlag gelöscht',
            'accountCreated' => 'Beitragskonto angelegt',
            'accountUpdated' => 'Beitragskonto geändert',
            'assignmentCreated' => 'Beitragszuordnung angelegt',
            'assignmentUpdated' => 'Beitragszuordnung geändert',
            'assignmentEnded' => 'Beitragszuordnung beendet',
            'reviewRequired' => 'Tarifwechsel zur Prüfung vorgeschlagen',
            'reviewDismissed' => 'Tarifwechsel verworfen',
            'exemptionCreated' => 'Beitragsbefreiung angelegt',
            'exemptionUpdated' => 'Beitragsbefreiung geändert',
            'exemptionDeleted' => 'Beitragsbefreiung gelöscht',
        ],
        'proposal' => [
