...
return [
    ...
    'field' => [
        ...
        'cost_center_master' => "Kostenstelle aus den Stammdaten",
        'cost_center_master_free' => "– frei eingeben –",
        'cost_center_master_help' => "Auswahl übernimmt den Stammdaten-Code; ohne Auswahl gilt der frei eingetragene Code.",
        'priority' => "Priorität",
