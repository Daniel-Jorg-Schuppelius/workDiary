...
return [
    ...
    'field' => [
        ...
        'jit' => 'Nutzer beim ersten Login anlegen (JIT)',
        'jit_hint' => 'Legt beim ersten IdP-Login ein neues Konto an (Lizenzlimit gilt). Verknüpft nie bestehende Konten — E-Mail-Kollisionen werden abgelehnt. Nur für nachgewiesene SSO-Domains und — bei OIDC — vom IdP bestätigte E-Mail-Adressen.',
        'jit_role' => 'JIT-Standardrolle',
        'jit_role_none' => 'keine Rolle',
        'email_link_hint' => 'Beim ersten SSO-Login ein vorhandenes Konto über die E-Mail verknüpfen (nur bei genau einem Treffer). Danach zählt nur noch Issuer + Subject. Nur mit vom IdP bestätigter E-Mail (OIDC) und nachgewiesener SSO-Domain.',
    ...
    'error' => [
        ...
        'entra_issuer_not_tenant_specific' => 'Für Microsoft Entra ID muss der tenant-spezifische Issuer verwendet werden (https://login.microsoftonline.com/<Tenant-GUID>/v2.0) — nie common/organizations.',
        'entra_email_link_forbidden' => 'E-Mail-Erstverknüpfung ist für Microsoft Entra ID gesperrt: der email-Claim ist dort nicht verifiziert (nOAuth-Angriff). Identitäten vorab anlegen (SCIM/manuell) oder JIT nutzen.',
