...
return [
    ...
    'apply' => 'Anzeigen',
    'weights_hint' => 'Gewichtung Gesamt-Score: Termintreue :ontime %, Reklamationsquote :complaints %, ISMS-Qualität :quality %, Preisentwicklung :price %, Regressverhalten :recourse %. Nicht verfügbare Kennzahlen werden übersprungen und die Gewichte re-normalisiert.',
    ...
    'metric_recourse' => 'Regressverhalten',
    'recourse_no_source' => 'Keine beantworteten Regressforderungen im Zeitraum.',
    'recourse_detail' => ':answered von :submitted Regressen beantwortet; Anteil anerkannt.',
    'recourse_ontime' => 'Antwort fristgerecht',
    'recourse_recovery' => 'Rückfluss',
    'recourse_days' => 'Ø Antwortdauer (Tage)',
    'claim_costs' => 'Reklamationskosten im Zeitraum: :amount',
    'metric_lead_time' => 'Durchlaufzeit (Median)',
    'days' => ':days Tage',
    'lead_time_detail' => 'Median über :count Bestellungen, schnellste :min, langsamste :max Tage (Bestellung bis letzter Wareneingang).',
    'chart_lead_time' => 'Bestell-Durchlaufzeit je Lieferant',
    'unit_days' => 'Tage',
    'chart_lead_time_note' => 'Bestellung bis letzter Wareneingang, Bestellungen mit Abschluss im Zeitraum; Klick öffnet die Scorecard.',
];
