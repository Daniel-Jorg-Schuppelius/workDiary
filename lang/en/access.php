...
return [
    ...
    'permission' => [
        ...
        'club.viewAny' => 'View club register (members, groups)',
        'club.manage' => 'Manage club (members, groups, guardians, import)',
        'club.groups.lead' => 'Group leader (run own groups)',
        'club.grading.manage' => 'Manage gradings (systems, recognitions, proofs)',
        'club.exams.examine' => 'Examiner (record exam results)',
        'club.fees.manage' => 'Manage fees (tariffs, fee accounts, exemptions, runs, payments, collection)',
        'training.viewAny' => 'View course catalogue and training plan',
        'training.manage' => 'Manage training (catalogue, requirements, plan)',
        'learning.viewAny' => 'View everyone’s learning progress',
        'learning.author' => 'Create and edit learning courses',
        'learning.release' => 'Release and archive learning courses',
        'learning.grade' => 'Grade assignments and essays',
        'learning.manage' => 'Manage learning (assignments, groups, catalogue)',
        ...
        'hrFile.viewAny' => 'View personnel files (all staff)',
        'hrFile.create' => 'Add personnel file documents',
        'hrFile.update' => 'Edit personnel file documents',
        'hrFile.delete' => 'Destroy personnel file documents',
