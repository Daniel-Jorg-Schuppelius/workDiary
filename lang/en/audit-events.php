...
return [
    ...
    'invoice' => [
        ...
        'peppolSent' => 'Invoice delivered via Peppol',
    ],
    'isms' => [
        'audit' => [
    ...
    'customer' => [
        ...
        'peppolChecked' => 'Peppol registration checked',
    ],
    ...
    'accounting' => [
        ...
        'period_soft_closed' => 'Period closed provisionally',
    ...
    'club' => [
        ...
        'grading' => [
            'systemCreated' => 'Grading system created',
            'systemUpdated' => 'Grading system updated',
            'systemDeleted' => 'Grading system deleted',
            'gradeCreated' => 'Grade created',
            'gradeUpdated' => 'Grade updated',
            'gradeDeleted' => 'Grade deleted',
            'versionCreated' => 'Rule version created',
            'versionUpdated' => 'Rule version updated',
            'versionActivated' => 'Rule version activated',
            'requirementSaved' => 'Requirements saved',
            'requirementDeleted' => 'Requirements removed',
            'gradeRecognized' => 'Grade recognised',
            'gradeAwarded' => 'Grade awarded',
        ...
        'exam' => [
            'offerCreated' => 'Exam offer created',
            'offerUpdated' => 'Exam offer updated',
            'candidateRequested' => 'Exam candidate requested',
            'candidateApproved' => 'Approval granted',
            'candidateAdmitted' => 'Candidate admitted',
            'candidateAdmittedByException' => 'Candidate admitted by exception',
            'candidateRejected' => 'Candidate rejected',
            'candidateWithdrawn' => 'Candidate withdrawn',
            'resultRecorded' => 'Exam result recorded',
            'rechecked' => 'Admissions re-checked',
            'reviewRequired' => 'Admission review required',
            'reviewCleared' => 'Review closed',
        ],
        'team' => [
            'profileCreated' => 'Sport profile created',
            'profileUpdated' => 'Sport profile updated',
            'profileDeleted' => 'Sport profile deleted',
            'packInstalled' => 'Starter package installed',
            'squadMemberAdded' => 'Added to season squad',
            'squadMemberUpdated' => 'Squad entry updated',
            'squadMemberEnded' => 'Squad entry ended',
        ],
        'match' => [
            'created' => 'Match day created',
            'updated' => 'Match day updated',
            'lineupSaved' => 'Lineup saved',
            'lineupReleased' => 'Lineup released',
            'lineupWithdrawn' => 'Lineup release withdrawn',
            'roleAssigned' => 'Event role assigned',
            'roleRemoved' => 'Event role removed',
            'resultRecorded' => 'Match result recorded',
            'proposalsImported' => 'Fixture proposals imported',
            'proposalAccepted' => 'Fixture proposal accepted',
            'proposalDismissed' => 'Fixture proposal dismissed',
        ],
        'resource' => [
            ...
            'released' => 'Resource booking released',
            'moved' => 'Resource bookings moved with event',
            'closed' => 'Resource closure set',
            'reopened' => 'Resource closure lifted',
            'clearanceGranted' => 'Resource clearance granted',
            'clearanceRevoked' => 'Resource clearance revoked',
        ],
        'horse' => [
            'created' => 'Horse created',
            'updated' => 'Horse updated',
            'deleted' => 'Horse deleted',
            'assigned' => 'Horse assigned',
            'unassigned' => 'Horse assignment removed',
            'needsReview' => 'Riding lesson flagged for replanning',
            'useRecorded' => 'Horse use recorded',
        ],
        'competition' => [
            'created' => 'Competition created',
            'updated' => 'Competition updated',
            'entered' => 'Competition entry recorded',
            'entryCleared' => 'Competition entry cleared',
            'withdrawn' => 'Competition entry withdrawn',
            'startRightGranted' => 'Start right documented',
            'startRightRevoked' => 'Start right removed',
            'performanceRecorded' => 'Performance recorded',
            'performanceConfirmed' => 'Performance confirmed',
            'performanceCorrected' => 'Performance corrected',
            'performanceDeleted' => 'Performance deleted',
            'requirementCreated' => 'Attendance requirement created',
            'requirementUpdated' => 'Attendance requirement updated',
            'requirementDeleted' => 'Attendance requirement deleted',
            'requirementExported' => 'Proof list exported',
        ],
        'fee' => [
            'paymentRecorded' => 'Fee payment booked',
            'paymentMatched' => 'Fee payment linked to bank transaction',
            'paymentReverted' => 'Fee payment reverted',
            'chargeback' => 'Chargeback booked',
            'dunned' => 'Fee claim dunned',
            'dunningMailed' => 'Dunning sent',
            'dunningBlocked' => 'Dunning blocked',
            'dunningUnblocked' => 'Dunning unblocked',
            'collectionUnblocked' => 'Collection re-enabled',
            'collectionScheduled' => 'Collection scheduled',
            'runCreated' => 'Fee run created',
            'runRecalculated' => 'Fee run recalculated',
            'runReleased' => 'Fee run released',
            'runCancelled' => 'Fee run discarded',
            'runExported' => 'Handover list exported',
            'claimCreated' => 'Fee claim created',
            'claimCancelled' => 'Fee claim cancelled',
            'correctionCreated' => 'Correction created',
            'noticeMailed' => 'Fee notice sent',
            'tariffCreated' => 'Fee tariff created',
            'tariffUpdated' => 'Fee tariff updated',
            'tariffDeleted' => 'Fee tariff deleted',
            'rateCreated' => 'Tariff rate created',
            'rateUpdated' => 'Tariff rate updated',
            'rateDeleted' => 'Tariff rate deleted',
            'surchargeCreated' => 'Department surcharge created',
            'surchargeUpdated' => 'Department surcharge updated',
            'surchargeDeleted' => 'Department surcharge deleted',
            'accountCreated' => 'Fee account created',
            'accountUpdated' => 'Fee account updated',
            'assignmentCreated' => 'Fee assignment created',
            'assignmentUpdated' => 'Fee assignment updated',
            'assignmentEnded' => 'Fee assignment ended',
            'reviewRequired' => 'Tariff change proposed for review',
            'reviewDismissed' => 'Tariff change dismissed',
            'exemptionCreated' => 'Fee exemption created',
            'exemptionUpdated' => 'Fee exemption updated',
            'exemptionDeleted' => 'Fee exemption deleted',
        ],
        'proposal' => [
