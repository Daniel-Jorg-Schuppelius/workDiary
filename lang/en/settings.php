...
return [
    ...
    'dunning' => [
        ...
        'interest_rate_hint' => '0 = no interest shown. Guidance from Section 288 BGB: 5 or 9 percentage points above the base rate — the rate is maintained manually here (no base-rate feed). Shown in the dunning letter only, nothing is posted.',
    ],
];
