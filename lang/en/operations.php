...
return [
    ...
    'type' => [
        ...
        'queue_failed_jobs' => 'Failed background jobs',
        'queue_worker_down' => 'Queue worker inactive',
    ...
    'task' => [
        ...
        'queue_failed_jobs' => ':count failed background jobs (last :last) — check failed_jobs, queue:retry.',
        'queue_worker_down' => 'The queue worker has not reported for :minutes minutes — check the worker service/cron.',
