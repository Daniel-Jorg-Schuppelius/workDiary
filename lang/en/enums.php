...
return [
    ...
    'notification' => [
        'event' => [
            'club' => [
                ...
                'horseUnavailable' => 'Horse unavailable — replan riding lesson',
            ],
            'learning' => [
    ...
    'club' => [
        ...
        'criteria-result' => [
            ...
            'grade_below' => 'Below minimum grade',
            'grade_above' => 'Above maximum grade',
            'grade_unknown' => 'No valid grade',
        ],
        'event-kind' => [
        ...
        'counting-basis' => [
            'since_previous_grade' => 'Since previous grade',
            'since_membership' => 'Since joining',
            'window_months' => 'Fixed window',
        ],
        'grade-source' => [
            'exam' => 'Exam',
        ...
        'proof-kind' => [
            'course' => 'Course proof',
            'external_training' => 'External training record',
        ],
        ...
        'sport-family' => [
            'team_ball' => 'Team ball sport',
            'racket' => 'Racket sport',
            'individual' => 'Individual/competition sport',
            'shooting' => 'Shooting sport',
            'equestrian' => 'Equestrian',
            'martial_arts' => 'Martial arts',
            'boats' => 'Boat/equipment sport',
            'other' => 'Other',
        ],
        'result-format' => [
            'goals' => 'Goals',
            'period_points' => 'Points per period',
            'sets' => 'Sets',
            'none' => 'No match result',
        ],
        'lineup-slot' => [
            'field' => 'Field',
            'bench' => 'Bench',
