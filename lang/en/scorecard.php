...
return [
    ...
    'apply' => 'Show',
    'weights_hint' => 'Overall score weighting: on-time delivery :ontime %, complaint rate :complaints %, ISMS quality :quality %, price trend :price %, recourse behaviour :recourse %. Unavailable metrics are skipped and the weights re-normalised.',
    ...
    'metric_recourse' => 'Recourse behaviour',
    'recourse_no_source' => 'No answered recourse claims in the period.',
    'recourse_detail' => ':answered of :submitted recourse claims answered; share accepted.',
    'recourse_ontime' => 'Answered on time',
    'recourse_recovery' => 'Recovery',
    'recourse_days' => 'Avg. response time (days)',
    'claim_costs' => 'Claim costs in the period: :amount',
    'metric_lead_time' => 'Lead time (median)',
    'days' => ':days days',
    'lead_time_detail' => 'Median over :count orders, fastest :min, slowest :max days (order to last goods receipt).',
    'chart_lead_time' => 'Order lead time by supplier',
    'unit_days' => 'days',
    'chart_lead_time_note' => 'Order to last goods receipt, orders completed in the period; click opens the scorecard.',
];
