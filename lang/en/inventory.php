...
return [
    ...
    'subtitle' => [
        ...
        'bins' => 'Manage the storage bins of warehouse :warehouse.',
    ],
    'action' => [
    ...
    'empty' => [
        ...
        'bins' => 'No storage bins created yet.',
        'pick_list' => 'No open positions for this source.',
    ],
    'confirm' => [
        'delete_warehouse' => 'Really delete this warehouse? Only possible without movements.',
        'delete_bin' => 'Really delete this bin? Only possible without movements.',
    ],
    'flash' => [
        ...
        'bin_delete_blocked' => 'Bin cannot be deleted: movements exist.',
        'bin_blocked' => 'Bin blocked.',
        'bin_unblocked' => 'Bin released.',
    ],
    'reservation_status' => [
        'active' => 'Active',
        'fulfilled' => 'Fulfilled',
    ...
    'pick_list' => [
        'title' => 'Pick list',
        'subtitle' => 'Open positions by warehouse, bin and lot (FEFO).',
        'source' => 'Source',
        'number' => 'No.',
        'position' => 'Pos.',
        'available' => 'Available in bin',
        'footer_note' => 'Order: warehouse → bin → lot (earliest best-before first).',
        'lines' => 'Positions',
    ],
    'error' => [
        'bin_foreign' => 'The bin does not belong to this warehouse.',
        'bin_with_customer' => 'Posting material costs to a customer is only possible without a bin.',
        'bin_unusable' => 'Bin :code is blocked or inactive — posting not possible.',
        'warehouse_unusable' => 'Warehouse :name is blocked or inactive — posting not possible.',
