...
return [
    ...
    'flash' => [
        ...
        'invited_emailed' => 'External participant ":name" invited and access link sent by email.',
        'revoked' => 'External access revoked.',
    ],
    'mail' => [
        'subject' => 'Your access to shared documents',
        'heading' => 'External access',
        'intro' => 'Hello :name, you have been invited to shared documents. The link below gives you access without signing in:',
        'button' => 'Open access',
        'expires' => 'The access is valid until :date.',
        'note' => 'Please do not share this link — it is personal and time-limited.',
    ],
    'contact' => [
        'title' => 'External contact profiles',
        'intro' => 'Recurring external participants (subcontractors, inspectors …) as reusable master data.',
        'new' => 'New profile',
        'edit' => 'Edit profile',
        'eyebrow' => 'External contact profiles',
        'submit' => 'Save',
        'notes' => 'Notes',
        'delete' => 'Delete',
        'confirm_delete' => 'Delete this contact profile? Existing invitations remain.',
        'empty' => 'No contact profiles yet.',
        'pick' => 'Choose an existing profile (optional)',
        'pick_none' => '— Enter new —',
        'save_as' => 'Save these details as a reusable profile',
        'flash' => [
            'created' => 'Contact profile created.',
            'updated' => 'Contact profile updated.',
            'deleted' => 'Contact profile deleted.',
        ],
    ],
    'public' => [
