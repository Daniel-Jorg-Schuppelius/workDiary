...
return [
    ...
    'dialog' => [
        ...
        'before' => 'Days before period start (prepayment)',
        'after' => 'Days after period start (late billing)',
        'window_hint' => 'An invoice belongs to a period if its date falls within this window around the period start. Keep the trailing side generous (default two years): late billing and multi-year blocks are allocated in licence-months, nothing counts twice.',
