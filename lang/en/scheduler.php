...
return [
    ...
    'cadence_label' => [
        ...
        'weeklyOn' => 'Every :weekday at :time',
        'monthlyOn' => 'Monthly on day :day at :time',
    ],
    'criticality' => [
    ...
    'job' => [
        ...
        'learning' => [
            'close_stale_sessions' => 'Close stale learning sessions',
        ...
        'zammad' => ['sync' => 'Zammad ticket sync'],
        'github' => ['sync' => 'GitHub issue sync'],
        'gitlab' => ['sync' => 'GitLab issue sync'],
