...
return [
    ...
    'costing' => [
        ...
        'sum' => 'Total',
        'empty' => 'No completed manufacturing orders in the period.',
        'open_order' => 'Open manufacturing order',
        'note' => 'Material cost from consumption postings (else quantity × master cost), labor from assigned time entries × internal hourly rate. Scrap rate across all reports of the article.',
        'kpi' => [
            'orders' => 'Orders',
            'unit_cost_avg' => 'Avg. unit cost',
            'unit_cost_range' => 'min :min · max :max',
            'material' => 'Actual material',
            'planned' => 'Planned: :value',
            'deviation' => 'Material deviation',
