...
return [
    ...
    'team' => [
        'title' => 'Team today',
        'subtitle' => 'Who is here now and which days still need to be closed.',
        'present' => 'Present',
        'nobody_present' => 'Nobody clocked in',
        'on_break' => 'Break',
        'since' => 'since :time',
        'away' => 'Away',
        'off_site' => 'off site',
        'absent' => 'absent',
        'unaccounted' => 'Not clocked in',
        'open_days' => 'Open day closings',
        'apply' => 'Apply period',
        'no_open_days' => 'All days in the period are closed.',
        'day' => 'Day',
        'person' => 'Person',
        'open' => 'Open day',
    ],
