...
use App\Http\Controllers\Absence\{SickLeaveController, VacationController, VacationEntitlementController};
...
Route::get('/impressum', [\App\Http\Controllers\Platform\LegalPageController::class, 'imprint'])->name('legal.imprint');
Route::get('/datenschutz', [\App\Http\Controllers\Platform\LegalPageController::class, 'privacy'])->name('legal.privacy');
Route::get('/barrierefreiheit', [\App\Http\Controllers\Platform\LegalPageController::class, 'accessibility'])->name('legal.accessibility');
...
Route::get('serial-passport/{token}', [\App\Http\Controllers\Inventory\PublicSerialController::class, 'show'])
...
Route::get('umfrage/{token}', [\App\Http\Controllers\Survey\PublicSurveyController::class, 'show'])
    ->middleware('throttle:30,1')
    ->name('surveys.public-show');
Route::post('umfrage/{token}', [\App\Http\Controllers\Survey\PublicSurveyController::class, 'store'])
...
Route::get('angebote/{quote}/annahme', [\App\Http\Controllers\Sales\QuoteController::class, 'portalShow'])
    ->middleware('throttle:30,1')
    ->name('quotes.portal.show');
Route::post('angebote/{quote}/annahme', [\App\Http\Controllers\Sales\QuoteController::class, 'portalDecide'])
    ->middleware('throttle:12,1')
...
Route::middleware('auth')->group(function () {
    ...
    // SMS-Alarmierung (Feature 147, MVP-730): Einwilligung ist Sache der
    // Person selbst — keine Permission, ausschließlich auth()->user().
    // Throttle gegen Code-Automaten (SMS kostet je Anforderung Geld).
    Route::get('account/sms-opt-in', [\App\Http\Controllers\Account\SmsOptInController::class, 'index'])->name('account.sms.index');
    Route::post('account/sms-opt-in', [\App\Http\Controllers\Account\SmsOptInController::class, 'start'])
        ->middleware('throttle:5,10')->name('account.sms.start');
    Route::post('account/sms-opt-in/bestaetigen', [\App\Http\Controllers\Account\SmsOptInController::class, 'confirm'])
        ->middleware('throttle:10,10')->name('account.sms.confirm');
    Route::delete('account/sms-opt-in', [\App\Http\Controllers\Account\SmsOptInController::class, 'destroy'])->name('account.sms.destroy');
    ...
    Route::get('notifications', [\App\Http\Controllers\Notification\NotificationCenterController::class, 'index'])->name('notifications.index');
    Route::post('notifications/read-all', [\App\Http\Controllers\Notification\NotificationCenterController::class, 'readAll'])->name('notifications.readAll');
    Route::post('notifications/{id}/read', [\App\Http\Controllers\Notification\NotificationCenterController::class, 'read'])->name('notifications.read');
    // destroyRead VOR destroy registrieren — sonst fängt {id} den Pfad "read" ab.
    Route::delete('notifications/read', [\App\Http\Controllers\Notification\NotificationCenterController::class, 'destroyRead'])->name('notifications.destroyRead');
    Route::delete('notifications/{id}', [\App\Http\Controllers\Notification\NotificationCenterController::class, 'destroy'])->name('notifications.destroy');
    ...
    Route::get('me/workspaces', [\App\Http\Controllers\Me\UserWorkspaceController::class, 'index'])
        ->name('me.workspaces.index');
    Route::get('me/workspaces/create', [\App\Http\Controllers\Me\UserWorkspaceController::class, 'create'])
        ->name('me.workspaces.create');
    Route::post('me/workspaces', [\App\Http\Controllers\Me\UserWorkspaceController::class, 'store'])
        ->name('me.workspaces.store');
    Route::get('me/workspaces/{workspace}/edit', [\App\Http\Controllers\Me\UserWorkspaceController::class, 'edit'])
        ->name('me.workspaces.edit');
    Route::put('me/workspaces/{workspace}', [\App\Http\Controllers\Me\UserWorkspaceController::class, 'update'])
        ->name('me.workspaces.update');
    Route::delete('me/workspaces/{workspace}', [\App\Http\Controllers\Me\UserWorkspaceController::class, 'destroy'])
        ->name('me.workspaces.destroy');
    ...
    Route::middleware(['access.new', \App\Http\Middleware\EnforcePlanModules::class])->group(function () {
        ...
        Route::prefix('compliance/datenschutz')->name('dataprotection.')->group(function (): void {
            ...
            // Betroffenen-Selbstmeldeportal (G11, MVP-728): Konfiguration des
            // oeffentlichen Formulars; die Public-Routen liegen in routes/dsar.php.
            Route::get('portal', [\App\Http\Controllers\Privacy\DsarPortalController::class, 'edit'])->name('portal.edit');
            Route::put('portal', [\App\Http\Controllers\Privacy\DsarPortalController::class, 'update'])->name('portal.update');
            Route::post('portal/link', [\App\Http\Controllers\Privacy\DsarPortalController::class, 'rotateSlug'])->name('portal.rotate');
            ...
            Route::get('anfragen/{dsr}', [\App\Http\Controllers\Privacy\DataSubjectRequestController::class, 'show'])->name('requests.show');
        ...
        Route::get('terminanfragen', [\App\Http\Controllers\Calendar\AppointmentInboxController::class, 'index'])->name('appointments.index');
        Route::post('terminanfragen/{appointmentRequest}/bestaetigen', [\App\Http\Controllers\Calendar\AppointmentInboxController::class, 'confirm'])->name('appointments.confirm');
        Route::post('terminanfragen/{appointmentRequest}/ablehnen', [\App\Http\Controllers\Calendar\AppointmentInboxController::class, 'decline'])->name('appointments.decline');
        Route::get('terminanfragen/leistungsarten/neu', [\App\Http\Controllers\Calendar\AppointmentInboxController::class, 'createService'])->name('appointments.services.create');
        Route::post('terminanfragen/leistungsarten', [\App\Http\Controllers\Calendar\AppointmentInboxController::class, 'storeService'])->name('appointments.services.store');
        Route::post('terminanfragen/leistungsarten/{bookableService}/aktiv', [\App\Http\Controllers\Calendar\AppointmentInboxController::class, 'toggleService'])->name('appointments.services.toggle');

        // Wächterrundgänge (Feature 089, MVP-663–665): Kontrollpunkte mit
        // Soll-Fenstern, Scan-Nachweis und Abweichungs-Eskalation.
        Route::get('rundgaenge', [\App\Http\Controllers\Patrol\PatrolController::class, 'index'])->name('patrols.index');
        Route::get('rundgaenge/neu', [\App\Http\Controllers\Patrol\PatrolController::class, 'create'])->name('patrols.create');
        Route::post('rundgaenge', [\App\Http\Controllers\Patrol\PatrolController::class, 'store'])->name('patrols.store');
        ...
        Route::post('rundgaenge/{patrolRoute}/kontrollpunkte/{checkpoint}/neu', [\App\Http\Controllers\Patrol\PatrolController::class, 'reissueToken'])->name('patrols.checkpoints.reissue');
        ...
        Route::get('dispatch-board/vorschlaege', [\App\Http\Controllers\Schedule\DispatchSuggestionController::class, 'index'])->name('dispatch.suggestions');
        Route::post('dispatch-board/vorschlaege/{entry}/uebernehmen', [\App\Http\Controllers\Schedule\DispatchSuggestionController::class, 'apply'])->name('dispatch.suggestions.apply');
        Route::post('dispatch-board/vorschlaege/{entry}/ablehnen', [\App\Http\Controllers\Schedule\DispatchSuggestionController::class, 'dismiss'])->name('dispatch.suggestions.dismiss');
        ...
        Route::put('diary/{diary}/qualifications', [\App\Http\Controllers\Diary\DiaryQualificationController::class, 'update'])->name('diary.qualifications.update');
        ...
        Route::get('extern-kontakte', [\App\Http\Controllers\Contacts\ExternalContactController::class, 'index'])->name('external-contacts.index');
        Route::get('extern-kontakte/neu', [\App\Http\Controllers\Contacts\ExternalContactController::class, 'create'])->name('external-contacts.create');
        Route::post('extern-kontakte', [\App\Http\Controllers\Contacts\ExternalContactController::class, 'store'])->name('external-contacts.store');
        Route::get('extern-kontakte/{externalContact}/bearbeiten', [\App\Http\Controllers\Contacts\ExternalContactController::class, 'edit'])->name('external-contacts.edit');
        Route::put('extern-kontakte/{externalContact}', [\App\Http\Controllers\Contacts\ExternalContactController::class, 'update'])->name('external-contacts.update');
        Route::delete('extern-kontakte/{externalContact}', [\App\Http\Controllers\Contacts\ExternalContactController::class, 'destroy'])->name('external-contacts.destroy');
        ...
        Route::get('calendar/events', [\App\Http\Controllers\Calendar\CalendarController::class, 'events'])->name('calendar.events');
        ...
        Route::post('rooms/{room}/requirements', [\App\Http\Controllers\Facility\RoomRequirementController::class, 'store'])
            ->name('rooms.requirements.store');
        Route::put('rooms/{room}/requirements/{requirement}', [\App\Http\Controllers\Facility\RoomRequirementController::class, 'update'])
            ->name('rooms.requirements.update');
        Route::delete('rooms/{room}/requirements/{requirement}', [\App\Http\Controllers\Facility\RoomRequirementController::class, 'destroy'])
            ->name('rooms.requirements.destroy');

        // ── Liegenschaften (Standort → Gebäude → Geschoss) ──────────────────
        Route::resource('sites', \App\Http\Controllers\Facility\SiteController::class);
        Route::resource('buildings', \App\Http\Controllers\Facility\BuildingController::class);
        Route::resource('floors', \App\Http\Controllers\Facility\FloorController::class);
        ...
        Route::get('leads', [\App\Http\Controllers\Sales\LeadController::class, 'index'])->name('leads.index');
        Route::get('leads/neu', [\App\Http\Controllers\Sales\LeadController::class, 'create'])->name('leads.create');
        Route::post('leads', [\App\Http\Controllers\Sales\LeadController::class, 'store'])->name('leads.store');
        Route::get('leads/{lead}', [\App\Http\Controllers\Sales\LeadController::class, 'show'])->name('leads.show');
        Route::get('leads/{lead}/bearbeiten', [\App\Http\Controllers\Sales\LeadController::class, 'edit'])->name('leads.edit');
        Route::put('leads/{lead}', [\App\Http\Controllers\Sales\LeadController::class, 'update'])->name('leads.update');
        Route::post('leads/{lead}/status', [\App\Http\Controllers\Sales\LeadController::class, 'transition'])->name('leads.transition');
        Route::post('leads/{lead}/konvertieren', [\App\Http\Controllers\Sales\LeadController::class, 'convert'])->name('leads.convert');

        // Provisionen (Feature 146, MVP-729): Regeln, Provisionszeilen je Beleg
        // und Abrechnungsläufe. Rechte über commission.* (Policies auf
        // CommissionRule/CommissionSettlementRun), Modul module.vertrieb.
        // Reihenfolge beachtet: die festen Segmente stehen vor den
        // Wildcard-Routen des Zuordnungs-Dialogs.
        Route::prefix('provisionen')->group(function (): void {
            Route::get('regeln', [\App\Http\Controllers\Sales\CommissionRuleController::class, 'index'])->name('commission-rules.index');
            Route::get('regeln/neu', [\App\Http\Controllers\Sales\CommissionRuleController::class, 'create'])->name('commission-rules.create');
            Route::post('regeln', [\App\Http\Controllers\Sales\CommissionRuleController::class, 'store'])->name('commission-rules.store');
            ...
            Route::post('laeufe', [\App\Http\Controllers\Sales\CommissionRunController::class, 'store'])->name('commission-runs.store');
            Route::get('laeufe/{run}', [\App\Http\Controllers\Sales\CommissionRunController::class, 'show'])->name('commission-runs.show');
            Route::get('laeufe/{run}/export', [\App\Http\Controllers\Sales\CommissionRunController::class, 'export'])->name('commission-runs.export');
            Route::post('laeufe/{run}/schliessen', [\App\Http\Controllers\Sales\CommissionRunController::class, 'close'])->name('commission-runs.close');
            Route::delete('laeufe/{run}', [\App\Http\Controllers\Sales\CommissionRunController::class, 'destroy'])->name('commission-runs.destroy');

            Route::get('/', [\App\Http\Controllers\Sales\CommissionController::class, 'index'])->name('commissions.index');
            Route::get('zuordnung/{invoice}', [\App\Http\Controllers\Sales\CommissionController::class, 'assignForm'])->name('commissions.assign.form');
            Route::post('zuordnung/{invoice}', [\App\Http\Controllers\Sales\CommissionController::class, 'assign'])->name('commissions.assign');
        });

        // Umfragen (Feature 090, MVP-660–662): Fragebögen, Einladungen, NPS.
        Route::get('umfragen', [\App\Http\Controllers\Survey\SurveyController::class, 'index'])->name('surveys.index');
        Route::get('umfragen/neu', [\App\Http\Controllers\Survey\SurveyController::class, 'create'])->name('surveys.create');
        Route::post('umfragen', [\App\Http\Controllers\Survey\SurveyController::class, 'store'])->name('surveys.store');
        Route::get('umfragen/{survey}', [\App\Http\Controllers\Survey\SurveyController::class, 'show'])->name('surveys.show');
        Route::post('umfragen/{survey}/fragen', [\App\Http\Controllers\Survey\SurveyController::class, 'addQuestion'])->name('surveys.questions.add');
        Route::delete('umfragen/{survey}/fragen/{question}', [\App\Http\Controllers\Survey\SurveyController::class, 'removeQuestion'])->name('surveys.questions.remove');
        Route::post('umfragen/{survey}/einladen', [\App\Http\Controllers\Survey\SurveyController::class, 'invite'])->name('surveys.invite');
        Route::post('umfragen/{survey}/aktiv', [\App\Http\Controllers\Survey\SurveyController::class, 'toggleActive'])->name('surveys.toggle-active');
        ...
        Route::get('customers/{customer}/portal-access/create', [\App\Http\Controllers\Customer\CustomerPortalAccessController::class, 'createDialog'])->name('customers.portal-access.create');
        Route::post('customers/{customer}/portal-access', [\App\Http\Controllers\Customer\CustomerPortalAccessController::class, 'store'])->name('customers.portal-access.store');
        ...
        Route::get('articles/export/datanorm', [\App\Http\Controllers\Article\ArticleExportController::class, 'datanorm'])->name('articles.export.datanorm'); // Feature 107 W5 — vor der Resource (Kollision mit articles/{article})
        // Feature 107 W9: Verkaufs-Rabattgruppen (ebenfalls vor der Resource).
        Route::get('articles/sales-discount-groups', [\App\Http\Controllers\Sales\SalesDiscountGroupController::class, 'index'])->name('articles.sales-discount-groups.index');
        Route::post('articles/sales-discount-groups', [\App\Http\Controllers\Sales\SalesDiscountGroupController::class, 'store'])->name('articles.sales-discount-groups.store');
        Route::delete('articles/sales-discount-groups/{salesDiscountGroup}', [\App\Http\Controllers\Sales\SalesDiscountGroupController::class, 'destroy'])->name('articles.sales-discount-groups.destroy');
        // Feature 107 MVP-567: Kunden-Overrides je Verkaufs-Rabattgruppe.
        Route::post('articles/sales-discount-groups/overrides', [\App\Http\Controllers\Sales\SalesDiscountGroupController::class, 'storeOverride'])->name('articles.sales-discount-groups.overrides.store');
        Route::delete('articles/sales-discount-groups/overrides/{override}', [\App\Http\Controllers\Sales\SalesDiscountGroupController::class, 'destroyOverride'])->name('articles.sales-discount-groups.overrides.destroy');
        // Dubletten-Abgleich VOR der Resource (Kollision mit articles/{article}); Audit W2.9.
        Route::get('articles/duplicates', [\App\Http\Controllers\Article\ArticleMergeController::class, 'index'])->name('articles.duplicates.index');
        Route::get('articles/duplicates/compare', [\App\Http\Controllers\Article\ArticleMergeController::class, 'compare'])->name('articles.duplicates.compare');
        ...
        Route::post('articles/{article}/options', [\App\Http\Controllers\Article\ArticleController::class, 'storeOption'])->name('articles.options.store');
        Route::post('articles/{article}/options/{option}/values', [\App\Http\Controllers\Article\ArticleController::class, 'storeOptionValue'])->name('articles.options.values.store');
        Route::post('articles/{article}/units', [\App\Http\Controllers\Article\ArticleController::class, 'storeUnit'])->name('articles.units.store');
        Route::post('articles/{article}/variants', [\App\Http\Controllers\Article\ArticleController::class, 'storeVariant'])->name('articles.variants.store');
        Route::post('articles/{article}/variants/{variant}/retire', [\App\Http\Controllers\Article\ArticleController::class, 'retireVariant'])->name('articles.variants.retire');
        ...
        // Lagerplätze je Lagerort (Feature 048, MVP-706) — Modal-Dialoge, Bin-Zugehörigkeit prüft der Controller.
        Route::get('warehouses/{warehouse}/bins', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'index'])->name('warehouses.bins.index');
        Route::get('warehouses/{warehouse}/bins/create', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'create'])->name('warehouses.bins.create');
        Route::post('warehouses/{warehouse}/bins', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'store'])->name('warehouses.bins.store');
        Route::get('warehouses/{warehouse}/bins/{bin}/edit', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'edit'])->name('warehouses.bins.edit');
        Route::put('warehouses/{warehouse}/bins/{bin}', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'update'])->name('warehouses.bins.update');
        Route::post('warehouses/{warehouse}/bins/{bin}/block', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'toggleBlock'])->name('warehouses.bins.block');
        Route::delete('warehouses/{warehouse}/bins/{bin}', [\App\Http\Controllers\Inventory\WarehouseBinController::class, 'destroy'])->name('warehouses.bins.destroy');
        // Kommissionierliste je Quelle (MVP-706): .pdf VOR der HTML-Route ({sqid} würde sonst „x.pdf" schlucken).
        Route::get('inventory/pick-lists/{source}/{sqid}.pdf', [\App\Http\Controllers\Inventory\PickListController::class, 'pdf'])->name('inventory.pick-lists.pdf')->where(['source' => '[a-z-]+', 'sqid' => '[A-Za-z0-9]+']);
        Route::get('inventory/pick-lists/{source}/{sqid}', [\App\Http\Controllers\Inventory\PickListController::class, 'show'])->name('inventory.pick-lists.show')->where(['source' => '[a-z-]+', 'sqid' => '[A-Za-z0-9]+']);
        Route::get('inventory/stock', [\App\Http\Controllers\Inventory\StockController::class, 'index'])->name('inventory.stock');
        Route::post('inventory/movements', [\App\Http\Controllers\Inventory\StockController::class, 'storeMovement'])->name('inventory.movements.store');
        Route::get('inventory/counts', [\App\Http\Controllers\Inventory\StocktakeController::class, 'index'])->name('inventory.counts.index');
        Route::post('inventory/counts', [\App\Http\Controllers\Inventory\StocktakeController::class, 'open'])->name('inventory.counts.open');
        Route::post('inventory/counts/cycle', [\App\Http\Controllers\Inventory\StocktakeController::class, 'openCycle'])->name('inventory.counts.cycle'); // E6 zyklisch
        ...
        Route::get('inventory/scan', [\App\Http\Controllers\Inventory\ScanController::class, 'index'])->name('inventory.scan');
        Route::post('inventory/scan', [\App\Http\Controllers\Inventory\ScanController::class, 'book'])->name('inventory.scan.book');
        ...
        Route::get('inventory/label-templates/create', [\App\Http\Controllers\Print\LabelTemplateController::class, 'create'])->name('inventory.label-templates.create');
        Route::post('inventory/label-templates', [\App\Http\Controllers\Print\LabelTemplateController::class, 'store'])->name('inventory.label-templates.store');
        Route::get('inventory/label-templates/{labelTemplate}/edit', [\App\Http\Controllers\Print\LabelTemplateController::class, 'edit'])->name('inventory.label-templates.edit');
        Route::put('inventory/label-templates/{labelTemplate}', [\App\Http\Controllers\Print\LabelTemplateController::class, 'update'])->name('inventory.label-templates.update');
        Route::delete('inventory/label-templates/{labelTemplate}', [\App\Http\Controllers\Print\LabelTemplateController::class, 'destroy'])->name('inventory.label-templates.destroy');
        Route::post('inventory/reservations/{reservation}/release', [\App\Http\Controllers\Inventory\StockController::class, 'releaseReservation'])->name('inventory.reservations.release');
        Route::post('inventory/levels', [\App\Http\Controllers\Inventory\StockController::class, 'setLevels'])->name('inventory.levels.set');
        ...
        Route::post('manufacturing-orders/{order}/release', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'release'])->name('manufacturing-orders.release');
        Route::post('manufacturing-orders/{order}/start', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'start'])->name('manufacturing-orders.start');
        Route::post('manufacturing-orders/{order}/reserve', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'reserve'])->name('manufacturing-orders.reserve');
        Route::post('manufacturing-orders/{order}/report', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'report'])->name('manufacturing-orders.report');
        Route::post('manufacturing-orders/{order}/materials/{material}/consume', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'consumeMaterial'])->name('manufacturing-orders.materials.consume'); // MVP-065 Ist-Verbrauch
        // Vollaudit 2026-07 (M20): Fehlmaterial-/Ersatzmaterialprozess (MVP-068).
        Route::post('manufacturing-orders/{order}/substitutes', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'requestSubstitute'])->name('manufacturing-orders.substitutes.request');
        ...
        Route::post('manufacturing-orders/{order}/work-center', [\App\Http\Controllers\Manufacturing\ManufacturingOrderController::class, 'assignWorkCenter'])->name('manufacturing-orders.work-center'); // E7 Kapazität

        // Fertigungsplanung MRP/SPC (Feature 047/048, E7) → module.lager
        Route::get('manufacturing-planning', [\App\Http\Controllers\Manufacturing\ManufacturingPlanningController::class, 'index'])->name('manufacturing-planning.index');

        // Kapazitätsboard / Arbeitsplätze (Feature 047/048, E7) → module.lager
        Route::get('work-centers', [\App\Http\Controllers\Manufacturing\WorkCenterController::class, 'index'])->name('work-centers.index');
        Route::get('work-centers/create', [\App\Http\Controllers\Manufacturing\WorkCenterController::class, 'create'])->name('work-centers.create');
        Route::post('work-centers', [\App\Http\Controllers\Manufacturing\WorkCenterController::class, 'store'])->name('work-centers.store');

        // ── Seriennummern (Feature 047/048, E2) ─ Gate serials.* → module.lager
        Route::get('serials', [\App\Http\Controllers\Inventory\SerialController::class, 'index'])->name('serials.index');
        Route::get('serials/verify', [\App\Http\Controllers\Inventory\SerialController::class, 'verify'])->name('serials.verify');
        // Vor `serials/{serial}` — sonst schluckt der Platzhalter den Pfad.
        Route::get('serials/geraete-pass', [\App\Http\Controllers\Inventory\SerialPassportSettingsController::class, 'edit'])->name('serials.passport.edit');
        Route::post('serials/geraete-pass/token', [\App\Http\Controllers\Inventory\SerialPassportSettingsController::class, 'rotate'])->name('serials.passport.rotate');
        Route::delete('serials/geraete-pass/token', [\App\Http\Controllers\Inventory\SerialPassportSettingsController::class, 'revoke'])->name('serials.passport.revoke');
        Route::patch('serials/geraete-pass', [\App\Http\Controllers\Inventory\SerialPassportSettingsController::class, 'toggle'])->name('serials.passport.toggle');
        Route::get('serials/{serial}', [\App\Http\Controllers\Inventory\SerialController::class, 'show'])->name('serials.show');
        Route::post('serials/{serial}/block', [\App\Http\Controllers\Inventory\SerialController::class, 'block'])->name('serials.block');
        Route::post('serials/{serial}/unblock', [\App\Http\Controllers\Inventory\SerialController::class, 'unblock'])->name('serials.unblock');
        Route::post('serials/{serial}/scrap', [\App\Http\Controllers\Inventory\SerialController::class, 'scrap'])->name('serials.scrap');

        // ── Beschaffung / Bestellungen (Feature 048, E4) ─ Gate purchase-orders.* → module.lager
        Route::get('purchase-orders', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'index'])->name('purchase-orders.index');
        Route::get('purchase-orders/suggestions', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'suggestions'])->name('purchase-orders.suggestions');
        Route::get('purchase-orders/incoming', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'incoming'])->name('purchase-orders.incoming'); // E4 erwartete Wareneingänge
        Route::post('purchase-orders/suggestions/apply', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'applySuggestions'])->name('purchase-orders.suggestions.apply');
        Route::get('purchase-orders/create', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'create'])->name('purchase-orders.create');
        Route::post('purchase-orders', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'store'])->name('purchase-orders.store');
        Route::get('purchase-orders/{purchaseOrder}', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'show'])->name('purchase-orders.show');
        Route::get('purchase-orders/{purchaseOrder}/order-xml', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'downloadOrder'])->name('purchase-orders.order-xml'); // E4 XBestellung/Order-X Export
        Route::get('purchase-orders/{purchaseOrder}/order.pdf', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'downloadPdf'])->name('purchase-orders.pdf'); // E4 Bestellung-PDF
        // Feature 128 (MVP-692): Bestellung per E-Mail an den Lieferanten.
        Route::get('purchase-orders/{purchaseOrder}/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'purchaseOrderForm'])->name('purchase-orders.mail.form');
        Route::post('purchase-orders/{purchaseOrder}/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'purchaseOrderSend'])->name('purchase-orders.mail');
        Route::post('purchase-orders/{purchaseOrder}/lines', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'addLine'])->name('purchase-orders.lines.add');
        Route::post('purchase-orders/{purchaseOrder}/conditions', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'updateConditions'])->name('purchase-orders.conditions'); // Frachtkosten (UGL POZ)
        Route::post('purchase-orders/{purchaseOrder}/submit', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'submit'])->name('purchase-orders.submit');
        ...
        Route::post('purchase-orders/{purchaseOrder}/cancel', [\App\Http\Controllers\Procurement\PurchaseOrderController::class, 'cancel'])->name('purchase-orders.cancel');
        ...
        Route::get('pricing-margin-rules/create', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'create'])->name('pricing-margin-rules.create');
        Route::get('pricing-margin-rules/approvals', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'approvals'])->name('pricing-margin-rules.approvals'); // MVP-095 Vier-Augen-Anträge
        Route::post('pricing-margin-rules/approvals/{priceRequest}/approve', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'approveRequest'])->name('pricing-margin-rules.approvals.approve');
        Route::post('pricing-margin-rules/approvals/{priceRequest}/reject', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'rejectRequest'])->name('pricing-margin-rules.approvals.reject');
        Route::post('pricing-margin-rules/approval-mode', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'saveApprovalMode'])->name('pricing-margin-rules.approval-mode'); // MVP-095 Freigabemodus
        Route::post('pricing-margin-rules', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'store'])->name('pricing-margin-rules.store');
        Route::delete('pricing-margin-rules/{pricingMarginRule}', [\App\Http\Controllers\Article\PricingMarginRuleController::class, 'destroy'])->name('pricing-margin-rules.destroy');
        ...
        Route::get('bill-of-quantities/import', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'importForm'])->name('bill-of-quantities.import-form'); // vor show!
        Route::post('bill-of-quantities/import', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'import'])->name('bill-of-quantities.import');
        ...
        Route::get('bill-of-quantities/{billOfQuantity}', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'show'])->name('bill-of-quantities.show');
        // MVP-084/085: LV-Workflow und GAEB-Export
        Route::get('bill-of-quantities/{billOfQuantity}/preisspiegel', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'priceComparison'])->name('bill-of-quantities.price-comparison');
        Route::get('bill-of-quantities/{billOfQuantity}/kostengruppen', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'costGroups'])->name('bill-of-quantities.cost-groups');
        // Kalkulationsdaten (Feature 109, MVP-647): EKT/GKT je Kostenart.
        Route::get('bill-of-quantities/{billOfQuantity}/kalkulation', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'calculationData'])->name('bill-of-quantities.calculation-data');
        // Zuordnungs-Oberfläche (Feature 109, MVP-639).
        Route::get('bill-of-quantities/{billOfQuantity}/zuordnung', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'catalogAssignment'])->name('bill-of-quantities.catalog-assignment');
        Route::post('bill-of-quantities/{billOfQuantity}/zuordnung', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'assignCatalogBulk'])->name('bill-of-quantities.catalog-assignment.bulk');
        Route::post('bill-of-quantities/items/{boqItem}/zuordnung', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'assignCatalog'])->name('bill-of-quantities.items.catalog-assignment');
        Route::post('bill-of-quantities/teilmengen/{split}/zuordnung', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'assignSplitCatalog'])->name('bill-of-quantities.splits.catalog-assignment');
        Route::post('bill-of-quantities/{billOfQuantity}/zuordnung/regeln', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'applyCatalogRules'])->name('bill-of-quantities.catalog-rules.apply');
        Route::match(['get', 'post'], 'bill-of-quantities/{billOfQuantity}/zuordnung/ausgabe', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'catalogEdition'])->name('bill-of-quantities.catalog-edition');
        // Kostenermittlung (Feature 109, MVP-646): X51 rein als Budget, raus
        // als Kostenanschlag bzw. Kostenfeststellung.
        Route::post('bill-of-quantities/kostenermittlung', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'costEstimateImport'])->name('bill-of-quantities.cost-estimate.import');
        Route::get('bill-of-quantities/{billOfQuantity}/kostenermittlung', [\App\Http\Controllers\Gaeb\BillOfQuantityController::class, 'costEstimateExport'])->name('bill-of-quantities.cost-estimate.export');
        ...
        Route::post('telefonie/waehlen', \App\Http\Controllers\Cti\CtiDialController::class)->middleware('throttle:30,1')->name('cti.dial');
        ...
        Route::get('auswertungen/ansichten', [\App\Http\Controllers\Reporting\SavedReportViewController::class, 'index'])->name('report-views.index');
        Route::post('auswertungen/ansichten', [\App\Http\Controllers\Reporting\SavedReportViewController::class, 'store'])->name('report-views.store');
        Route::post('auswertungen/ansichten/{view}/teilen', [\App\Http\Controllers\Reporting\SavedReportViewController::class, 'toggleShare'])->name('report-views.toggle-share');
        Route::delete('auswertungen/ansichten/{view}', [\App\Http\Controllers\Reporting\SavedReportViewController::class, 'destroy'])->name('report-views.destroy');
        ...
        // ── Zeitkonten (MVP-526) ────────────────────────────────────────────────
        Route::get('zeitkonten', [\App\Http\Controllers\Time\TimeAccountController::class, 'index'])->name('time-accounts.index');
        ...
        Route::get('tasks/global', [\App\Http\Controllers\Project\GlobalTaskController::class, 'index'])->name('tasks.global.index');
        Route::get('tasks/global/create', [\App\Http\Controllers\Project\GlobalTaskController::class, 'create'])->name('tasks.global.create');
        Route::post('tasks/global', [\App\Http\Controllers\Project\GlobalTaskController::class, 'store'])->name('tasks.global.store');
        Route::get('tasks/global/{task}/edit', [\App\Http\Controllers\Project\GlobalTaskController::class, 'edit'])->name('tasks.global.edit');
        Route::put('tasks/global/{task}', [\App\Http\Controllers\Project\GlobalTaskController::class, 'update'])->name('tasks.global.update');
        Route::delete('tasks/global/{task}', [\App\Http\Controllers\Project\GlobalTaskController::class, 'destroy'])->name('tasks.global.destroy');
        ...
        Route::get('invoices/datei-import', [\App\Http\Controllers\Invoicing\InvoicePdfImportController::class, 'create'])->name('invoices.pdf-import.create');
        Route::post('invoices/datei-import', [\App\Http\Controllers\Invoicing\InvoicePdfImportController::class, 'store'])->name('invoices.pdf-import.store');
        ...
        Route::prefix('rundschreiben')->name('circulars.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Communication\CustomerCircularController::class, 'index'])->name('index');
            Route::get('neu', [\App\Http\Controllers\Communication\CustomerCircularController::class, 'form'])->name('create');
            Route::post('/', [\App\Http\Controllers\Communication\CustomerCircularController::class, 'store'])->name('store');
            Route::get('{circular}', [\App\Http\Controllers\Communication\CustomerCircularController::class, 'show'])->name('show');
            Route::post('{circular}/freigeben', [\App\Http\Controllers\Communication\CustomerCircularController::class, 'approve'])->name('approve');
            Route::post('{circular}/versenden', [\App\Http\Controllers\Communication\CustomerCircularController::class, 'send'])->name('send');
        });

        // Anlagen-Stückliste (Feature 118, MVP-607).
        Route::get('assets/{asset}/stueckliste', [\App\Http\Controllers\Asset\AssetComponentController::class, 'index'])->name('assets.components.index');
        Route::get('assets/{asset}/stueckliste/neu', [\App\Http\Controllers\Asset\AssetComponentController::class, 'form'])->name('assets.components.create');
        Route::post('assets/{asset}/stueckliste', [\App\Http\Controllers\Asset\AssetComponentController::class, 'store'])->name('assets.components.store');
        Route::get('assets/{asset}/stueckliste/{component}/ersetzen', [\App\Http\Controllers\Asset\AssetComponentController::class, 'form'])->name('assets.components.replace-form');
        Route::post('assets/{asset}/stueckliste/{component}/ersetzen', [\App\Http\Controllers\Asset\AssetComponentController::class, 'replace'])->name('assets.components.replace');
        Route::post('assets/{asset}/stueckliste/{component}/ausbauen', [\App\Http\Controllers\Asset\AssetComponentController::class, 'remove'])->name('assets.components.remove');

        // Pflichtnachweise von Subunternehmern (Feature 117, MVP-606).
        Route::get('lieferanten/nachweise', [\App\Http\Controllers\Supplier\SupplierCredentialController::class, 'index'])->name('suppliers.credentials.index');
        Route::get('lieferanten/{supplier}/nachweise/neu', [\App\Http\Controllers\Supplier\SupplierCredentialController::class, 'form'])->name('suppliers.credentials.create');
        Route::post('lieferanten/{supplier}/nachweise', [\App\Http\Controllers\Supplier\SupplierCredentialController::class, 'store'])->name('suppliers.credentials.store');
        Route::delete('lieferanten/{supplier}/nachweise/{credential}', [\App\Http\Controllers\Supplier\SupplierCredentialController::class, 'destroy'])->name('suppliers.credentials.destroy');

        // Zählerstands-Faktura (Feature 116, MVP-605).
        Route::prefix('zaehlerabrechnung')->name('metering.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Metering\MeterBillingController::class, 'index'])->name('index');
            Route::get('neu', [\App\Http\Controllers\Metering\MeterBillingController::class, 'form'])->name('create');
            Route::post('/', [\App\Http\Controllers\Metering\MeterBillingController::class, 'store'])->name('store');
            Route::get('{agreement}/bearbeiten', [\App\Http\Controllers\Metering\MeterBillingController::class, 'form'])->name('edit');
            Route::put('{agreement}', [\App\Http\Controllers\Metering\MeterBillingController::class, 'update'])->name('update');
            Route::post('{agreement}/abrechnen', [\App\Http\Controllers\Metering\MeterBillingController::class, 'run'])->name('run');
        });
        ...
        Route::prefix('vobb-schreiben')->name('construction-notices.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'index'])->name('index');
            Route::get('neu', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'form'])->name('create');
            Route::post('/', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'store'])->name('store');
            Route::get('{notice}', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'show'])->name('show');
            Route::get('{notice}/bearbeiten', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'form'])->name('edit');
            Route::put('{notice}', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'update'])->name('update');
            Route::get('{notice}/pdf', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'pdf'])->name('pdf');
            Route::get('{notice}/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'constructionNoticeForm'])->name('mail.form');
            Route::post('{notice}/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'constructionNoticeSend'])->name('mail');
            Route::post('{notice}/zustellung', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'recordDelivery'])->name('delivery');
            Route::post('{notice}/eingang', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'acknowledge'])->name('acknowledge');
            Route::delete('{notice}', [\App\Http\Controllers\Construction\ConstructionNoticeController::class, 'destroy'])->name('destroy');
        });

        // Gewährleistungsfristen (Feature 115, MVP-604).
        Route::prefix('gewaehrleistung')->name('warranties.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Warranty\WarrantyPeriodController::class, 'index'])->name('index');
            Route::get('neu', [\App\Http\Controllers\Warranty\WarrantyPeriodController::class, 'form'])->name('create');
            Route::post('/', [\App\Http\Controllers\Warranty\WarrantyPeriodController::class, 'store'])->name('store');
            Route::post('{warranty}/abschliessen', [\App\Http\Controllers\Warranty\WarrantyPeriodController::class, 'close'])->name('close');
        });

        // Bürgschaftsregister (Feature 114, MVP-603).
        Route::prefix('buergschaften')->name('guarantees.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Guarantee\GuaranteeController::class, 'index'])->name('index');
            Route::get('neu', [\App\Http\Controllers\Guarantee\GuaranteeController::class, 'form'])->name('create');
            Route::post('/', [\App\Http\Controllers\Guarantee\GuaranteeController::class, 'store'])->name('store');
            Route::get('{guarantee}/bearbeiten', [\App\Http\Controllers\Guarantee\GuaranteeController::class, 'form'])->name('edit');
        ...
        Route::get('invoices/{invoice}/einbehalte/dialog', [\App\Http\Controllers\Invoicing\InvoiceRetentionController::class, 'dialog'])->name('invoices.retentions.dialog');
        Route::post('invoices/{invoice}/einbehalte', [\App\Http\Controllers\Invoicing\InvoiceRetentionController::class, 'store'])->name('invoices.retentions.store');
        Route::post('invoices/{invoice}/einbehalte/{retention}/freigeben', [\App\Http\Controllers\Invoicing\InvoiceRetentionController::class, 'release'])->name('invoices.retentions.release');
        ...
        Route::post('invoices/{invoice}/peppol', [\App\Http\Controllers\Invoicing\InvoicePeppolController::class, 'send'])->name('invoices.peppol.send');
        ...
        Route::get('invoices/{invoice}/einvoice-validierung', [\App\Http\Controllers\Invoicing\InvoiceController::class, 'einvoiceValidation'])->name('invoices.einvoice-validation');
        Route::get('invoices/{invoice}/zugferd', [InvoiceController::class, 'zugferdDownload'])->name('invoices.zugferd');
        Route::get('invoices/{invoice}/e-rechnungsoptionen', [\App\Http\Controllers\Invoicing\InvoicePdfImportController::class, 'edit'])->name('invoices.einvoice-options.edit');
        Route::patch('invoices/{invoice}/e-rechnungsoptionen', [\App\Http\Controllers\Invoicing\InvoicePdfImportController::class, 'update'])->name('invoices.einvoice-options.update');
        Route::get('invoices/{invoice}/originaldatei', [\App\Http\Controllers\Invoicing\InvoicePdfImportController::class, 'source'])->name('invoices.pdf-import.source');
        ...
        Route::prefix('ki/vorschlaege')->name('ai.suggestions.')->group(function (): void {
            ...
            // Feature 143, MVP-711: Protokollpunkte (Freitext veredeln, Chips klassifizieren).
            Route::post('protokolle/punkte/{item}', [\App\Http\Controllers\Ai\AiSuggestionController::class, 'protocolItem'])->name('protocol-item');
            Route::post('protokolle/punkte/{item}/klassifizieren', [\App\Http\Controllers\Ai\AiSuggestionController::class, 'protocolItemClassify'])->name('protocol-item-classify');
            ...
            Route::post('{suggestion}/anwenden', [\App\Http\Controllers\Ai\AiSuggestionController::class, 'apply'])->name('apply');
        ...
        Route::prefix('ki/assistenz')->name('ai.assist.')->group(function (): void {
            // Statische Segmente VOR dem {suggestion}-Wildcard.
            Route::post('angebote/{quote}/positionen/{item}/belegsprache', [\App\Http\Controllers\Ai\AiAssistanceController::class, 'quoteItemTranslate'])->name('quote-item-translate');
            Route::post('angebote/{quote}/begleittext/belegsprache', [\App\Http\Controllers\Ai\AiAssistanceController::class, 'quoteTermsTranslate'])->name('quote-terms-translate');
            Route::post('rueckfragen/{customerQuery}/verstehen', [\App\Http\Controllers\Ai\AiAssistanceController::class, 'portalQuery'])->name('portal-query');
            Route::post('kommunikation/{note}/strukturieren', [\App\Http\Controllers\Ai\AiAssistanceController::class, 'communicationNote'])->name('communication-note');
            ...
            Route::post('{suggestion}/anwenden', [\App\Http\Controllers\Ai\AiAssistanceController::class, 'apply'])->name('apply');
            Route::post('{suggestion}/verwerfen', [\App\Http\Controllers\Ai\AiAssistanceController::class, 'reject'])->name('reject');
        });
        ...
        Route::prefix('verleih')->name('rental.')->group(function (): void {
            ...
            Route::get('anfragen', [\App\Http\Controllers\Rental\RentalRequestController::class, 'index'])->name('requests.index');
            Route::post('anfragen/{rentalRequest}/annehmen', [\App\Http\Controllers\Rental\RentalRequestController::class, 'accept'])->name('requests.accept');
            Route::post('anfragen/{rentalRequest}/ablehnen', [\App\Http\Controllers\Rental\RentalRequestController::class, 'decline'])->name('requests.decline');
        ...
        Route::prefix('angebote')->name('quotes.')->group(function (): void {
            ...
            Route::get('{quote}', [\App\Http\Controllers\Sales\QuoteController::class, 'show'])->name('show');
            Route::delete('{quote}', [\App\Http\Controllers\Sales\QuoteController::class, 'destroy'])->name('destroy');
            // MVP-650: Angebots-PDF + Auftragsbestätigung (Design-Pipeline).
            Route::get('{quote}/pdf', [\App\Http\Controllers\Sales\QuoteController::class, 'pdf'])->name('pdf');
            Route::get('{quote}/auftragsbestaetigung', [\App\Http\Controllers\Sales\QuoteController::class, 'orderConfirmationPdf'])->name('order-confirmation');
            // Feature 128 (MVP-692): PDF-Mailversand — getrennt vom Annahme-Token-Flow (quotes.send).
            Route::get('{quote}/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'quoteForm'])->name('mail.form');
            Route::post('{quote}/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'quoteSend'])->name('mail');
            Route::get('{quote}/auftragsbestaetigung/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'orderConfirmationForm'])->name('order-confirmation.mail.form');
            Route::post('{quote}/auftragsbestaetigung/mail', [\App\Http\Controllers\Document\DocumentMailController::class, 'orderConfirmationSend'])->name('order-confirmation.mail');
            Route::post('{quote}/freigeben', [\App\Http\Controllers\Sales\QuoteController::class, 'approve'])->name('approve');
            Route::post('{quote}/versenden', [\App\Http\Controllers\Sales\QuoteController::class, 'send'])->name('send');
            Route::post('{quote}/entscheiden', [\App\Http\Controllers\Sales\QuoteController::class, 'decide'])->name('decide');
            Route::post('{quote}/neue-version', [\App\Http\Controllers\Sales\QuoteController::class, 'newVersion'])->name('new-version');
            Route::post('{quote}/ueberfuehren', [\App\Http\Controllers\Sales\QuoteController::class, 'convert'])->name('convert');
            Route::get('{quote}/positionen/neu', [\App\Http\Controllers\Sales\QuoteController::class, 'itemForm'])->name('items.create');
            Route::post('{quote}/positionen', [\App\Http\Controllers\Sales\QuoteController::class, 'addItem'])->name('items.store');
        ...
        // ── Mahnlauf (Feature 127, MVP-691 — Vollscan H8): Cockpit über
        // fällige Mahnstufen lokal geführter Rechnungen + Sammelmahnung.
        // Routen MÜSSEN finance.* heißen (Plan-Gating 'finance.*' →
        // module.finance); Recht: canManageBilling (im Controller, wie dun).
        Route::prefix('finanzen/mahnlauf')->name('finance.dunning.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Finance\DunningRunController::class, 'index'])->name('index');
            Route::post('/', [\App\Http\Controllers\Finance\DunningRunController::class, 'run'])->name('run');
        });
        ...
        Route::prefix('finanzen/gobd')->name('finance.gobd.')->group(function (): void {
            ...
            // Abholen eines fertigen Pakets (MVP-722): Recht wie die Erzeugung, mit Audit.
            Route::get('{export}/download', [\App\Http\Controllers\Finance\GobdExportController::class, 'download'])->name('download');
        });
        // GoBD-Verfahrensdokumentation (Feature 134, MVP-699) — module.finance über finance.*,
        // Recht finance.gobd.export über die Policy.
        Route::prefix('finanzen/verfahrensdokumentation')->name('finance.procedure-documentation.')->group(function (): void {
            Route::get('/', [\App\Http\Controllers\Finance\ProcedureDocumentationController::class, 'index'])->name('index');
            Route::post('/', [\App\Http\Controllers\Finance\ProcedureDocumentationController::class, 'store'])->name('store');
            Route::get('{document}', [\App\Http\Controllers\Finance\ProcedureDocumentationController::class, 'show'])->name('show');
        ...
        Route::prefix('finanzen/buchhaltung')->name('finance.accounting.')->group(function (): void {
            ...
            Route::prefix('abschluss')->name('closing.')->group(function (): void {
                ...
                // Jahres-AfA als Inbox-Vorschlag (Feature 133, MVP-698).
                Route::post('jahr/{year}/afa', [\App\Http\Controllers\Finance\PeriodClosingController::class, 'proposeDepreciation'])->name('depreciation');
            ...
            Route::prefix('anlagen')->name('fixed-assets.')->group(function (): void {
                Route::get('/', [\App\Http\Controllers\Finance\FixedAssetController::class, 'index'])->name('index');
                Route::get('neu', [\App\Http\Controllers\Finance\FixedAssetController::class, 'form'])->name('create');
                Route::post('/', [\App\Http\Controllers\Finance\FixedAssetController::class, 'store'])->name('store');
                Route::get('{fixedAsset}', [\App\Http\Controllers\Finance\FixedAssetController::class, 'show'])->name('show');
                Route::get('{fixedAsset}/bearbeiten', [\App\Http\Controllers\Finance\FixedAssetController::class, 'form'])->name('edit');
        ...
        Route::get('time-entries/{timeEntry}/allocations', [\App\Http\Controllers\Time\TimeAllocationController::class, 'edit'])->name('time-entries.allocations.edit');
        Route::put('time-entries/{timeEntry}/allocations', [\App\Http\Controllers\Time\TimeAllocationController::class, 'update'])->name('time-entries.allocations.update');
        ...
        Route::prefix('verein')->name('club.')->group(function (): void {
            ...
            // Graduierungen (MVP-846): Ordnungen, Grade, Regelversionen, Voraussetzungen; Anerkennung und Nachweise je Mitglied.
            Route::get('einstellungen', [\App\Http\Controllers\Club\ClubSettingsController::class, 'edit'])->name('settings.edit');
            Route::put('einstellungen', [\App\Http\Controllers\Club\ClubSettingsController::class, 'update'])->name('settings.update');
            Route::get('graduierungen', [\App\Http\Controllers\Club\ClubGradingController::class, 'index'])->name('grading.index');
            Route::get('graduierungen/create', [\App\Http\Controllers\Club\ClubGradingController::class, 'create'])->name('grading.create');
            Route::post('graduierungen', [\App\Http\Controllers\Club\ClubGradingController::class, 'store'])->name('grading.store');
            Route::get('graduierungen/grad/{grade}/edit', [\App\Http\Controllers\Club\ClubGradingController::class, 'editGrade'])->name('grading.grades.edit');
            Route::put('graduierungen/grad/{grade}', [\App\Http\Controllers\Club\ClubGradingController::class, 'updateGrade'])->name('grading.grades.update');
            Route::delete('graduierungen/grad/{grade}', [\App\Http\Controllers\Club\ClubGradingController::class, 'destroyGrade'])->name('grading.grades.destroy');
            Route::get('graduierungen/version/{version}/edit', [\App\Http\Controllers\Club\ClubGradingController::class, 'editVersion'])->name('grading.versions.edit');
            Route::put('graduierungen/version/{version}', [\App\Http\Controllers\Club\ClubGradingController::class, 'updateVersion'])->name('grading.versions.update');
            Route::post('graduierungen/version/{version}/aktivieren', [\App\Http\Controllers\Club\ClubGradingController::class, 'activateVersion'])->name('grading.versions.activate');
            Route::get('graduierungen/version/{version}/grad/{grade}/edit', [\App\Http\Controllers\Club\ClubGradingController::class, 'editRequirement'])->name('grading.requirements.edit');
            Route::put('graduierungen/version/{version}/grad/{grade}', [\App\Http\Controllers\Club\ClubGradingController::class, 'updateRequirement'])->name('grading.requirements.update');
            Route::delete('graduierungen/voraussetzung/{requirement}', [\App\Http\Controllers\Club\ClubGradingController::class, 'destroyRequirement'])->name('grading.requirements.destroy');
            Route::get('graduierungen/{system}', [\App\Http\Controllers\Club\ClubGradingController::class, 'show'])->name('grading.show');
            Route::get('graduierungen/{system}/edit', [\App\Http\Controllers\Club\ClubGradingController::class, 'edit'])->name('grading.edit');
            Route::put('graduierungen/{system}', [\App\Http\Controllers\Club\ClubGradingController::class, 'update'])->name('grading.update');
            Route::delete('graduierungen/{system}', [\App\Http\Controllers\Club\ClubGradingController::class, 'destroy'])->name('grading.destroy');
            Route::get('graduierungen/{system}/grad/create', [\App\Http\Controllers\Club\ClubGradingController::class, 'createGrade'])->name('grading.grades.create');
            Route::post('graduierungen/{system}/grad', [\App\Http\Controllers\Club\ClubGradingController::class, 'storeGrade'])->name('grading.grades.store');
            Route::post('graduierungen/{system}/version', [\App\Http\Controllers\Club\ClubGradingController::class, 'storeVersion'])->name('grading.versions.store');
            Route::get('mitglieder/{member}/graduierung', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'show'])->name('members.grading');
            Route::get('mitglieder/{member}/graduierung/anerkennen', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'createGrade'])->name('members.grades.create');
            Route::post('mitglieder/{member}/graduierung/anerkennen', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'storeGrade'])->name('members.grades.store');
            Route::get('mitglieder/{member}/graduierung/{memberGrade}/widerrufen', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'revokeDialog'])->name('members.grades.revoke.edit');
            Route::post('mitglieder/{member}/graduierung/{memberGrade}/widerrufen', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'revoke'])->name('members.grades.revoke');
            Route::get('mitglieder/{member}/nachweise/create', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'createProof'])->name('members.proofs.create');
            Route::post('mitglieder/{member}/nachweise', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'storeProof'])->name('members.proofs.store');
            Route::get('mitglieder/{member}/nachweise/{proof}/edit', [\App\Http\Controllers\Club\ClubMemberGradeController::class, 'editProof'])->name('members.proofs.edit');
            ...
            Route::get('beitraege/tarife/{tariff}/edit', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'edit'])->name('fees.tariffs.edit');
            Route::put('beitraege/tarife/{tariff}', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'update'])->name('fees.tariffs.update');
            Route::delete('beitraege/tarife/{tariff}', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'destroy'])->name('fees.tariffs.destroy');
            Route::get('beitraege/tarife/{tariff}/satz/create', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'createRate'])->name('fees.rates.create');
            Route::post('beitraege/tarife/{tariff}/satz', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'storeRate'])->name('fees.rates.store');
            Route::get('beitraege/saetze/{rate}/edit', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'editRate'])->name('fees.rates.edit');
            Route::put('beitraege/saetze/{rate}', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'updateRate'])->name('fees.rates.update');
            Route::delete('beitraege/saetze/{rate}', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'destroyRate'])->name('fees.rates.destroy');
            Route::get('beitraege/zuschlaege/create', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'createSurcharge'])->name('fees.surcharges.create');
            Route::post('beitraege/zuschlaege', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'storeSurcharge'])->name('fees.surcharges.store');
            Route::get('beitraege/zuschlaege/{surcharge}/edit', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'editSurcharge'])->name('fees.surcharges.edit');
            Route::put('beitraege/zuschlaege/{surcharge}', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'updateSurcharge'])->name('fees.surcharges.update');
            Route::delete('beitraege/zuschlaege/{surcharge}', [\App\Http\Controllers\Club\ClubFeeTariffController::class, 'destroySurcharge'])->name('fees.surcharges.destroy');
            // Wettkämpfe, Leistungen, Startrechte, Nachweisliste (MVP-855).
            Route::get('wettkaempfe', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'index'])->name('competitions.index');
            Route::get('wettkaempfe/create', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'create'])->name('competitions.create');
            Route::post('wettkaempfe', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'store'])->name('competitions.store');
            Route::get('wettkaempfe/{event}', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'show'])->name('competitions.show');
            Route::get('wettkaempfe/{event}/edit', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'edit'])->name('competitions.edit');
            Route::put('wettkaempfe/{event}', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'update'])->name('competitions.update');
            Route::get('wettkaempfe/{event}/meldungen/create', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'entryDialog'])->name('competitions.entries.create');
            Route::post('wettkaempfe/{event}/meldungen', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'enter'])->name('competitions.entries.store');
            Route::post('wettkaempfe/{event}/meldungen/{entry}/klaeren', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'clearEntry'])->name('competitions.entries.clear');
            Route::post('wettkaempfe/{event}/meldungen/{entry}/zurueckziehen', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'withdraw'])->name('competitions.entries.withdraw');
            Route::get('wettkaempfe/{event}/meldungen/{entry}/ergebnis', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'resultDialog'])->name('competitions.entries.result.edit');
            Route::post('wettkaempfe/{event}/meldungen/{entry}/ergebnis', [\App\Http\Controllers\Club\ClubCompetitionController::class, 'recordResult'])->name('competitions.entries.result');
            Route::get('mitglieder/{member}/leistungen/create', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'create'])->name('members.performances.create');
            Route::post('mitglieder/{member}/leistungen', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'store'])->name('members.performances.store');
            Route::get('mitglieder/{member}/leistungen/{performance}/edit', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'edit'])->name('members.performances.edit');
            Route::put('mitglieder/{member}/leistungen/{performance}', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'update'])->name('members.performances.update');
            Route::post('mitglieder/{member}/leistungen/{performance}/bestaetigen', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'confirm'])->name('members.performances.confirm');
            Route::delete('mitglieder/{member}/leistungen/{performance}', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'destroy'])->name('members.performances.destroy');
            Route::get('mitglieder/{member}/startrechte/create', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'startRightDialog'])->name('members.startrights.create');
            Route::post('mitglieder/{member}/startrechte', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'grantStartRight'])->name('members.startrights.store');
            Route::delete('mitglieder/{member}/startrechte/{startRight}', [\App\Http\Controllers\Club\ClubPerformanceController::class, 'revokeStartRight'])->name('members.startrights.destroy');
            Route::get('nachweisliste', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'index'])->name('requirements.index');
            Route::get('nachweisliste/create', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'create'])->name('requirements.create');
            Route::post('nachweisliste', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'store'])->name('requirements.store');
            Route::get('nachweisliste/{requirement}/edit', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'edit'])->name('requirements.edit');
            Route::put('nachweisliste/{requirement}', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'update'])->name('requirements.update');
            Route::delete('nachweisliste/{requirement}', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'destroy'])->name('requirements.destroy');
            Route::get('nachweisliste/{requirement}/export', [\App\Http\Controllers\Club\ClubAttendanceRequirementController::class, 'export'])->name('requirements.export');
            // Reitbetrieb (MVP-854).
            Route::get('pferde', [\App\Http\Controllers\Club\ClubHorseController::class, 'index'])->name('horses.index');
            Route::get('pferde/create', [\App\Http\Controllers\Club\ClubHorseController::class, 'create'])->name('horses.create');
            Route::post('pferde', [\App\Http\Controllers\Club\ClubHorseController::class, 'store'])->name('horses.store');
            Route::get('pferde/{horse}', [\App\Http\Controllers\Club\ClubHorseController::class, 'show'])->name('horses.show');
            Route::get('pferde/{horse}/edit', [\App\Http\Controllers\Club\ClubHorseController::class, 'edit'])->name('horses.edit');
            Route::put('pferde/{horse}', [\App\Http\Controllers\Club\ClubHorseController::class, 'update'])->name('horses.update');
            Route::delete('pferde/{horse}', [\App\Http\Controllers\Club\ClubHorseController::class, 'destroy'])->name('horses.destroy');
            Route::post('termine/{event}/pferde', [\App\Http\Controllers\Club\ClubEventHorseController::class, 'assign'])->name('events.horses.assign');
            Route::delete('termine/{event}/pferde/{assignment}', [\App\Http\Controllers\Club\ClubEventHorseController::class, 'unassign'])->name('events.horses.unassign');
            Route::post('termine/{event}/pferde/einsatz', [\App\Http\Controllers\Club\ClubEventHorseController::class, 'recordUse'])->name('events.horses.use');
            // Sportstätten und Ressourcen (MVP-853).
            Route::get('sportstaetten', [\App\Http\Controllers\Club\ClubResourceController::class, 'index'])->name('resources.index');
            Route::get('sportstaetten/create', [\App\Http\Controllers\Club\ClubResourceController::class, 'create'])->name('resources.create');
            Route::post('sportstaetten', [\App\Http\Controllers\Club\ClubResourceController::class, 'store'])->name('resources.store');
            Route::get('sportstaetten/{resource}', [\App\Http\Controllers\Club\ClubResourceController::class, 'show'])->name('resources.show');
            Route::get('sportstaetten/{resource}/edit', [\App\Http\Controllers\Club\ClubResourceController::class, 'edit'])->name('resources.edit');
            Route::put('sportstaetten/{resource}', [\App\Http\Controllers\Club\ClubResourceController::class, 'update'])->name('resources.update');
            Route::delete('sportstaetten/{resource}', [\App\Http\Controllers\Club\ClubResourceController::class, 'destroy'])->name('resources.destroy');
            Route::get('sportstaetten/{resource}/sperre/create', [\App\Http\Controllers\Club\ClubResourceController::class, 'closureDialog'])->name('resources.closures.create');
            Route::post('sportstaetten/{resource}/sperre', [\App\Http\Controllers\Club\ClubResourceController::class, 'close'])->name('resources.close');
            Route::delete('sportstaetten/{resource}/sperre/{closure}', [\App\Http\Controllers\Club\ClubResourceController::class, 'reopen'])->name('resources.closures.destroy');
            Route::get('sportstaetten/{resource}/freigaben/create', [\App\Http\Controllers\Club\ClubResourceController::class, 'clearanceDialog'])->name('resources.clearances.create');
            Route::post('sportstaetten/{resource}/freigaben', [\App\Http\Controllers\Club\ClubResourceController::class, 'grantClearance'])->name('resources.clearances.store');
            Route::delete('sportstaetten/{resource}/freigaben/{clearance}', [\App\Http\Controllers\Club\ClubResourceController::class, 'revokeClearance'])->name('resources.clearances.destroy');
            Route::get('termine/{event}/ressourcen/create', [\App\Http\Controllers\Club\ClubEventResourceController::class, 'create'])->name('events.resources.create');
            Route::post('termine/{event}/ressourcen', [\App\Http\Controllers\Club\ClubEventResourceController::class, 'store'])->name('events.resources.store');
            Route::delete('termine/{event}/ressourcen/{booking}', [\App\Http\Controllers\Club\ClubEventResourceController::class, 'destroy'])->name('events.resources.destroy');
            // Sportartenprofile, Saisons, Kader, Spieltage, Spielplan-Vorschläge (MVP-852).
            Route::get('sportarten', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'index'])->name('profiles.index');
            Route::get('sportarten/create', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'create'])->name('profiles.create');
            Route::post('sportarten', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'store'])->name('profiles.store');
            Route::post('sportarten/startpaket', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'installPack'])->name('profiles.packs.store');
            Route::get('sportarten/{profile}/edit', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'edit'])->name('profiles.edit');
            Route::put('sportarten/{profile}', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'update'])->name('profiles.update');
            Route::delete('sportarten/{profile}', [\App\Http\Controllers\Club\ClubSportProfileController::class, 'destroy'])->name('profiles.destroy');
            Route::get('saisons/create', [\App\Http\Controllers\Club\ClubTeamController::class, 'createSeason'])->name('seasons.create');
            Route::post('saisons', [\App\Http\Controllers\Club\ClubTeamController::class, 'storeSeason'])->name('seasons.store');
            Route::get('gruppen/{group}/kader/create', [\App\Http\Controllers\Club\ClubTeamController::class, 'createSquadMember'])->name('groups.squad.create');
            Route::post('gruppen/{group}/kader', [\App\Http\Controllers\Club\ClubTeamController::class, 'storeSquadMember'])->name('groups.squad.store');
            Route::get('gruppen/{group}/kader/{squadMember}/edit', [\App\Http\Controllers\Club\ClubTeamController::class, 'editSquadMember'])->name('groups.squad.edit');
            Route::put('gruppen/{group}/kader/{squadMember}', [\App\Http\Controllers\Club\ClubTeamController::class, 'updateSquadMember'])->name('groups.squad.update');
            Route::post('gruppen/{group}/kader/{squadMember}/beenden', [\App\Http\Controllers\Club\ClubTeamController::class, 'endSquadMember'])->name('groups.squad.end');
            Route::get('spieltage', [\App\Http\Controllers\Club\ClubMatchController::class, 'index'])->name('matches.index');
            Route::get('spieltage/vorschlaege', [\App\Http\Controllers\Club\ClubMatchProposalController::class, 'index'])->name('matches.proposals.index');
            Route::get('spieltage/vorschlaege/import', [\App\Http\Controllers\Club\ClubMatchProposalController::class, 'importDialog'])->name('matches.proposals.import.create');
            Route::post('spieltage/vorschlaege/import', [\App\Http\Controllers\Club\ClubMatchProposalController::class, 'import'])->name('matches.proposals.import');
            Route::get('spieltage/vorschlaege/{proposal}/uebernehmen', [\App\Http\Controllers\Club\ClubMatchProposalController::class, 'acceptDialog'])->name('matches.proposals.accept.edit');
            Route::post('spieltage/vorschlaege/{proposal}/uebernehmen', [\App\Http\Controllers\Club\ClubMatchProposalController::class, 'accept'])->name('matches.proposals.accept');
            Route::post('spieltage/vorschlaege/{proposal}/verwerfen', [\App\Http\Controllers\Club\ClubMatchProposalController::class, 'dismiss'])->name('matches.proposals.dismiss');
            Route::get('spieltage/create', [\App\Http\Controllers\Club\ClubMatchController::class, 'create'])->name('matches.create');
            Route::post('spieltage', [\App\Http\Controllers\Club\ClubMatchController::class, 'store'])->name('matches.store');
            Route::get('spieltage/{event}', [\App\Http\Controllers\Club\ClubMatchController::class, 'show'])->name('matches.show');
            Route::get('spieltage/{event}/edit', [\App\Http\Controllers\Club\ClubMatchController::class, 'edit'])->name('matches.edit');
            Route::put('spieltage/{event}', [\App\Http\Controllers\Club\ClubMatchController::class, 'update'])->name('matches.update');
            Route::post('spieltage/{event}/verfuegbarkeit', [\App\Http\Controllers\Club\ClubMatchController::class, 'availability'])->name('matches.availability');
            Route::post('spieltage/{event}/aufstellung', [\App\Http\Controllers\Club\ClubMatchController::class, 'saveLineup'])->name('matches.lineup');
            Route::post('spieltage/{event}/aufstellung/freigeben', [\App\Http\Controllers\Club\ClubMatchController::class, 'releaseLineup'])->name('matches.lineup.release');
            Route::post('spieltage/{event}/aufstellung/zuruecknehmen', [\App\Http\Controllers\Club\ClubMatchController::class, 'withdrawLineup'])->name('matches.lineup.withdraw');
            Route::get('spieltage/{event}/rollen/create', [\App\Http\Controllers\Club\ClubMatchController::class, 'roleDialog'])->name('matches.roles.create');
            Route::post('spieltage/{event}/rollen', [\App\Http\Controllers\Club\ClubMatchController::class, 'assignRole'])->name('matches.roles.store');
            Route::delete('spieltage/{event}/rollen/{role}', [\App\Http\Controllers\Club\ClubMatchController::class, 'removeRole'])->name('matches.roles.destroy');
            Route::get('spieltage/{event}/ergebnis', [\App\Http\Controllers\Club\ClubMatchController::class, 'resultDialog'])->name('matches.result.edit');
            Route::post('spieltage/{event}/ergebnis', [\App\Http\Controllers\Club\ClubMatchController::class, 'recordResult'])->name('matches.result');
            // Zahlungen, Mahnung, Einzug (MVP-851).
            Route::get('beitraege/konten/{account}/zahlung/create/{claim?}', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'createPayment'])->name('fees.payments.create');
            Route::post('beitraege/konten/{account}/zahlung', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'storePayment'])->name('fees.payments.store');
            Route::post('beitraege/konten/{account}/guthaben-verrechnen', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'applyCredit'])->name('fees.payments.apply-credit');
            Route::get('beitraege/konten/{account}/zahlung/{payment}/ruecklastschrift', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'chargebackDialog'])->name('fees.payments.chargeback.edit');
            Route::post('beitraege/konten/{account}/zahlung/{payment}/ruecklastschrift', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'chargeback'])->name('fees.payments.chargeback');
            Route::get('beitraege/konten/{account}/einstellungen', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'accountSettingsDialog'])->name('fees.accounts.settings.edit');
            Route::post('beitraege/konten/{account}/einstellungen', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'accountSettings'])->name('fees.accounts.settings');
            Route::get('beitraege/forderungen/{claim}/mahnen', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'dunningDialog'])->name('fees.claims.dun.edit');
            Route::post('beitraege/forderungen/{claim}/mahnen', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'dun'])->name('fees.claims.dun');
            Route::get('beitraege/forderungen/{claim}/mahnung/{dunning}/pdf', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'dunningPdf'])->name('fees.claims.dunning.pdf');
            Route::get('beitraege/forderungen/{claim}/mahnsperre', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'blockDunningDialog'])->name('fees.claims.dunning.block.edit');
            Route::post('beitraege/forderungen/{claim}/mahnsperre', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'blockDunning'])->name('fees.claims.dunning.block');
            Route::post('beitraege/forderungen/{claim}/mahnsperre-aufheben', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'unblockDunning'])->name('fees.claims.dunning.unblock');
            Route::post('beitraege/forderungen/{claim}/einzug-freigeben', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'unblockCollection'])->name('fees.claims.collection.unblock');
            Route::get('beitraege/einzug', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'collections'])->name('fees.collections.index');
            Route::post('beitraege/einzug', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'storeCollection'])->name('fees.collections.store');
            Route::post('beitraege/einzug/{run}/abbrechen', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'cancelCollection'])->name('fees.collections.cancel');
            Route::post('beitraege/einzug/{run}/eingang', [\App\Http\Controllers\Club\ClubFeePaymentController::class, 'settleCollection'])->name('fees.collections.settle');
            // Beitragslauf und Forderungen (MVP-850).
            Route::get('beitraege/laeufe', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'index'])->name('fees.runs.index');
            Route::get('beitraege/laeufe/create', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'create'])->name('fees.runs.create');
            Route::post('beitraege/laeufe', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'store'])->name('fees.runs.store');
            Route::get('beitraege/laeufe/{run}', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'show'])->name('fees.runs.show');
            Route::post('beitraege/laeufe/{run}/neu', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'recalculate'])->name('fees.runs.recalculate');
            Route::post('beitraege/laeufe/{run}/freigeben', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'release'])->name('fees.runs.release');
            Route::post('beitraege/laeufe/{run}/verwerfen', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'cancel'])->name('fees.runs.cancel');
            Route::get('beitraege/laeufe/{run}/export', [\App\Http\Controllers\Club\ClubFeeRunController::class, 'export'])->name('fees.runs.export');
            Route::get('beitraege/forderungen', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'index'])->name('fees.claims.index');
            Route::get('beitraege/forderungen/{claim}', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'show'])->name('fees.claims.show');
            Route::get('beitraege/forderungen/{claim}/pdf', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'pdf'])->name('fees.claims.pdf');
            Route::get('beitraege/forderungen/{claim}/senden', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'sendDialog'])->name('fees.claims.send.edit');
            Route::post('beitraege/forderungen/{claim}/senden', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'send'])->name('fees.claims.send');
            Route::get('beitraege/forderungen/{claim}/storno', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'cancelDialog'])->name('fees.claims.cancel.edit');
            Route::post('beitraege/forderungen/{claim}/storno', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'cancel'])->name('fees.claims.cancel');
            Route::get('beitraege/forderungen/{claim}/korrektur', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'correctionDialog'])->name('fees.claims.correction.create');
            Route::post('beitraege/forderungen/{claim}/korrektur', [\App\Http\Controllers\Club\ClubFeeClaimController::class, 'storeCorrection'])->name('fees.claims.correction.store');
            Route::get('beitraege/vorschau', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'preview'])->name('fees.preview');
            Route::get('beitraege/konten', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'index'])->name('fees.accounts.index');
            Route::get('beitraege/konten/create', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'create'])->name('fees.accounts.create');
            Route::post('beitraege/konten', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'store'])->name('fees.accounts.store');
            Route::get('beitraege/konten/{account}', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'show'])->name('fees.accounts.show');
            Route::get('beitraege/konten/{account}/edit', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'edit'])->name('fees.accounts.edit');
            Route::put('beitraege/konten/{account}', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'update'])->name('fees.accounts.update');
            Route::get('beitraege/konten/{account}/zuordnung/create', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'createAssignment'])->name('fees.assignments.create');
            Route::post('beitraege/konten/{account}/zuordnung', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'storeAssignment'])->name('fees.assignments.store');
            Route::get('beitraege/konten/{account}/zuordnung/{assignment}/edit', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'editAssignment'])->name('fees.assignments.edit');
            Route::put('beitraege/konten/{account}/zuordnung/{assignment}', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'updateAssignment'])->name('fees.assignments.update');
            Route::post('beitraege/konten/{account}/zuordnung/{assignment}/beenden', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'endAssignment'])->name('fees.assignments.end');
            Route::get('beitraege/konten/{account}/zuordnung/{assignment}/pruefen', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'reviewDialog'])->name('fees.assignments.review.edit');
            Route::post('beitraege/konten/{account}/zuordnung/{assignment}/pruefen', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'review'])->name('fees.assignments.review');
            Route::get('beitraege/konten/{account}/mitglied/{member}/befreiung/create', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'createExemption'])->name('fees.exemptions.create');
            Route::post('beitraege/konten/{account}/mitglied/{member}/befreiung', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'storeExemption'])->name('fees.exemptions.store');
            Route::get('beitraege/konten/{account}/befreiung/{exemption}/edit', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'editExemption'])->name('fees.exemptions.edit');
            Route::put('beitraege/konten/{account}/befreiung/{exemption}', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'updateExemption'])->name('fees.exemptions.update');
            Route::delete('beitraege/konten/{account}/befreiung/{exemption}', [\App\Http\Controllers\Club\ClubFeeAccountController::class, 'destroyExemption'])->name('fees.exemptions.destroy');
            // Prüfungen (MVP-847): Angebote, Kandidaten, Ergebnisse; Bescheinigungen.
            Route::get('pruefungen', [\App\Http\Controllers\Club\ClubExamController::class, 'index'])->name('exams.index');
            Route::get('pruefungen/create', [\App\Http\Controllers\Club\ClubExamController::class, 'create'])->name('exams.create');
            Route::post('pruefungen', [\App\Http\Controllers\Club\ClubExamController::class, 'store'])->name('exams.store');
            Route::get('pruefungen/{offer}', [\App\Http\Controllers\Club\ClubExamController::class, 'show'])->name('exams.show');
            Route::get('pruefungen/{offer}/edit', [\App\Http\Controllers\Club\ClubExamController::class, 'edit'])->name('exams.edit');
            Route::put('pruefungen/{offer}', [\App\Http\Controllers\Club\ClubExamController::class, 'update'])->name('exams.update');
            Route::post('pruefungen/{offer}/neu-pruefen', [\App\Http\Controllers\Club\ClubExamController::class, 'recheck'])->name('exams.recheck');
            Route::get('pruefungen/{offer}/kandidaten/create', [\App\Http\Controllers\Club\ClubExamController::class, 'candidateDialog'])->name('exams.candidates.create');
            Route::post('pruefungen/{offer}/kandidaten', [\App\Http\Controllers\Club\ClubExamController::class, 'storeCandidate'])->name('exams.candidates.store');
            Route::post('pruefungen/{offer}/kandidaten/{candidate}/freigeben', [\App\Http\Controllers\Club\ClubExamController::class, 'approve'])->name('exams.candidates.approve');
            Route::post('pruefungen/{offer}/kandidaten/{candidate}/zulassen', [\App\Http\Controllers\Club\ClubExamController::class, 'admit'])->name('exams.candidates.admit');
            Route::get('pruefungen/{offer}/kandidaten/{candidate}/ausnahme', [\App\Http\Controllers\Club\ClubExamController::class, 'exceptionDialog'])->name('exams.candidates.exception.edit');
            Route::post('pruefungen/{offer}/kandidaten/{candidate}/ablehnen', [\App\Http\Controllers\Club\ClubExamController::class, 'reject'])->name('exams.candidates.reject');
            Route::post('pruefungen/{offer}/kandidaten/{candidate}/ueberprueft', [\App\Http\Controllers\Club\ClubExamController::class, 'clearReview'])->name('exams.candidates.review');
            Route::get('pruefungen/{offer}/kandidaten/{candidate}/ergebnis', [\App\Http\Controllers\Club\ClubExamController::class, 'resultDialog'])->name('exams.candidates.result.edit');
            Route::post('pruefungen/{offer}/kandidaten/{candidate}/ergebnis', [\App\Http\Controllers\Club\ClubExamController::class, 'storeResult'])->name('exams.candidates.result');
            ...
            Route::post('mein-verein/pruefungen/{event}/anfragen', [\App\Http\Controllers\Club\ClubMyController::class, 'examRequest'])->name('my.exam.request');
            Route::get('mein-verein/bescheinigung/{memberGrade}', [\App\Http\Controllers\Club\ClubMyController::class, 'certificate'])->name('my.certificate');
            Route::get('mein-verein/beitraege', [\App\Http\Controllers\Club\ClubMyController::class, 'fees'])->name('my.fees');
            Route::get('mein-verein/beitraege/{claim}/pdf', [\App\Http\Controllers\Club\ClubMyController::class, 'feePdf'])->name('my.fees.pdf');
            Route::post('mein-verein/spieltage/{event}/verfuegbarkeit', [\App\Http\Controllers\Club\ClubMyController::class, 'availability'])->name('my.availability');
            Route::post('mein-verein/wettkaempfe/{event}/melden', [\App\Http\Controllers\Club\ClubMyController::class, 'compete'])->name('my.compete');
        ...
        Route::prefix('arbeitsschutz')->name('safety.')->group(function (): void {
            Route::get('gefaehrdungsbeurteilungen', [\App\Http\Controllers\Safety\HazardAssessmentController::class, 'index'])->name('assessments.index');
            Route::get('gefaehrdungsbeurteilungen/create', [\App\Http\Controllers\Safety\HazardAssessmentController::class, 'create'])->name('assessments.create');
            ...
            Route::delete('gefaehrdungsbeurteilungen/{assessment}', [\App\Http\Controllers\Safety\HazardAssessmentController::class, 'destroy'])->name('assessments.destroy');
            Route::get('gefaehrdungsbeurteilungen/{assessment}/positionen/create', [\App\Http\Controllers\Safety\HazardAssessmentController::class, 'createItem'])->name('assessments.items.create');
            Route::post('gefaehrdungsbeurteilungen/{assessment}/positionen', [\App\Http\Controllers\Safety\HazardAssessmentController::class, 'storeItem'])->name('assessments.items.store');
            ...
            Route::put('vorsorge/{checkup}', [\App\Http\Controllers\Safety\MedicalCheckupController::class, 'update'])->name('checkups.update');
            Route::delete('vorsorge/{checkup}', [\App\Http\Controllers\Safety\MedicalCheckupController::class, 'destroy'])->name('checkups.destroy');
        });

        // ── Trainingsmanagement (Feature 145, MVP-727): Katalog, Pflichtmatrix, Soll ──
        // Nachweise bleiben im Arbeitsschutz-Register (132) — hier gibt es
        // bewusst keine Signatur-Route. Rechte training.viewAny/manage.
        Route::prefix('schulungen')->name('training.')->group(function (): void {
            Route::get('kurse', [\App\Http\Controllers\Training\TrainingCourseController::class, 'index'])->name('courses.index');
            Route::get('kurse/create', [\App\Http\Controllers\Training\TrainingCourseController::class, 'create'])->name('courses.create');
            Route::post('kurse', [\App\Http\Controllers\Training\TrainingCourseController::class, 'store'])->name('courses.store');
            Route::get('kurse/{course}', [\App\Http\Controllers\Training\TrainingCourseController::class, 'show'])->name('courses.show');
            Route::get('kurse/{course}/edit', [\App\Http\Controllers\Training\TrainingCourseController::class, 'edit'])->name('courses.edit');
            Route::put('kurse/{course}', [\App\Http\Controllers\Training\TrainingCourseController::class, 'update'])->name('courses.update');
            Route::delete('kurse/{course}', [\App\Http\Controllers\Training\TrainingCourseController::class, 'destroy'])->name('courses.destroy');
            Route::get('kurse/{course}/versionen/create', [\App\Http\Controllers\Training\TrainingCourseController::class, 'createVersion'])->name('courses.versions.create');
            Route::post('kurse/{course}/versionen', [\App\Http\Controllers\Training\TrainingCourseController::class, 'storeVersion'])->name('courses.versions.store');
            Route::delete('kurse/{course}/versionen/{version}', [\App\Http\Controllers\Training\TrainingCourseController::class, 'destroyVersion'])->name('courses.versions.destroy');

            Route::get('pflichtmatrix', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'index'])->name('requirements.index');
            Route::get('pflichtmatrix/create', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'create'])->name('requirements.create');
            Route::post('pflichtmatrix', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'store'])->name('requirements.store');
            Route::post('pflichtmatrix/abgleich', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'sync'])->name('requirements.sync');
            Route::get('pflichtmatrix/{requirement}/edit', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'edit'])->name('requirements.edit');
            Route::put('pflichtmatrix/{requirement}', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'update'])->name('requirements.update');
            Route::delete('pflichtmatrix/{requirement}', [\App\Http\Controllers\Training\TrainingRequirementController::class, 'destroy'])->name('requirements.destroy');

            Route::get('soll', [\App\Http\Controllers\Training\TrainingAssignmentController::class, 'index'])->name('assignments.index');
            Route::get('soll/create', [\App\Http\Controllers\Training\TrainingAssignmentController::class, 'create'])->name('assignments.create');
            Route::post('soll', [\App\Http\Controllers\Training\TrainingAssignmentController::class, 'store'])->name('assignments.store');
        ...
        Route::prefix('lernen')->name('learning.')->group(function (): void {
            ...
            Route::post('kurse/{course}/duplizieren', [\App\Http\Controllers\Learning\LearningCourseController::class, 'duplicate'])->name('courses.duplicate');
            Route::post('kurse/import', [\App\Http\Controllers\Learning\LearningCourseController::class, 'importCourse'])->name('courses.import');
            // LearnDash-Import (MVP-792): Export-ZIP als Entwürfe übernehmen.
            Route::get('kurse/import/learndash', [\App\Http\Controllers\Learning\LearningCourseController::class, 'importLearnDashDialog'])->name('courses.import-learndash.create');
            Route::post('kurse/import/learndash', [\App\Http\Controllers\Learning\LearningCourseController::class, 'importLearnDash'])->name('courses.import-learndash');
            ...
            // Fragenkatalog (MVP-782): Fragen gehören der Organisation, Prüfungen zeigen darauf.
            Route::get('fragen', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'index'])->name('questions.index');
            Route::get('fragen/create', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'create'])->name('questions.create');
            Route::post('fragen', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'store'])->name('questions.store');
            Route::get('fragen/{question}/edit', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'edit'])->name('questions.edit');
            Route::put('fragen/{question}', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'update'])->name('questions.update');
            Route::post('fragen/{question}/duplizieren', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'duplicate'])->name('questions.duplicate');
            Route::delete('fragen/{question}', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'destroy'])->name('questions.destroy');
            Route::post('fragen/kategorien', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'storeCategory'])->name('questions.categories.store');
            Route::patch('fragen/kategorien/{category}', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'updateCategory'])->name('questions.categories.update');
            Route::delete('fragen/kategorien/{category}', [\App\Http\Controllers\Learning\LearningQuestionCatalogController::class, 'destroyCategory'])->name('questions.categories.destroy');

            // Einstellungen der Lernplattform (MVP-786): Trainer-Scoping, Gamification, Einbettungs-Hosts.
            Route::get('einstellungen', [\App\Http\Controllers\Learning\LearningSettingsController::class, 'edit'])->name('settings.edit');
            Route::put('einstellungen', [\App\Http\Controllers\Learning\LearningSettingsController::class, 'update'])->name('settings.update');
            // Trainer je Kurs (MVP-786).
            Route::post('kurse/{course}/trainer', [\App\Http\Controllers\Learning\LearningCourseController::class, 'storeTrainer'])->name('courses.trainers.store');
            Route::delete('kurse/{course}/trainer/{user}', [\App\Http\Controllers\Learning\LearningCourseController::class, 'destroyTrainer'])->name('courses.trainers.destroy');

            // Teilnehmerverwaltung je Kurs (MVP-778): Einschreibungen sehen,
            // manuell einschreiben, Frist/Zugang ändern, stornieren, Einstiegslink
            // für Externe. Recht: updateMeta am Kurs; fremde Einschreibung = 404.
            Route::get('kurse/{course}/teilnehmer', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'index'])->name('courses.enrollments.index');
            Route::get('kurse/{course}/teilnehmer/create', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'create'])->name('courses.enrollments.create');
            Route::post('kurse/{course}/teilnehmer', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'store'])->name('courses.enrollments.store');
            Route::get('kurse/{course}/teilnehmer/{enrollment}/edit', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'edit'])->name('courses.enrollments.edit');
            Route::patch('kurse/{course}/teilnehmer/{enrollment}', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'update'])->name('courses.enrollments.update');
            Route::post('kurse/{course}/teilnehmer/{enrollment}/stornieren', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'cancel'])->name('courses.enrollments.cancel');
            Route::post('kurse/{course}/teilnehmer/{enrollment}/zugangslink', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'accessLink'])->name('courses.enrollments.access-link');
            // Versuchsfreigabe (MVP-785): ein weiterer Versuch trotz Grenze oder Sperrfrist.
            Route::get('kurse/{course}/teilnehmer/{enrollment}/versuchsfreigabe', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'waiverDialog'])->name('courses.enrollments.waiver');
            Route::post('kurse/{course}/teilnehmer/{enrollment}/versuchsfreigabe', [\App\Http\Controllers\Learning\LearningEnrollmentController::class, 'grantWaiver'])->name('courses.enrollments.attempt-waiver');

            // KI-Eingänge (MVP-781): Gliederungs- und Fragenentwurf — nur Vorschläge,
            // der Autor übernimmt einzeln; nichts wird bewertet oder entschieden.
            Route::get('kurse/{course}/ki-gliederung/create', [\App\Http\Controllers\Learning\LearningCourseController::class, 'createAiOutline'])->name('courses.ai-outline.create');
            Route::post('kurse/{course}/ki-gliederung', [\App\Http\Controllers\Learning\LearningCourseController::class, 'storeAiOutline'])->name('courses.ai-outline');
            Route::post('kurse/{course}/einheiten/{unit}/pruefung/fragen/ki-entwurf', [\App\Http\Controllers\Learning\LearningCourseController::class, 'draftQuestions'])->name('courses.units.quiz.ai-draft');
            ...
            // Fragen bearbeiten, kopieren, sortieren (MVP-779).
            // Prüfungsstatistik (MVP-785).
            Route::get('kurse/{course}/einheiten/{unit}/pruefung/statistik', [\App\Http\Controllers\Learning\LearningCourseController::class, 'quizStatistics'])->name('courses.units.quiz.statistics');
            // Fragenkatalog in der Prüfung (MVP-782): übernehmen, Ziehregeln.
            Route::get('kurse/{course}/einheiten/{unit}/pruefung/katalog', [\App\Http\Controllers\Learning\LearningCourseController::class, 'catalogPicker'])->name('courses.units.quiz.catalog');
            Route::post('kurse/{course}/einheiten/{unit}/pruefung/katalog', [\App\Http\Controllers\Learning\LearningCourseController::class, 'attachQuestions'])->name('courses.units.quiz.attach');
            Route::post('kurse/{course}/einheiten/{unit}/pruefung/ziehregeln', [\App\Http\Controllers\Learning\LearningCourseController::class, 'storeDrawRule'])->name('courses.units.quiz.draw-rules.store');
            Route::delete('kurse/{course}/einheiten/{unit}/pruefung/ziehregeln/{rule}', [\App\Http\Controllers\Learning\LearningCourseController::class, 'destroyDrawRule'])->name('courses.units.quiz.draw-rules.destroy');
            Route::get('kurse/{course}/einheiten/{unit}/pruefung/fragen/{question}/edit', [\App\Http\Controllers\Learning\LearningCourseController::class, 'editQuestion'])->name('courses.units.quiz.questions.edit');
            Route::put('kurse/{course}/einheiten/{unit}/pruefung/fragen/{question}', [\App\Http\Controllers\Learning\LearningCourseController::class, 'updateQuestion'])->name('courses.units.quiz.questions.update');
            Route::post('kurse/{course}/einheiten/{unit}/pruefung/fragen/{question}/duplizieren', [\App\Http\Controllers\Learning\LearningCourseController::class, 'duplicateQuestion'])->name('courses.units.quiz.questions.duplicate');
            Route::post('kurse/{course}/einheiten/{unit}/pruefung/fragen/{question}/verschieben', [\App\Http\Controllers\Learning\LearningCourseController::class, 'moveQuestion'])->name('courses.units.quiz.questions.move');
            // Kursstruktur sortieren (MVP-779).
            Route::post('kurse/{course}/einheiten/{unit}/verschieben', [\App\Http\Controllers\Learning\LearningCourseController::class, 'moveUnit'])->name('courses.units.move');
            Route::post('kurse/{course}/abschnitte/{section}/verschieben', [\App\Http\Controllers\Learning\LearningCourseController::class, 'moveSection'])->name('courses.sections.move');
            ...
            Route::get('bewertungen/aufsaetze/{answer}/dateien/{attachment}', [\App\Http\Controllers\Learning\LearningGradingController::class, 'answerFile'])->name('grading.essay.file');
            // Prüfungsakte einsehen (MVP-785) — protokolliert.
            Route::get('bewertungen/versuche/{attempt}', [\App\Http\Controllers\Learning\LearningGradingController::class, 'showAttempt'])->name('grading.attempts.show');
            ...
            // Notenbuch je Kurs (MVP-790): Komponenten, manuelle Noten, Zeugnis, CSV.
            Route::get('kurse/{course}/notenbuch', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'show'])->name('courses.gradebook.show');
            Route::get('kurse/{course}/notenbuch.csv', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'csv'])->name('courses.gradebook.csv');
            Route::get('kurse/{course}/notenbuch/komponenten', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'editComponents'])->name('courses.gradebook.components.edit');
            Route::put('kurse/{course}/notenbuch/komponenten', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'updateComponents'])->name('courses.gradebook.components.update');
            Route::get('kurse/{course}/notenbuch/{enrollment}/zeugnis', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'reportCard'])->name('courses.gradebook.report-card');
            Route::get('kurse/{course}/notenbuch/{enrollment}/{component}/note', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'gradeDialog'])->name('courses.gradebook.grade.create');
            Route::post('kurse/{course}/notenbuch/{enrollment}/{component}/note', [\App\Http\Controllers\Learning\LearningGradebookController::class, 'storeManualGrade'])->name('courses.gradebook.grade.store');
        ...
        Route::prefix('meine-schulungen')->name('learning.my.')->group(function (): void {
            ...
            Route::post('{enrollment}/notizen', [\App\Http\Controllers\Learning\MyLearningController::class, 'storeNote'])->name('notes.store');
            Route::delete('{enrollment}/notizen/{note}', [\App\Http\Controllers\Learning\MyLearningController::class, 'destroyNote'])->name('notes.destroy');
            Route::post('{enrollment}/fokus', [\App\Http\Controllers\Learning\MyLearningController::class, 'toggleFocus'])->name('focus');
            Route::get('{enrollment}/frage', [\App\Http\Controllers\Learning\MyLearningController::class, 'askCreate'])->name('ask.create');
            Route::post('{enrollment}/frage', [\App\Http\Controllers\Learning\MyLearningController::class, 'ask'])->middleware('throttle:10,1')->name('ask.store');
            ...
            // Zwischenspeichern je Antwort (MVP-783): der Versuch bleibt offen, bewertet wird erst bei der Abgabe.
            Route::patch('{enrollment}/versuche/{attempt}/antwort', [\App\Http\Controllers\Learning\MyLearningController::class, 'saveAnswer'])->middleware('throttle:240,1')->name('quiz.answer');
            ...
            Route::get('{enrollment}/zeugnis', [\App\Http\Controllers\Learning\MyLearningController::class, 'reportCard'])->name('report-card');
        ...
        Route::get('documents', [\App\Http\Controllers\Document\DocumentController::class, 'index'])->name('documents.index');
        Route::get('documents/create', [\App\Http\Controllers\Document\DocumentController::class, 'create'])->name('documents.create');
        Route::post('documents', [\App\Http\Controllers\Document\DocumentController::class, 'store'])->name('documents.store');
        // Detailseite (Rang 28) — nach documents/create registriert, damit das Literal zuerst matcht.
        Route::get('documents/{document}', [\App\Http\Controllers\Document\DocumentController::class, 'show'])->name('documents.show');
        Route::get('documents/{document}/edit', [\App\Http\Controllers\Document\DocumentController::class, 'edit'])->name('documents.edit');
        Route::put('documents/{document}', [\App\Http\Controllers\Document\DocumentController::class, 'update'])->name('documents.update');
        Route::get('documents/{document}/versions', [\App\Http\Controllers\Document\DocumentController::class, 'versions'])->name('documents.versions');
        Route::post('documents/{document}/versions', [\App\Http\Controllers\Document\DocumentController::class, 'addVersion'])->name('documents.versions.store');
        Route::get('documents/{document}/download/{version?}', [\App\Http\Controllers\Document\DocumentController::class, 'download'])->name('documents.download');
        Route::post('documents/{document}/archive', [\App\Http\Controllers\Document\DocumentController::class, 'archive'])->name('documents.archive');
        // Kundenfreigabe fürs Kundenportal (Welle D — Dokument-Spiegelung).
        Route::post('documents/{document}/customer-release', [\App\Http\Controllers\Document\DocumentController::class, 'release'])->name('documents.customer-release');
        Route::post('documents/{document}/customer-revoke', [\App\Http\Controllers\Document\DocumentController::class, 'revoke'])->name('documents.customer-revoke');
        Route::delete('documents/{document}', [\App\Http\Controllers\Document\DocumentController::class, 'destroy'])->name('documents.destroy');

        // ── Wissensbasis & Problemhistorie (Feature 011) ───────────────────
        Route::get('knowledge', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'index'])->name('knowledge.index');
        Route::get('knowledge/create', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'create'])->name('knowledge.create');
        Route::post('knowledge', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'store'])->name('knowledge.store');
        Route::get('knowledge/{article}', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'show'])->name('knowledge.show');
        Route::get('knowledge/{article}/edit', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'edit'])->name('knowledge.edit');
        Route::put('knowledge/{article}', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'update'])->name('knowledge.update');
        Route::post('knowledge/{article}/publish', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'publish'])->name('knowledge.publish');
        Route::post('knowledge/{article}/archive', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'archive'])->name('knowledge.archive');
        Route::post('knowledge/{article}/feedback', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'feedback'])->name('knowledge.feedback');
        Route::post('knowledge/{article}/links', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'storeLink'])->name('knowledge.links.store');
        Route::delete('knowledge/{article}/links/{link}', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'destroyLink'])->name('knowledge.links.destroy');
        Route::delete('knowledge/{article}', [\App\Http\Controllers\Knowledge\KnowledgeArticleController::class, 'destroy'])->name('knowledge.destroy');
        ...
        Route::get('wissen', [\App\Http\Controllers\Knowledge\KnowledgeHubController::class, 'index'])->name('knowledge-hub.index');
        ...
        Route::get('collections/add', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'addDialog'])->name('collections.add');
        Route::post('collections/items', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'storeItem'])->name('collections.items.store');
        Route::post('collections/items/bulk', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'storeItems'])->name('collections.items.bulk');
        Route::get('collections/{collection}/edit', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'edit'])->name('collections.edit');
        Route::put('collections/{collection}', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'update'])->name('collections.update');
        Route::post('collections/{collection}/archive', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'archive'])->name('collections.archive');
        Route::post('collections/{collection}/restore', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'restore'])->name('collections.restore');
        Route::delete('collections/{collection}/items/{item}', [\App\Http\Controllers\Knowledge\ContentCollectionController::class, 'destroyItem'])->name('collections.items.destroy');
        // Verweise (MVP-811): gesetzt von der Detailseite, gelöst in der Verweiskarte.
        Route::get('references/create', [\App\Http\Controllers\Knowledge\ContentReferenceController::class, 'create'])->name('references.create');
        Route::post('references', [\App\Http\Controllers\Knowledge\ContentReferenceController::class, 'store'])->name('references.store');
        ...
        Route::get('form-templates/create', [\App\Http\Controllers\Form\FormTemplateController::class, 'create'])->name('form-templates.create');
        Route::post('form-templates', [\App\Http\Controllers\Form\FormTemplateController::class, 'store'])->name('form-templates.store');
        Route::get('form-templates/{template}/edit', [\App\Http\Controllers\Form\FormTemplateController::class, 'edit'])->name('form-templates.edit');
        Route::put('form-templates/{template}', [\App\Http\Controllers\Form\FormTemplateController::class, 'update'])->name('form-templates.update');
        Route::post('form-templates/{template}/activate', [\App\Http\Controllers\Form\FormTemplateController::class, 'activate'])->name('form-templates.activate');
        Route::post('form-templates/{template}/archive', [\App\Http\Controllers\Form\FormTemplateController::class, 'archive'])->name('form-templates.archive');
        Route::delete('form-templates/{template}', [\App\Http\Controllers\Form\FormTemplateController::class, 'destroy'])->name('form-templates.destroy');
        ...
        Route::post('procedures/{template}/versions', [\App\Http\Controllers\Procedure\ProcedureTemplateController::class, 'storeVersion'])->name('procedures.versions.store');
        Route::post('procedures/{template}/versions/{version}/publish', [\App\Http\Controllers\Procedure\ProcedureTemplateController::class, 'publish'])->name('procedures.versions.publish');
        Route::post('procedures/{template}/activate', [\App\Http\Controllers\Procedure\ProcedureTemplateController::class, 'activate'])->name('procedures.activate');
        Route::post('procedures/{template}/archive', [\App\Http\Controllers\Procedure\ProcedureTemplateController::class, 'archive'])->name('procedures.archive');
        ...
        Route::get('procedure-runs/{run}', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'show'])->name('procedure-runs.show');
        Route::post('procedure-runs/{run}/steps/{stepRun}/execute', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'executeStep'])->name('procedure-runs.steps.execute');
        Route::post('procedure-runs/{run}/steps/{stepRun}/wait/begin', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'beginWait'])->name('procedure-runs.steps.wait.begin');
        Route::post('procedure-runs/{run}/steps/{stepRun}/wait/continue', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'continueWait'])->name('procedure-runs.steps.wait.continue');
        Route::post('procedure-runs/{run}/steps/{stepRun}/abweichung', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'recordDeviation'])->name('procedure-runs.steps.deviation');
        Route::post('procedure-runs/{run}/steps/{stepRun}/second-person', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'signSecondPerson'])->name('procedure-runs.steps.second-person');
        Route::post('procedure-runs/{run}/complete', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'complete'])->name('procedure-runs.complete');
        Route::post('procedure-runs/{run}/abort', [\App\Http\Controllers\Procedure\ProcedureRunController::class, 'abort'])->name('procedure-runs.abort');

        Route::get('form-submissions', [\App\Http\Controllers\Form\FormSubmissionController::class, 'index'])->name('form-submissions.index');
        Route::get('form-submissions/create', [\App\Http\Controllers\Form\FormSubmissionController::class, 'create'])->name('form-submissions.create');
        Route::post('form-submissions', [\App\Http\Controllers\Form\FormSubmissionController::class, 'store'])->name('form-submissions.store');
        Route::get('form-submissions/{submission}/pdf', [\App\Http\Controllers\Form\FormSubmissionController::class, 'pdf'])->name('form-submissions.pdf'); // Feature 032 Rang 31
        Route::get('form-submissions/{submission}', [\App\Http\Controllers\Form\FormSubmissionController::class, 'show'])->name('form-submissions.show');
        ...
        Route::get('zutrittsmedien', [\App\Http\Controllers\Access\AccessMediumController::class, 'index'])->name('access-media.index');
        Route::get('zutrittsmedien/neu', [\App\Http\Controllers\Access\AccessMediumController::class, 'create'])->name('access-media.create');
        Route::post('zutrittsmedien', [\App\Http\Controllers\Access\AccessMediumController::class, 'store'])->name('access-media.store');
        Route::get('zutrittsmedien/{accessMedium}', [\App\Http\Controllers\Access\AccessMediumController::class, 'show'])->name('access-media.show');
        Route::post('zutrittsmedien/{accessMedium}/ausgabe', [\App\Http\Controllers\Access\AccessMediumController::class, 'issue'])->name('access-media.issue');
        Route::post('zutrittsmedien/{accessMedium}/rueckgabe', [\App\Http\Controllers\Access\AccessMediumController::class, 'takeBack'])->name('access-media.take-back');
        Route::post('zutrittsmedien/{accessMedium}/verlust', [\App\Http\Controllers\Access\AccessMediumController::class, 'reportLost'])->name('access-media.report-lost');
        Route::post('zutrittsmedien/{accessMedium}/gesperrt', [\App\Http\Controllers\Access\AccessMediumController::class, 'confirmBlocked'])->name('access-media.confirm-blocked');
        Route::post('zutrittsmedien/{accessMedium}/ausmustern', [\App\Http\Controllers\Access\AccessMediumController::class, 'retire'])->name('access-media.retire');

        Route::get('assets', [AssetController::class, 'index'])->name('assets.index');
        Route::get('assets/create', [AssetController::class, 'create'])->name('assets.create');
        Route::get('assets/merge/compare', [\App\Http\Controllers\Asset\AssetMergeController::class, 'compare'])->name('assets.merge.compare');
        Route::post('assets/merge', [\App\Http\Controllers\Asset\AssetMergeController::class, 'merge'])->name('assets.merge');
        ...
        Route::get('permits', [\App\Http\Controllers\Asset\PermitController::class, 'index'])->name('permits.index');
        Route::get('permits/create', [\App\Http\Controllers\Asset\PermitController::class, 'create'])->name('permits.create');
        Route::post('permits', [\App\Http\Controllers\Asset\PermitController::class, 'store'])->name('permits.store');
        Route::get('permits/{permit}/edit', [\App\Http\Controllers\Asset\PermitController::class, 'edit'])->name('permits.edit');
        Route::put('permits/{permit}', [\App\Http\Controllers\Asset\PermitController::class, 'update'])->name('permits.update');
        Route::delete('permits/{permit}', [\App\Http\Controllers\Asset\PermitController::class, 'destroy'])->name('permits.destroy');
        ...
        Route::get('sla-contracts', [\App\Http\Controllers\ServiceTicket\SlaContractController::class, 'index'])->name('sla-contracts.index');
        ...
        Route::get('sla-contracts/{slaContract}', [\App\Http\Controllers\ServiceTicket\SlaContractController::class, 'show'])->name('sla-contracts.show');
        ...
        Route::get('driver-license-checks', [\App\Http\Controllers\Fleet\DriverLicenseCheckController::class, 'index'])->name('driver-license-checks.index');
        Route::get('driver-license-checks/create', [\App\Http\Controllers\Fleet\DriverLicenseCheckController::class, 'create'])->name('driver-license-checks.create');
        Route::post('driver-license-checks', [\App\Http\Controllers\Fleet\DriverLicenseCheckController::class, 'store'])->name('driver-license-checks.store');
        Route::get('driver-license-checks/{user}', [\App\Http\Controllers\Fleet\DriverLicenseCheckController::class, 'show'])->name('driver-license-checks.show');
        ...
        Route::get('suche', [\App\Http\Controllers\Search\SearchController::class, 'index'])->name('search.index');
        ...
        Route::get('suche/treffer/{type}/{id}', [\App\Http\Controllers\Search\SearchHitController::class, 'open'])
        ...
        Route::get('belegung', [\App\Http\Controllers\Time\PresenceBoardController::class, 'index'])->name('presence.board');
        ...
        Route::get('month-approval', [\App\Http\Controllers\Time\MonthApprovalController::class, 'index'])
            ->name('month-approval.index');
        Route::get('month-approval/{year}/{month}', [\App\Http\Controllers\Time\MonthApprovalController::class, 'show'])
            ->whereNumber(['year', 'month'])
            ->name('month-approval.show');
        Route::post('month-approval/{year}/{month}/submit', [\App\Http\Controllers\Time\MonthApprovalController::class, 'submit'])
            ->whereNumber(['year', 'month'])
            ->name('month-approval.submit');
        Route::post('month-approval/{year}/{month}/reopen', [\App\Http\Controllers\Time\MonthApprovalController::class, 'reopen'])
            ->whereNumber(['year', 'month'])
        ...
        Route::get('corrections', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'index'])
            ->name('corrections.index');
        Route::get('corrections/create', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'create'])
            ->name('corrections.create');
        Route::get('corrections/targets', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'targets'])
            ->name('corrections.targets');
        Route::post('corrections', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'store'])
            ->name('corrections.store');
        Route::get('corrections/{correction}', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'show'])
            ->name('corrections.show');
        Route::post('corrections/{correction}/submit', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'submit'])
            ->name('corrections.submit');
        Route::post('corrections/{correction}/withdraw', [\App\Http\Controllers\Time\TimeCorrectionController::class, 'withdraw'])
            ->name('corrections.withdraw');

        // ── Überstunden-Anträge (MVP-519) ───────────────────────────────────────
        Route::get('overtime', [\App\Http\Controllers\Time\OvertimeRequestController::class, 'index'])
            ->name('overtime.index');
        Route::get('overtime/create', [\App\Http\Controllers\Time\OvertimeRequestController::class, 'create'])
            ->name('overtime.create');
        Route::post('overtime', [\App\Http\Controllers\Time\OvertimeRequestController::class, 'store'])
            ->name('overtime.store');
        Route::post('overtime/{overtime}/withdraw', [\App\Http\Controllers\Time\OvertimeRequestController::class, 'withdraw'])
        ...
        Route::post('tagesabschluss/request-correction', [\App\Http\Controllers\Time\DayCloseController::class, 'requestCorrection'])
            ->name('day-close.request-correction');
        Route::post('tagesabschluss/corrections/{dayCorrection}/approve', [\App\Http\Controllers\Time\DayCloseController::class, 'approveCorrection'])
            ->name('day-close.correction.approve');
        Route::post('tagesabschluss/corrections/{dayCorrection}/reject', [\App\Http\Controllers\Time\DayCloseController::class, 'rejectCorrection'])
            ->name('day-close.correction.reject');
        Route::post('tagesabschluss/reopen', [\App\Http\Controllers\Time\DayCloseController::class, 'reopen'])
            ->name('day-close.reopen');

        // ── Zeit-Export (MVP-019) ──────────────────────────────────────────────
        Route::get('exports', [\App\Http\Controllers\Time\TimeExportController::class, 'index'])
            ->name('exports.index');
        Route::get('exports/create', [\App\Http\Controllers\Time\TimeExportController::class, 'create'])
            ->name('exports.create');
        Route::post('exports', [\App\Http\Controllers\Time\TimeExportController::class, 'store'])
            ->name('exports.store');
        Route::get('exports/{export}', [\App\Http\Controllers\Time\TimeExportController::class, 'show'])
            ->name('exports.show');
        Route::get('exports/{export}/download', [\App\Http\Controllers\Time\TimeExportController::class, 'download'])
            ->name('exports.download');
        Route::post('exports/{export}/deliver', [\App\Http\Controllers\Time\TimeExportController::class, 'deliver'])
            ->name('exports.deliver');
        Route::post('exports/{export}/reject', [\App\Http\Controllers\Time\TimeExportController::class, 'reject'])
            ->name('exports.reject');
        // Kostenstellen-Override je Zeile im Prüf-UI (Rang 35, nur Status ready).
        Route::patch('exports/{export}/lines/{line}', [\App\Http\Controllers\Time\TimeExportController::class, 'updateLine'])
            ->name('exports.lines.update');
        // Löschung mit Pflicht-Begründung (Vollaudit 2026-07, N6).
        Route::delete('exports/{export}', [\App\Http\Controllers\Time\TimeExportController::class, 'destroy'])
        ...
        // Umsatz je Produkt (Feature 140, MVP-705): Artikelbezug der Rechnungspositionen.
        Route::get('reports/product-revenue', [\App\Http\Controllers\Reporting\ProductRevenueReportController::class, 'index'])->name('reports.product-revenue');
        ...
        // Zoll-Nachweisexport §17 MiLoG (Feature 131, MVP-695).
        Route::get('reports/milog-nachweis', \App\Http\Controllers\Reporting\MilogEvidenceExportController::class)
            ->name('reports.milog-evidence');
        ...
        Route::get('org/members/{member}/personalakte', [\App\Http\Controllers\Hr\PersonnelFileController::class, 'index'])->name('org.members.personnel-file.index');
        Route::get('org/members/{member}/personalakte/create', [\App\Http\Controllers\Hr\PersonnelFileController::class, 'create'])->name('org.members.personnel-file.create');
        Route::post('org/members/{member}/personalakte', [\App\Http\Controllers\Hr\PersonnelFileController::class, 'store'])->name('org.members.personnel-file.store');
        Route::get('personalakte/{document}/edit', [\App\Http\Controllers\Hr\PersonnelFileController::class, 'edit'])->name('personnel-file.edit');
