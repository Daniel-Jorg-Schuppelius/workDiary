...
return [
    ...
    'description' => 'Bau, Ausbau und Trockenbau: Bautagesbericht, Aufmaß, Nachträge, Mängel und Teilabnahmen mit Gewerken und Genehmigungen.',
    'version' => 2,
    ...
    'procedure_templates' => [
        ...
        [
            ...
            'steps' => [
                ['code' => 'bereich', 'step_type' => 'choice', 'label' => 'Bauteil/Bereich wählen'],
                ['code' => 'beschreibung', 'step_type' => 'text', 'label' => 'Mangel beschreiben'],
                ['code' => 'einstufung', 'step_type' => 'choice', 'label' => 'Mangelart und Verursacher einstufen'],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Mangel fotografieren', 'requires_proof_type' => 'photo'],
                ['code' => 'frist', 'step_type' => 'text', 'label' => 'Frist zur Beseitigung festhalten', 'required' => false, 'blocking' => false],
                ['code' => 'meldung', 'step_type' => 'confirm', 'label' => 'Bauleitung/Auftraggeber informieren'],
            ],
        ],
        [
            'code' => 'BAU_NACHTRAG',
            ...
            'steps' => [
                ['code' => 'anlass', 'step_type' => 'choice', 'label' => 'Anlass des Nachtrags (geänderte/zusätzliche Leistung, Behinderung)'],
                ['code' => 'leistung', 'step_type' => 'text', 'label' => 'Nachtragsleistung beschreiben'],
                ['code' => 'mengen', 'step_type' => 'messreihe', 'label' => 'Mengen/Aufmaß der Nachtragsleistung erfassen', 'requires_proof_type' => 'measure'],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Situation dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'anerkennung', 'step_type' => 'signature', 'label' => 'Nachtragsanerkennung durch Auftraggeber', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'signature'],
                ['code' => 'meldung', 'step_type' => 'confirm', 'label' => 'Nachtrag an Kalkulation/Büro melden'],
            ],
        ],
        [
            'code' => 'BAU_RESTARBEIT',
            ...
            'steps' => [
                ['code' => 'liste', 'step_type' => 'confirm', 'label' => 'Restpunkteliste aus der Abnahme prüfen'],
                ['code' => 'durchfuehrung', 'step_type' => 'confirm', 'label' => 'Restarbeiten ausführen'],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Erledigte Punkte dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'stand', 'step_type' => 'choice', 'label' => 'Erledigungsstand je Restpunkt festhalten'],
                ['code' => 'bestaetigung', 'step_type' => 'signature', 'label' => 'Erledigung bestätigen lassen', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'signature'],
            ],
        ],
    ],
