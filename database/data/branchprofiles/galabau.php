...
return [
    ...
    'procedure_templates' => [
        ...
        [
            ...
            'steps' => [
                ['code' => 'flaeche', 'step_type' => 'choice', 'label' => 'Fläche/Objekt wählen'],
                ['code' => 'arbeiten', 'step_type' => 'choice', 'label' => 'Durchgeführte Pflegearbeiten (Mähen, Schnitt, Unkraut, Bewässerung)'],
                ['code' => 'auffaelligkeiten', 'step_type' => 'text', 'label' => 'Auffälligkeiten/Schäden vermerken', 'required' => false, 'blocking' => false],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Zustand dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'abschluss', 'step_type' => 'confirm', 'label' => 'Fläche geräumt und gesäubert'],
            ],
        ],
        [
            'code' => 'GL_PFLANZUNG',
            ...
            'steps' => [
                ['code' => 'pflanzgut', 'step_type' => 'confirm', 'label' => 'Pflanzgut auf Qualität und Sortenechtheit prüfen'],
                ['code' => 'boden', 'step_type' => 'confirm', 'label' => 'Boden vorbereiten (Lockerung, Substrat)'],
                ['code' => 'pflanzen', 'step_type' => 'confirm', 'label' => 'Pflanzung nach Plan und Pflanzabstand'],
                ['code' => 'angiessen', 'step_type' => 'confirm', 'label' => 'Angießen und Anwuchspflege festlegen'],
                ['code' => 'material', 'step_type' => 'material', 'label' => 'Pflanzgut/Material erfassen', 'required' => false, 'blocking' => false],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Pflanzung dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
            ],
        ],
        [
            'code' => 'GL_NEUANLAGE',
            ...
            'steps' => [
                ['code' => 'planabgleich', 'step_type' => 'confirm', 'label' => 'Ausführung gegen Plan prüfen'],
                ['code' => 'erdarbeiten', 'step_type' => 'confirm', 'label' => 'Erdarbeiten/Modellierung ausführen'],
                ['code' => 'aufbau', 'step_type' => 'confirm', 'label' => 'Vegetationsschicht/Substrat einbauen'],
                ['code' => 'aufmass', 'step_type' => 'messreihe', 'label' => 'Flächen und Mengen aufmessen', 'requires_proof_type' => 'measure'],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Bauzustand dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'abnahme', 'step_type' => 'signature', 'label' => 'Zwischen-/Endabnahme', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'signature'],
            ],
        ],
        [
            'code' => 'GL_PFLASTER',
            ...
            'steps' => [
                ['code' => 'unterbau', 'step_type' => 'confirm', 'label' => 'Tragschicht/Unterbau prüfen (Verdichtung)'],
                ['code' => 'gefaelle', 'step_type' => 'number', 'label' => 'Gefälle in Prozent prüfen'],
                ['code' => 'verlegung', 'step_type' => 'confirm', 'label' => 'Verlegung nach Verlegemuster/Plan'],
                ['code' => 'fugen', 'step_type' => 'confirm', 'label' => 'Fugen füllen und abrütteln'],
                ['code' => 'aufmass', 'step_type' => 'messreihe', 'label' => 'Fläche aufmessen', 'requires_proof_type' => 'measure'],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Fläche dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
            ],
        ],
        [
            ...
            'steps' => [
                ['code' => 'einsatz', 'step_type' => 'confirm', 'label' => 'Einsatz laut Winterdienstplan/Wetterlage begonnen'],
                ['code' => 'raeumen', 'step_type' => 'confirm', 'label' => 'Flächen räumen'],
                ['code' => 'streuen', 'step_type' => 'choice', 'label' => 'Streumittel und Menge'],
                ['code' => 'zeiten', 'step_type' => 'text', 'label' => 'Beginn und Ende je Fläche festhalten'],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Zustand nach Einsatz dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'nachweis', 'step_type' => 'confirm', 'label' => 'Einsatz im Streubuch/Nachweis vermerkt'],
            ],
        ],
    ],
