...
return [
    ...
    'description' => 'Sicherheitsdienst und Objektschutz: Wachbuch, Revierfahrt, Kontrollgang, Alarmverfolgung, Zutritt und Schlüsselnachweis.',
    'version' => 1,
    ...
    'procedure_templates' => [
        ...
        [
            ...
            'steps' => [
                ['code' => 'beginn', 'step_type' => 'text', 'label' => 'Dienstbeginn und Wachposten erfassen'],
                ['code' => 'uebernahme', 'step_type' => 'confirm', 'label' => 'Objekt, Schlüssel und Funkgerät übernommen'],
                ['code' => 'vorkommnisse', 'step_type' => 'text', 'label' => 'Vorkommnisse chronologisch eintragen'],
                ['code' => 'ende', 'step_type' => 'text', 'label' => 'Dienstende erfassen'],
            ],
        ],
        [
            ...
            'steps' => [
                ['code' => 'route', 'step_type' => 'text', 'label' => 'Kontrollgang bzw. Route erfassen'],
                ['code' => 'kontrollpunkte', 'step_type' => 'confirm', 'label' => 'Kontrollpunkte nach Plan angelaufen'],
                ['code' => 'verschluss', 'step_type' => 'confirm', 'label' => 'Türen, Fenster und Tore auf Verschluss geprüft'],
                ['code' => 'befund', 'step_type' => 'photo', 'label' => 'Auffälligkeiten dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'ergebnis', 'step_type' => 'choice', 'label' => 'Ergebnis festhalten'],
            ],
        ],
        [
            ...
            'steps' => [
                ['code' => 'lage', 'step_type' => 'text', 'label' => 'Vorfall, Ort und Uhrzeit erfassen'],
                ['code' => 'sicherung', 'step_type' => 'confirm', 'label' => 'Eigensicherung und Absicherung der Lage'],
                ['code' => 'benachrichtigung', 'step_type' => 'choice', 'label' => 'Benachrichtigte Stellen festhalten (Polizei, Feuerwehr, Rettungsdienst, Auftraggeber)'],
                ['code' => 'spuren', 'step_type' => 'photo', 'label' => 'Spuren und Beweise dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'bericht', 'step_type' => 'text', 'label' => 'Vorfallbericht verfassen'],
            ],
        ],
        [
            'code' => 'SD_SCHLUESSEL',
            ...
            'steps' => [
                ['code' => 'schluessel', 'step_type' => 'text', 'label' => 'Schlüssel- bzw. Schließnummer erfassen'],
                ['code' => 'vorgang', 'step_type' => 'choice', 'label' => 'Vorgang wählen (Ausgabe, Rücknahme)'],
                ['code' => 'person', 'step_type' => 'text', 'label' => 'Übernehmende bzw. abgebende Person erfassen'],
        ...
        [
            ...
            'steps' => [
                ['code' => 'offen', 'step_type' => 'text', 'label' => 'Offene Punkte und laufende Vorgänge übergeben'],
                ['code' => 'ausruestung', 'step_type' => 'confirm', 'label' => 'Schlüssel, Funkgerät und Ausrüstung vollständig übergeben'],
                ['code' => 'hinweise', 'step_type' => 'text', 'label' => 'Besondere Hinweise für die Ablösung', 'required' => false, 'blocking' => false],
                ['code' => 'bestaetigung', 'step_type' => 'signature', 'label' => 'Übergabe durch die Ablösung bestätigen', 'requires_proof_type' => 'signature'],
            ],
        ],
    ],
