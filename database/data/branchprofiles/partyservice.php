...
return [
    ...
    'procedure_templates' => [
        ...
        [
            ...
            'steps' => [
                ['code' => 'bestellliste', 'step_type' => 'confirm', 'label' => 'Einkauf gegen Bestellliste/Gästezahl prüfen'],
                ['code' => 'wareneingang', 'step_type' => 'confirm', 'label' => 'Wareneingang prüfen (MHD, Unversehrtheit)'],
                ['code' => 'temperatur', 'step_type' => 'number', 'label' => 'Temperatur gekühlter Ware bei Anlieferung (°C)'],
                ['code' => 'lagerung', 'step_type' => 'confirm', 'label' => 'Ware sachgerecht einlagern'],
                ['code' => 'material', 'step_type' => 'material', 'label' => 'Eingekaufte Ware erfassen', 'required' => false, 'blocking' => false],
            ],
        ],
        [
            'code' => 'PS_SERVICE',
            ...
            'steps' => [
                ['code' => 'aufbau', 'step_type' => 'confirm', 'label' => 'Buffet/Service aufgebaut'],
                ['code' => 'temperatur', 'step_type' => 'number', 'label' => 'Temperatur bei Ausgabe (°C)'],
                ['code' => 'nachschub', 'step_type' => 'confirm', 'label' => 'Nachschub/Nachlegen organisiert', 'required' => false, 'blocking' => false],
                ['code' => 'hygiene', 'step_type' => 'confirm', 'label' => 'Hygiene während des Service (Handschuhe, Abdeckung)'],
                ['code' => 'zwischenfaelle', 'step_type' => 'text', 'label' => 'Zwischenfälle vermerken', 'required' => false, 'blocking' => false],
            ],
        ],
        [
            ...
            'steps' => [
                ['code' => 'reste', 'step_type' => 'choice', 'label' => 'Speisereste entsorgen oder zurücknehmen'],
                ['code' => 'equipment', 'step_type' => 'dienstmittel', 'label' => 'Equipment zählen und einladen'],
                ['code' => 'schaeden', 'step_type' => 'text', 'label' => 'Schäden/Fehlbestände vermerken', 'required' => false, 'blocking' => false],
                ['code' => 'reinigung', 'step_type' => 'confirm', 'label' => 'Ort sauber hinterlassen'],
        ...
        [
            ...
            'steps' => [
                ['code' => 'aufnahme', 'step_type' => 'text', 'label' => 'Reklamation aufnehmen'],
                ['code' => 'einstufung', 'step_type' => 'choice', 'label' => 'Art (Qualität, Menge, Hygiene, Lieferzeit)'],
                ['code' => 'sofort', 'step_type' => 'confirm', 'label' => 'Sofortlösung angeboten', 'required' => false, 'blocking' => false],
                ['code' => 'foto', 'step_type' => 'photo', 'label' => 'Beanstandung dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'abschluss', 'step_type' => 'confirm', 'label' => 'Rückmeldung an Kunde und Kulanz festgehalten'],
            ],
        ],
    ],
