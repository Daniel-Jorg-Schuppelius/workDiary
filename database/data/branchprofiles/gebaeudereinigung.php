...
return [
    ...
    'procedure_templates' => [
        ...
        [
            ...
            'steps' => [
                ['code' => 'revier', 'step_type' => 'text', 'label' => 'Objekt/Revier und Leistungsverzeichnis-Position erfassen'],
                ['code' => 'zutritt', 'step_type' => 'confirm', 'label' => 'Zutritt übernommen, Alarmanlage entschärft'],
                ['code' => 'durchfuehrung', 'step_type' => 'confirm', 'label' => 'Reinigung nach Leistungsverzeichnis durchführen'],
                ['code' => 'besonderheiten', 'step_type' => 'text', 'label' => 'Besonderheiten oder Schäden vermerken', 'required' => false, 'blocking' => false],
                ['code' => 'nachweis', 'step_type' => 'photo', 'label' => 'Leistungsnachweis (Foto)', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'verschluss', 'step_type' => 'confirm', 'label' => 'Objekt verschlossen, Alarmanlage scharf geschaltet'],
            ],
        ],
        [
            ...
            'steps' => [
                ['code' => 'belag', 'step_type' => 'choice', 'label' => 'Bodenbelag und Verfahren wählen'],
                ['code' => 'absperren', 'step_type' => 'confirm', 'label' => 'Bereich absperren und Rutschgefahr kennzeichnen'],
                ['code' => 'material', 'step_type' => 'material', 'label' => 'Reinigungs- und Pflegemittel erfassen', 'required' => false, 'blocking' => false],
                ['code' => 'durchfuehrung', 'step_type' => 'confirm', 'label' => 'Grundreinigung durchführen'],
                ['code' => 'trocknung', 'step_type' => 'confirm', 'label' => 'Trocknungszeit abwarten, Bereich erst danach freigeben'],
                ['code' => 'abnahme', 'step_type' => 'signature', 'label' => 'Abnahme durch den Auftraggeber', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'signature'],
            ],
        ],
        [
            'code' => 'GR_GLAS',
            ...
            'steps' => [
                ['code' => 'witterung', 'step_type' => 'confirm', 'label' => 'Witterung geprüft (kein Frost, kein Starkwind)'],
                ['code' => 'arbeitsmittel', 'step_type' => 'choice', 'label' => 'Arbeitsmittel wählen (Leiter, Teleskopstange, Hubarbeitsbühne)'],
                ['code' => 'absturz', 'step_type' => 'confirm', 'label' => 'Absturzsicherung geprüft und angelegt'],
                ['code' => 'durchfuehrung', 'step_type' => 'confirm', 'label' => 'Glas und Rahmen reinigen'],
                ['code' => 'nachweis', 'step_type' => 'photo', 'label' => 'Ergebnis dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
            ],
        ],
        [
            'code' => 'GR_REKLAMATION',
            ...
            'steps' => [
                ['code' => 'aufnahme', 'step_type' => 'text', 'label' => 'Beanstandung des Auftraggebers erfassen'],
                ['code' => 'vorher', 'step_type' => 'photo', 'label' => 'Zustand vor der Nacharbeit dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'ursache', 'step_type' => 'choice', 'label' => 'Ursache einordnen'],
                ['code' => 'nacharbeit', 'step_type' => 'confirm', 'label' => 'Nacharbeit durchführen'],
                ['code' => 'nachher', 'step_type' => 'photo', 'label' => 'Zustand nach der Nacharbeit dokumentieren', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'photo'],
                ['code' => 'abnahme', 'step_type' => 'signature', 'label' => 'Abnahme der Nacharbeit', 'required' => false, 'blocking' => false, 'requires_proof_type' => 'signature'],
            ],
        ],
    ],
