...
enum ImportEntity: string implements HasLabel {
    ...
    public function modelClass(): ?string {
        return match ($this) {
            ...
            self::Suppliers => \App\Models\Supplier\Supplier::class,
            self::Articles => \App\Models\Article\Article::class,
            self::Projects => \App\Models\Project\Project::class,
            self::Users => \App\Models\Platform\User::class,
            self::Materials => \App\Models\Material\Material::class,
            self::Vehicles => \App\Models\Fleet\Vehicle::class,
            self::ScheduledShifts => \App\Models\Schedule\ScheduledShift::class,
            self::RemoteSessions => null,
            self::Attendances => \App\Models\Time\Attendance::class,
            self::ProjectTimes => \App\Models\Time\TimeEntry::class,
            self::Invoices => \App\Models\Invoicing\Invoice::class,
            self::Quotes => \App\Models\Sales\Quote::class,
            self::Assets => \App\Models\Asset\Asset::class,
