...
class SaveChangeRequest extends BaseFormRequest {
    ...
    protected array $sqidFields = [
        'change_template_id' => \App\Models\ServiceTicket\ChangeTemplate::class,
        'problem_id' => \App\Models\ServiceTicket\Problem::class,
        'ticket_ids' => \App\Models\ServiceTicket\ServiceTicket::class,
        'asset_ids' => \App\Models\Asset\Asset::class,
    ];
    ...
    public function rules(): array {
        ...
        return [
            ...
            'window_from' => ['nullable', 'date', new \App\Rules\TimestampRange()],
            'window_to' => ['nullable', 'date', 'after_or_equal:window_from', new \App\Rules\TimestampRange()],
