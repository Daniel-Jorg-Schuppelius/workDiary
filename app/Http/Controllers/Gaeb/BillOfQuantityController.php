...
class BillOfQuantityController extends Controller {
     ...
     */
    public function assignSplitCatalog(Request $request, \App\Models\Gaeb\BoqItemQuantitySplit $split, \App\Services\Gaeb\CatalogAssignmentService $assignments): RedirectResponse {
        $this->canManage();
