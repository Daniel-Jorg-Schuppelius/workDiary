...
class DispatchBoardController extends Controller {
     ...
     */
    public function qualifications(\App\Models\Diary\DiaryEntry $diary, \App\Services\Schedule\QualificationGate $gate): View {
        $this->authorizeView();
     ...
     */
    private function coordinatesFor(\App\Models\Diary\DiaryEntry $entry): array {
