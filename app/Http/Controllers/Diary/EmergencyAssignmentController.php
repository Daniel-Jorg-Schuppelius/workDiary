...
class EmergencyAssignmentController extends Controller {
    ...
    private function validateAssignment(Request $request): array {
        ...
        $onCallShiftId = \App\Support\Sqid::decodeOrNumeric(\App\Models\Diary\OnCallShift::class, $rawShiftId);
        ...
        return $request->validate([
            ...
            'on_call_shift_id' => ['nullable', 'integer', new \App\Rules\ExistsInCurrentOrganization('on_call_shifts')],
