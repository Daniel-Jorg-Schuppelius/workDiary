...
use App\Services\Compliance\{ComplianceFindingRecorder, ComplianceScanService, CoreTimeScanService};
...
class ScanComplianceFindingsCommand extends Command {
    ...
    public function handle(ComplianceScanService $scanner, CoreTimeScanService $coreTimeScanner, ComplianceFindingRecorder $recorder): int {
        ...
        foreach ($organizationIds as $organizationId) {
            ...
            $this->withOrganizationContext($organization, function (Organization $organization) use ($scanner, $coreTimeScanner, $recorder, $from, $to, &$totals): void {
                ...
                // würde sie über das Auto-„behoben" wieder schließen.
