...
use App\Models\{ActivityCategory, Asset, Attachment, Classification, ClassificationRequirement, Comment, CoverageRequirement, Customer, DiaryEntry, DutyPlan, EmergencyAssignment, Event, EventCategory, Expense, ExpenseCategory, FlexEligibility, Material, MaterialUsage, Milestone, OpenIssue, Organization, PerDiemRate, PerDiemTrip, ProcedureBackupProof, ProcedureDeviation, ProcedureRun, ProcedureTemplate, Protocol, Qualification, Room, ScheduledShift, ShiftType, Tag, Task, TimeEntry, Timesheet, TravelLog, User, UserGroup, WorkSchedule};
...
use App\Policies\{ActivityCategoryPolicy, AssetPolicy, ClassificationPolicy, ClassificationRequirementPolicy, CoverageRequirementPolicy, DutyPlanPolicy, EventCategoryPolicy, EventPolicy, ExpenseCategoryPolicy, ExpensePolicy, FlexEligibilityPolicy, MaterialPolicy, MaterialUsagePolicy, MilestonePolicy, OpenIssuePolicy, OrganizationPolicy, PerDiemRatePolicy, PerDiemTripPolicy, ProcedureBackupProofPolicy, ProcedureDeviationPolicy, ProcedureRunPolicy, ProcedureTemplatePolicy, ProtocolPolicy, QualificationPolicy, RoomPolicy, ScheduledShiftPolicy, ShiftTypePolicy, TaskPolicy, TimeEntryPolicy, TimesheetPolicy, TravelLogPolicy, UserGroupPolicy, WorkSchedulePolicy};
