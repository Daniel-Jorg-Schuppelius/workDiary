...
/**
 * Ein Belegfluss über fünf Quellen (Feature 105, MVP-543).
 *
 * Angebote, lokale Rechnungen, gespiegelte Buchhaltungsbelege,
 * Eingangsrechnungen und Auslagen werden auf eine gemeinsame Zeilenform
 * projiziert und per `UNION ALL` zusammengeführt — Sortierung, Filterung und
 * Aggregation laufen danach in SQL. Ein Zusammenführen in PHP würde bei fünf
 * paginierten Quellen weder sortieren noch summieren können.
 *
