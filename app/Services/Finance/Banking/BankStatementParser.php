        ...
        foreach ($documents as $document) {
            ...
            foreach ($document->getEntries() as $entry) {
                ...
                $transactions[] = new NormalizedTransaction(
                    ...
                    amount: round($entry->getAmount()->toFloat(), 2),
            ...
            $statements[] = new NormalizedStatement(
                ...
                openingBalance: $opening !== null ? round($opening->getSignedAmount()->toFloat(), 2) : null,
                closingBalance: $closing !== null ? round($closing->getSignedAmount()->toFloat(), 2) : null,
        ...
        foreach ($documents as $document) {
            ...
            foreach ($document->getTransactions() as $tx) {
                ...
                $transactions[] = new NormalizedTransaction(
                    ...
                    amount: round($tx->getAmount()->toFloat(), 2),
            ...
            $statements[] = new NormalizedStatement(
                ...
                openingBalance: round($opening->getSignedAmount()->toFloat(), 2),
                closingBalance: round($closing->getSignedAmount()->toFloat(), 2),
        ...
        foreach ($document->getStatements() as $statement) {
            ...
            foreach ($statement->getTransactions() as $tx) {
                ...
                $transactions[] = new NormalizedTransaction(
                    ...
                    valutaDate: null,
                    amount: round($tx->getAbsoluteAmount()->toFloat(), 2),
                    direction: TransactionDirection::fromCreditDebit($tx->getCreditDebit()),
            ...
            $statements[] = new NormalizedStatement(
                ...
                openingBalance: null,
                closingBalance: $ledger !== null ? round($ledger->getAmount()->toFloat(), 2) : null,
    ...
    private function parseQif(string $content): array {
        ...
        foreach ($document->getTransactions() as $tx) {
            ...
            $transactions[] = $this->quickenTransaction(
                ...
                round($tx->getAbsoluteAmount()->toFloat(), 2),
    ...
    private function camtTransactionDetails(Camt053Transaction $entry): array {
        ...
        foreach ($entry->getTransactionDetails() as $detail) {
            $details[] = new NormalizedTransactionDetail(
                signedAmount: round($detail->getSignedAmount()->toFloat(), 2),
