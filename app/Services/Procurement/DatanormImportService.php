...
class DatanormImportService {
    ...
    private function unitPrice(string $price, string $priceUnit): ?string {
        ...
        // Bewusst float/number_format (Klasse F): eine bcmath-Variante rundet exakte .00005-Ties (Preiseinheit 1000)
        // anders als das etablierte float-Verhalten — Umstellung nur nach fachlicher Abnahme (siehe toolkit-audit-2026-06.md).
