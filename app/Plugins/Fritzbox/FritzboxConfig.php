 ...
 *
 * @phpstan-type FritzboxSettings array{enabled: bool, default_billable: bool, default_user_id: ?int, min_call_minutes: int, call_lead_minutes: int, own_number_allowlist: list<string>, type3_outgoing: bool, external_contact_matching: bool, stamp_in_line: string, stamp_out_line: string, stamp_toggle_line: string}
 */
class FritzboxConfig {
    /**
     * @return array{enabled: bool, default_billable: bool, default_user_id: ?int, min_call_minutes: int, call_lead_minutes: int, own_number_allowlist: list<string>, type3_outgoing: bool, external_contact_matching: bool, stamp_in_line: string, stamp_out_line: string, stamp_toggle_line: string}
     */
    public static function resolve(?int $organizationId = null): array {
        ...
        return [
            ...
            'external_contact_matching' => $r->bool('external_contact_matching', true),
