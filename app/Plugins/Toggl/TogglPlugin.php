...
class TogglPlugin extends AbstractPlugin implements TimeImporter {
    ...
    public function settingsSchema(): array {
        return [
            ...
            ['key' => 'single_user_mode', 'label' => __('Einbenutzer-Modus'), 'type' => 'boolean', 'default' => false, 'help' => __('Nur für Einzelarbeitsplätze: Einträge ohne zuordenbaren Toggl-Benutzer werden auf den Standard-Benutzer gebucht. Wenn aus (empfohlen), landen nicht zuordenbare Benutzer sichtbar in der Integrations-Inbox statt still beim Hauptbenutzer.')],
