...
/**
 * Gateway-Vertrag der Kalender-Provider (MVP-328, Bauturbo A8; C9):
 ...
 * CalDAV adaptiert PUT/DELETE auf deterministische Objektnamen dahinter.
 *
 * Fehlersemantik: Transport-/HTTP-Fehler werden zu `null`/`false` — der
 * {@see RemoteCalendarPublishService} zählt sie als `failed` und versucht
 * sie beim nächsten Lauf erneut.
 */
