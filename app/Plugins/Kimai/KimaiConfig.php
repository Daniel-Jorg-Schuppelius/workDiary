 ...
 *
 * @phpstan-type KimaiSettings array{enabled: bool, default_billable: bool, default_user_id: ?int, single_user_mode: bool, base_url: ?string, api_token: ?string, api_all_users: bool, sync_window_days: int, default_activity_id: ?int, export_enabled: bool, writeback: bool}
 */
class KimaiConfig {
    /**
     * @return array{enabled: bool, default_billable: bool, default_user_id: ?int, single_user_mode: bool, base_url: ?string, api_token: ?string, api_all_users: bool, sync_window_days: int, default_activity_id: ?int, export_enabled: bool, writeback: bool}
     */
