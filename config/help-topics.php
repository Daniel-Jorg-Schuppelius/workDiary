...
return [
    ...
    'routes' => [
        ...
        'club.requirements.*' => 'club.competitions',
        'club.members.performances.*' => 'club.competitions',
        'club.members.startrights.*' => 'club.competitions',
        'club.events.horses.*' => 'club.horses',
        'club.horses.*' => 'club.horses',
        'club.events.resources.*' => 'club.resources',
        'club.resources.*' => 'club.resources',
        'club.groups.squad.*' => 'club.matches',
        'club.matches.*' => 'club.matches',
        'club.profiles.*' => 'club.matches',
        ...
        'club.fees.*' => 'club.fees',
        'club.members.grading' => 'club.grading',
        'club.members.grades.*' => 'club.grading',
        'club.members.proofs.*' => 'club.grading',
        'club.settings.*' => 'club.members',
